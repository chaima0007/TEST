...
**Signal, explicitement NON VÉRIFIÉ, à ne PAS traiter comme un fait :** le Drive contient un
`Guide_Examen_MQ06` (2026-09-06) sur l'installation d'un parc Windows Server 2022 / Windows 11.
Cela **suggère** une familiarité Windows et un cursus sysadmin. **Ce n'est pas sa machine** :
c'est un exercice d'école avec des machines virtuelles. En déduire son OS violerait R-003.
