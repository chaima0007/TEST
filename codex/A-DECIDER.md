...
| Définir l'ICP cible + fournir la liste de prospects | Caelum/TEST | Marché/Humain | 2026-09-11 | Route/UI HERMES livrées (`/dashboard/prospection`) ; reste à définir QUI cibler et à fournir 5–10 prospects réels (l'envoi reste manuel, §10). |
