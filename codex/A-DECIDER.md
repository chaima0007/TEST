...
- **2026-09-11** — **Merge de la PR #1 dans `main`** (pipeline Nexus-Market + flotte d'agents Caelum) : gate requis vert (« Lint, Typecheck & Build » ✅), rouges non-bloquants connus (Revue automatique = secret manquant ERR-010). Merge délégué à l'agent puis exécuté — commit de merge `9cc15c2`. **TRANCHÉ PAR CHAIMA.**
