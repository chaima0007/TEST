...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/child-marriage-forced-union-rights-engine", label: "Mariage Forcé Enfants", icon: <IconChildMarriageForcedUnionRights className="w-4 h-4" /> },
      { href: "/dashboard/colonial-reparations-restitution-rights-engine", label: "Réparations Coloniales", icon: <IconColonialReparationsRestitutionRights className="w-4 h-4" /> },
      { href: "/dashboard/right-to-food-famine-accountability-engine", label: "Droit Alimentation Famine", icon: <IconRightToFoodFamineAccountability className="w-4 h-4" /> },
      { href: "/dashboard/digital-divide-internet-access-rights-engine", label: "Fracture Numérique", icon: <IconDigitalDivideInternetAccessRights className="w-4 h-4" /> },
      { href: "/dashboard/human-rights-education-rights-engine", label: "Éducation Droits Humains", icon: <IconHumanRightsEducationRights className="w-4 h-4" /> },
      { href: "/dashboard/elderly-abuse-care-home-rights-engine", label: "Maltraitance Personnes Âgées", icon: <IconElderlyAbuseCareHomeRights className="w-4 h-4" /> },
      ...
      { href: "/dashboard/witchcraft-accusation-persecution-engine", label: "Accusations Sorcellerie", icon: <IconWitchcraftAccusationPersecution className="w-4 h-4" /> },
      { href: "/dashboard/anti-corruption-whistleblower-protection-engine", label: "Lanceurs d'Alerte", icon: <IconAntiCorruptionWhistleblowerProtection className="w-4 h-4" /> },
      { href: "/dashboard/apostasy-blasphemy-persecution-engine", label: "Apostasie & Blasphème", icon: <IconApostasyBlasphemyPersecution className="w-4 h-4" /> },
      { href: "/dashboard/third-party-work-validation-engine", label: "Validation Tiers", icon: <IconThirdPartyWorkValidation className="w-4 h-4" /> },
      { href: "/dashboard/cybersecurity-data-protection-engine", label: "Cybersécurité", icon: <IconCybersecurityDataProtection className="w-4 h-4" /> },
      { href: "/dashboard/active-cyber-defense-honeypot-engine", label: "Défense Cyber", icon: <IconActiveCyberDefenseHoneypot className="w-4 h-4" /> },
      { href: "/dashboard/patent-revenue-prioritization-engine", label: "Revenus Brevets", icon: <IconPatentRevenuePrioritization className="w-4 h-4" /> },
      { href: "/dashboard/peasant-land-tenure-rights-engine", label: "Droits Fonciers Paysans", icon: <IconPeasantLandTenureRights className="w-4 h-4" /> },
      { href: "/dashboard/sex-worker-rights-criminalization-engine", label: "Droits Trav. du Sexe", icon: <IconSexWorkerRightsCriminalization className="w-4 h-4" /> },
      { href: "/dashboard/unaccompanied-migrant-children-rights-engine", label: "Enfants Migrants", icon: <IconUnaccompaniedMigrantChildrenRights className="w-4 h-4" /> },
      ...
      { href: "/dashboard/racial-discrimination-minority-rights-engine", label: "Discrimination Raciale", icon: <IconRacialDiscriminationMinorityRights className="w-4 h-4" /> },
      { href: "/dashboard/food-sovereignty-right-to-food-engine", label: "Souveraineté Alimentaire", icon: <IconFoodSovereigntyRightToFood className="w-4 h-4" /> },
      ...
      { href: "/dashboard/child-marriage-forced-union-engine", label: "Mariage Enfants &amp; Unions Forcées", icon: <IconChildMarriageForcedUnion className="w-4 h-4" /> },
      { href: "/dashboard/internet-freedom-digital-rights-engine", label: "Liberté Internet &amp; Droits Numériques", icon: <IconInternetFreedomDigitalRights className="w-4 h-4" /> },
      ...
      { href: "/dashboard/debt-bondage-microfinance-exploitation-engine", label: "Microfinance & Servitude Dette", icon: <IconDebtBondageMicrofinanceExploitation className="w-4 h-4" /> },
      { href: "/dashboard/sexual-orientation-gender-identity-rights-engine", label: "Droits SOGI & LGBTQ+", icon: <IconSexualOrientationGenderIdentityRights className="w-4 h-4" /> },
      { href: "/dashboard/indigenous-cultural-genocide-assimilation-engine", label: "Génocide Culturel Autochtone", icon: <IconIndigenousCulturalGenocideAssimilation className="w-4 h-4" /> },
    ],
  },
  {
    title: "COMPTE",
