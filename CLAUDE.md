...
- **Commandes de vérification AVANT PUSH (Parcours 4) :**
  ...
  **L'ordre compte :** `build` AVANT `tsc` (le build génère `.next/types/**` dont `tsc`
  ...
  références orphelines, rétrécissement du registre et données personnelles (ERR-20260914-2026, ERR-20260919-1259, ERR-20260919-1316, ERR-20260919-1324).
...
- **Rituel d'entrée §5 — ajouter au `git ls-remote` (ERR-20260914-2021) :** lister aussi les **PR
...
- **Un fait d'état vit à UN SEUL endroit (ERR-20260914-2022 et ERR-20260914-2023).** `ETAT.md` fait foi pour la branche
...
- **« APPLIQUÉ » sans SHA de `main` est une intention, pas un fait (ERR-20260914-2033).** Une entrée du
