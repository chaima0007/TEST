"""CaelumSwarm™ — Microgrid Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL"""

ENTITIES = [
    ("Microgrid Controller MFG", 99, 97, 95, 93),
    ("Battery Pack Supplier", 93, 90, 88, 86),
    ("Solar Inverter Corp", 85, 82, 80, 78),
    ("Microgrid Software Ltd", 80, 77, 75, 73),
    ("Local Grid Operator", 61, 58, 56, 54),
    ("Diesel Generator Co", 51, 48, 46, 44),
    ("Cable Assembly Works", 32, 29, 27, 25),
    ("Component Labor Supply", 13, 11, 9, 7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_microgrid_index": idx}
