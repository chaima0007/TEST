"""
CaelumSwarm™ — Loyalty Program Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Starbucks Rewards",        99, 97, 95, 93),
    ("Amazon Prime",             93, 90, 88, 86),
    ("Sephora Beauty Insider",   85, 82, 80, 78),
    ("Target Circle",            80, 77, 75, 73),
    ("Marriott Bonvoy",          61, 58, 56, 54),
    ("Delta SkyMiles",           51, 48, 46, 44),
    ("Nike Membership",          32, 29, 27, 25),
    ("CVS ExtraCare",            13, 11,  9,  7),
]
