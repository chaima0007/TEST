"""CaelumSwarm™ — Meal Kit Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL"""

ENTITIES = [
    ("Meal Kit Platform Corp", 99, 97, 95, 93),
    ("Fresh Ingredient Sourcing", 93, 90, 88, 86),
    ("Cold Box Packaging MFG", 85, 82, 80, 78),
    ("Recipe Tech Systems", 80, 77, 75, 73),
    ("Agricultural Supply Co", 61, 58, 56, 54),
    ("Cold Chain Logistics Co", 51, 48, 46, 44),
    ("Meal Prep Assembly Co", 32, 29, 27, 25),
    ("Farm Harvest Labor Pool", 13, 11, 9, 7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_mealkit_index": idx}
