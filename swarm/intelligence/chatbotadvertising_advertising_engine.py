...
for e in ENTITIES:
    ...
    results.append({**e, "composite_score": score, "risk_level": risk, f"estimated_{domain}_index": round(score/100*10, 2)})
avg = round(sum(r["composite_score"] for r in results)/len(results), 2)
dist = {}
for r in results: dist[r["risk_level"]] = dist.get(r["risk_level"], 0) + 1
print(json.dumps({"domain": domain, "entities": results, "avg_composite": avg, "distribution": dist}, ensure_ascii=False, indent=2))
