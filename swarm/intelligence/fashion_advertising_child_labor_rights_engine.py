"""
CaelumSwarm™ — Fashion Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Zara Fashion Ads",   99, 97, 95, 93),
    ("H&M Campaign",       93, 90, 88, 86),
    ("SHEIN Advertising",  85, 82, 80, 78),
    ("Uniqlo Ads",         80, 77, 75, 73),
    ("Gap Campaign",       61, 58, 56, 54),
    ("Primark Marketing",  51, 48, 46, 44),
    ("Forever 21 Ads",     32, 29, 27, 25),
    ("Boohoo Advertising", 13, 11,  9,  7),
]
