"""
CaelumSwarm™ — SpaceTech Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("SpaceX",              99, 97, 95, 93),
    ("Blue Origin",         93, 90, 88, 86),
    ("Rocket Lab",          85, 82, 80, 78),
    ("Planet Labs",         80, 77, 75, 73),
    ("OneWeb",              61, 58, 56, 54),
    ("Maxar Technologies",  51, 48, 46, 44),
    ("Spire Global",        32, 29, 27, 25),
    ("Astroscale",          13, 11,  9,  7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_spacetech_advertising_index": idx}
