"""
CaelumSwarm™ — Cause Marketing Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("(RED) Campaign",                       99, 97, 95, 93),
    ("TOMS One for One",                     93, 90, 88, 86),
    ("Patagonia 1% for Planet",              85, 82, 80, 78),
    ("Ben & Jerry's Social Mission",         80, 77, 75, 73),
    ("Dove Real Beauty",                     61, 58, 56, 54),
    ("Always #LikeAGirl",                    51, 48, 46, 44),
    ("Warby Parker Buy a Pair Give a Pair",  32, 29, 27, 25),
    ("Bombas Giving Model",                  13, 11,  9,  7),
]
