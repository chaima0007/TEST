"""
CaelumSwarm™ — Green Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Patagonia Green Ads",              99, 97, 95, 93),
    ("IKEA Sustainability Campaign",     93, 90, 88, 86),
    ("Tesla Zero Emission Ads",          85, 82, 80, 78),
    ("Beyond Meat Campaign",             80, 77, 75, 73),
    ("Oatly Advertising",               61, 58, 56, 54),
    ("Allbirds Carbon Footprint Ads",    51, 48, 46, 44),
    ("Loop Industries Campaign",         32, 29, 27, 25),
    ("Ecosia Green Ads",                 13, 11,  9,  7),
]
