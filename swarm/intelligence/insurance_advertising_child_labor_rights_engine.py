"""
CaelumSwarm™ — Insurance Advertising Child Labor Rights Engine
...
ENTITIES = [
    ...
    ("Allianz",    93, 90, 88, 86),
    ("Zurich",     85, 82, 80, 78),
    ("Munich Re",  80, 77, 75, 73),
    ("Generali",   61, 58, 56, 54),
    ("AIG",        51, 48, 46, 44),
    ("Prudential", 32, 29, 27, 25),
    ("MetLife",    13, 11,  9,  7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_insurance_advertising_child_labor_rights_index": idx}
