"""
CaelumSwarm™ — Retail Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Amazon Retail", 99, 97, 95, 93),
    ("Walmart",       93, 90, 88, 86),
    ("Carrefour",     85, 82, 80, 78),
    ("Tesco",         80, 77, 75, 73),
    ("Lidl",          61, 58, 56, 54),
    ("Zara (Inditex)",51, 48, 46, 44),
    ("H&M",           32, 29, 27, 25),
    ("IKEA",          13, 11,  9,  7),
]
...
if __name__ == "__main__":
    ...
    for r in results:
        print(f"  {r['name']:<22} score={r['composite_score']:>6}  level={r['risk_level']}")
    print(f"\navg_composite = {avg}")
