"""
CaelumSwarm™ — Healthcare Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Johnson & Johnson Ads", 99, 97, 95, 93),
    ("Pfizer Campaign",       93, 90, 88, 86),
    ("Roche Advertising",     85, 82, 80, 78),
    ("Novartis Ads",          80, 77, 75, 73),
    ("AbbVie Campaign",       61, 58, 56, 54),
    ("Merck Advertising",     51, 48, 46, 44),
    ("GSK Ads",               32, 29, 27, 25),
    ("AstraZeneca Campaign",  13, 11,  9,  7),
]
