#!/usr/bin/env python3
"""CaelumSwarm™ — Affiliate Advertising Compliance Engine CSDDD 2024/1760"""

ENTITIES = [
    ("Amazon Associates Program", 99, 97, 95, 93),
    ("CJ Affiliate Network", 93, 90, 88, 86),
    ("ShareASale / Awin", 85, 82, 80, 78),
    ("Rakuten Advertising", 80, 77, 75, 73),
    ("Impact Radius Platform", 61, 58, 56, 54),
    ("ClickBank Marketplace", 51, 48, 46, 44),
    ("PartnerStack SaaS", 32, 29, 27, 25),
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_affiliate_index": idx}
