"""
CaelumSwarm™ — Insurtech Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Lemonade",       99, 97, 95, 93),
    ("Root Insurance", 93, 90, 88, 86),
    ("Metromile",      85, 82, 80, 78),
    ("Oscar Health",   80, 77, 75, 73),
    ("Hippo Insurance",61, 58, 56, 54),
    ("Next Insurance", 51, 48, 46, 44),
    ("Coalition",      32, 29, 27, 25),
    ("At-Bay",         13, 11,  9,  7),
]
