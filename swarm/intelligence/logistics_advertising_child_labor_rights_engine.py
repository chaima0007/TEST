"""
CaelumSwarm™ — Logistics Advertising Child Labor Rights Engine
...
ENTITIES = [
    ...
    ("FedEx",            93, 90, 88, 86),
    ("UPS",              85, 82, 80, 78),
    ("Amazon Logistics", 80, 77, 75, 73),
    ("Maersk",           61, 58, 56, 54),
    ("DB Schenker",      51, 48, 46, 44),
    ("XPO Logistics",    32, 29, 27, 25),
    ("CEVA",             13, 11,  9,  7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_logistics_advertising_child_labor_rights_index": idx}
