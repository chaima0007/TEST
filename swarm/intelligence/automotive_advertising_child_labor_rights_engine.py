"""
CaelumSwarm™ — Automotive Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Toyota Advertising",        99, 97, 95, 93),
    ("Volkswagen Campaign",        93, 90, 88, 86),
    ("Ford Motor Ads",             85, 82, 80, 78),
    ("General Motors Campaign",    80, 77, 75, 73),
    ("BMW Advertising",            61, 58, 56, 54),
    ("Mercedes-Benz Ads",          51, 48, 46, 44),
    ("Tesla Campaign",             32, 29, 27, 25),
    ("Stellantis Advertising",     13, 11,  9,  7),
]
