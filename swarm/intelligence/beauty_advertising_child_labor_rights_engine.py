"""
CaelumSwarm™ — Beauty Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("L'Oreal Beauty Ads",         99, 97, 95, 93),
    ("Estée Lauder Campaign",       93, 90, 88, 86),
    ("Sephora Advertising",         85, 82, 80, 78),
    ("MAC Cosmetics Ads",           80, 77, 75, 73),
    ("NARS Campaign",               61, 58, 56, 54),
    ("Fenty Beauty Ads",            51, 48, 46, 44),
    ("NYX Cosmetics",               32, 29, 27, 25),
    ("e.l.f. Beauty Advertising",   13, 11,  9,  7),
]
