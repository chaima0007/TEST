...
def run_patent_revenue_prioritization_engine() -> PatentRevenuePrioritizationEngineResult:
    entities = [
        ...
        PatentEntity(
            ...
            market_size_potential=72.0,
            competitive_moat=75.0,
            filing_urgency=68.0,
            licensing_revenue_potential=70.0,
            primary_pattern="competitive_moat",
        ),
        PatentEntity(
            entity_id="PAT-006",
            ...
            market_size_potential=78.0,
            competitive_moat=65.0,
            filing_urgency=72.0,
            licensing_revenue_potential=68.0,
        ...
        PatentEntity(
            ...
            market_size_potential=55.0,
            competitive_moat=48.0,
            filing_urgency=42.0,
