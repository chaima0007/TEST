"""
CaelumSwarm™ — Food & Beverage Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Coca-Cola Advertising",        99, 97, 95, 93),
    ("PepsiCo Campaign",             93, 90, 88, 86),
    ("McDonald's Ads",               85, 82, 80, 78),
    ("Nestlé Advertising",           80, 77, 75, 73),
    ("Unilever Food Ads",            61, 58, 56, 54),
    ("Kraft Heinz Campaign",         51, 48, 46, 44),
    ("Danone Advertising",           32, 29, 27, 25),
    ("Mondelez International Ads",   13, 11,  9,  7),
]
