"""
CaelumSwarm™ — Biotech Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Moderna",               99, 97, 95, 93),
    ("BioNTech",              93, 90, 88, 86),
    ("Regeneron",             85, 82, 80, 78),
    ("Illumina",              80, 77, 75, 73),
    ("CRISPR Therapeutics",   61, 58, 56, 54),
    ("10x Genomics",          51, 48, 46, 44),
    ("Pacific Biosciences",   32, 29, 27, 25),
    ("Oxford Biomedica",      13, 11,  9,  7),
]
...
if __name__ == "__main__":
    ...
    for r in results:
        print(f"  {r['name']:<25} score={r['composite_score']:>5}  level={r['risk_level']}")
    print(f"\navg_composite = {avg}")
