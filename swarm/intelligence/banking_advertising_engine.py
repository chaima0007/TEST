"""
CaelumSwarm™ — Banking Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("JPMorgan Chase",     99, 97, 95, 93),
    ("BNP Paribas",        93, 90, 88, 86),
    ("HSBC",               85, 82, 80, 78),
    ("Deutsche Bank",      80, 77, 75, 73),
    ("Citigroup",          61, 58, 56, 54),
    ("Société Générale",   51, 48, 46, 44),
    ("ING Group",          32, 29, 27, 25),
    ("Standard Chartered", 13, 11,  9,  7),
]
...
if __name__ == "__main__":
    ...
    for r in results:
        print(f"  {r['name']}: {r['composite_score']} ({r['risk_level']}) — idx {r['estimated_index']}")
