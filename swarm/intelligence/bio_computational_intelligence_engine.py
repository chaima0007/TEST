...
MOCK_ORGANOIDS = [
    ...
    BioComputInput("OR-001","neural_organoid","EMEA",
        ...
        mutation_drift_rate=0.55, cross_substrate_compatibility=0.20,
        ...
        bio_digital_interface_quality=0.12, replication_accuracy=0.45,
    ...
    BioComputInput("OR-006","quantum_bio","MEA",
        viability_score=0.75, computational_coherence=0.72, biological_stability_rate=0.70,
        emergence_complexity_index=0.65, substrate_efficiency_score=0.70,
        mutation_drift_rate=0.30, cross_substrate_compatibility=0.65,
        signal_propagation_fidelity=0.72, metabolic_overhead_ratio=0.32,
        self_repair_capacity=0.70, information_density_score=0.68,
        temporal_resolution_score=0.72, noise_tolerance_level=0.70,
        bio_digital_interface_quality=0.65, replication_accuracy=0.78,
        environmental_sensitivity=0.28, evolutionary_adaptability=0.68),
    # OR-007 membrane_processor NAMER — high/substrate_incompatibility
    BioComputInput("OR-007","membrane_processor","NAMER",
        viability_score=0.48, computational_coherence=0.52, biological_stability_rate=0.45,
        emergence_complexity_index=0.42, substrate_efficiency_score=0.28,
        mutation_drift_rate=0.52, cross_substrate_compatibility=0.28,
        signal_propagation_fidelity=0.52, metabolic_overhead_ratio=0.62,
        self_repair_capacity=0.42, information_density_score=0.48,
        temporal_resolution_score=0.48, noise_tolerance_level=0.40,
        bio_digital_interface_quality=0.38, replication_accuracy=0.52,
