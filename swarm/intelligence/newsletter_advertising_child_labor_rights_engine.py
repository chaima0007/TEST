"""
CaelumSwarm™ — Newsletter Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Substack Ads",             99, 97, 95, 93),
    ("Morning Brew Ads",         93, 90, 88, 86),
    ("The Hustle Ads",           85, 82, 80, 78),
    ("Axios Ads",                80, 77, 75, 73),
    ("Beehiiv Ads",              61, 58, 56, 54),
    ("ConvertKit Ads",           51, 48, 46, 44),
    ("Mailchimp Advertising",    32, 29, 27, 25),
    ("LinkedIn Newsletter Ads",  13, 11,  9,  7),
]
