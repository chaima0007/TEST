"""CaelumSwarm™ — Affiliate Marketing Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL"""

ENTITIES = [
    ("Affiliate Network Platform", 99, 97, 95, 93),
    ("Publisher Partner Network", 93, 90, 88, 86),
    ("Tracking Technology Co", 85, 82, 80, 78),
    ("Commission Management Hub", 80, 77, 75, 73),
    ("Performance Analytics Co", 61, 58, 56, 54),
    ("Content Creator Agency", 51, 48, 46, 44),
