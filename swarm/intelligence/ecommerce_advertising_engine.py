"""CaelumSwarm™ — E-Commerce Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL"""

ENTITIES = [
    ("Marketplace Platform Corp", 99, 97, 95, 93),
    ("Logistics & Fulfillment Co", 93, 90, 88, 86),
    ("Payment Gateway Systems", 85, 82, 80, 78),
    ("Warehouse Automation MFG", 80, 77, 75, 73),
    ("Last Mile Delivery Corp", 61, 58, 56, 54),
    ("Packaging Supply Chain", 51, 48, 46, 44),
    ("Returns Processing Co", 32, 29, 27, 25),
    ("Gig Labor Platform", 13, 11, 9, 7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_ecommerce_index": idx}
