"""
CaelumSwarm™ — Display Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    # (sub1, sub2, sub3, sub4) — tuples FIXES
    ("Google Display Network",    99, 97, 95, 93),  # critique
    ("Meta Audience Network",     93, 90, 88, 86),  # critique
    ("Trade Desk (Display)",      85, 82, 80, 78),  # critique
    ("Xandr Display",             80, 77, 75, 73),  # critique
    ("Verizon Media Display",     61, 58, 56, 54),  # élevé
    ("Taboola Display",           51, 48, 46, 44),  # élevé
    ("Outbrain Display",          32, 29, 27, 25),  # modéré
    ("Index Exchange",            13, 11,  9,  7),  # faible
]
