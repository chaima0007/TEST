"""
CaelumSwarm™ — Blockchain Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Coinbase",          99, 97, 95, 93),
    ("Binance",           93, 90, 88, 86),
    ("Chainalysis",       85, 82, 80, 78),
    ("Ripple",            80, 77, 75, 73),
    ("ConsenSys",         61, 58, 56, 54),
    ("Alchemy",           51, 48, 46, 44),
    ("Fireblocks",        32, 29, 27, 25),
    ("Anchorage Digital", 13, 11,  9,  7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_blockchain_advertising_index": idx}
