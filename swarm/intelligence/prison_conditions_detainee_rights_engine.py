...
def run():
    entities = [
        ...
        EntityScore(
            entity_id="VEN",
            name="Venezuela",
            sub1_overcrowding_conditions=9.2,
            sub2_torture_ill_treatment=9.0,
            sub3_medical_legal_access_deficit=8.8,
            sub4_rehabilitation_rights_gap=8.5,
        ),
        EntityScore(
            entity_id="LBY",
            name="Libye",
            sub1_overcrowding_conditions=9.0,
            sub2_torture_ill_treatment=8.8,
            sub3_medical_legal_access_deficit=9.0,
            sub4_rehabilitation_rights_gap=8.2,
        ),
        EntityScore(
            entity_id="RUS",
            name="Russie",
            sub1_overcrowding_conditions=8.0,
            sub2_torture_ill_treatment=8.5,
            sub3_medical_legal_access_deficit=8.2,
            sub4_rehabilitation_rights_gap=8.0,
        ),
        EntityScore(
            entity_id="ETH",
            name="Éthiopie",
            sub1_overcrowding_conditions=8.5,
            sub2_torture_ill_treatment=8.2,
            sub3_medical_legal_access_deficit=8.0,
        ...
        EntityScore(
            ...
            sub2_torture_ill_treatment=5.5,
            sub3_medical_legal_access_deficit=5.2,
            sub4_rehabilitation_rights_gap=5.0,
        ),
        EntityScore(
            entity_id="PHL",
            name="Philippines",
            sub1_overcrowding_conditions=5.5,
            sub2_torture_ill_treatment=5.2,
            sub3_medical_legal_access_deficit=5.0,
            sub4_rehabilitation_rights_gap=4.5,
        ),
        # 1 modéré (20 <= composite_score < 40)
        EntityScore(
            entity_id="USA",
            name="États-Unis",
            sub1_overcrowding_conditions=3.8,
            sub2_torture_ill_treatment=3.5,
            sub3_medical_legal_access_deficit=3.2,
            sub4_rehabilitation_rights_gap=3.5,
        ),
