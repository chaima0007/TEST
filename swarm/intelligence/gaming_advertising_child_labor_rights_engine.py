...
ENTITIES = [
    ("Google AdMob Gaming",      99, 97, 95, 93),
    ("Meta Gaming Ads",          93, 90, 88, 86),
    ("Unity Ads Gaming",         85, 82, 80, 78),
    ("IronSource Gaming",        80, 77, 75, 73),
    ("AppLovin Gaming",          61, 58, 56, 54),
    ("Vungle Gaming",            51, 48, 46, 44),
    ("Digital Turbine Gaming",   32, 29, 27, 25),
    ("Chartboost Gaming",        13, 11,  9,  7),
]
