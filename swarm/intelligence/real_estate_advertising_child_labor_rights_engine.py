"""
CaelumSwarm™ — Real Estate Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Zillow Advertising",              99, 97, 95, 93),
    ("Realtor.com Ads",                 93, 90, 88, 86),
    ("Trulia Campaign",                 85, 82, 80, 78),
    ("RE/MAX Advertising",              80, 77, 75, 73),
    ("Century 21 Ads",                  61, 58, 56, 54),
    ("Coldwell Banker Campaign",        51, 48, 46, 44),
    ("Keller Williams Ads",             32, 29, 27, 25),
    ("Compass Real Estate Advertising", 13, 11,  9,  7),
]
