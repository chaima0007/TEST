"""
CaelumSwarm™ — Search Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    # (sub1, sub2, sub3, sub4) — tuples FIXES
    ("Google Search Ads",          99, 97, 95, 93),  # critique
    ("Microsoft Bing Ads",         93, 90, 88, 86),  # critique
    ("Yahoo Search Ads",           85, 82, 80, 78),  # critique
    ("Baidu Search Ads",           80, 77, 75, 73),  # critique
    ("DuckDuckGo Ads",             61, 58, 56, 54),  # élevé
    ("Amazon Sponsored Search",    51, 48, 46, 44),  # élevé
    ("Apple Search Ads",           32, 29, 27, 25),  # modéré
    ("Yandex Direct",              13, 11,  9,  7),  # faible
]
