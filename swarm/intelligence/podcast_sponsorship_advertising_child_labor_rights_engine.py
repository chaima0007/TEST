"""
CaelumSwarm™ — Podcast Sponsorship Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Spotify Podcast Ads",            99, 97, 95, 93),
    ("Apple Podcasts Subscriptions",   93, 90, 88, 86),
    ("iHeartMedia",                    85, 82, 80, 78),
    ("Audacy",                         80, 77, 75, 73),
    ("Wondery",                        61, 58, 56, 54),
    ("Podtrac",                        51, 48, 46, 44),
    ("Midroll (SiriusXM)",             32, 29, 27, 25),
    ("Acast",                          13, 11,  9,  7),
]
