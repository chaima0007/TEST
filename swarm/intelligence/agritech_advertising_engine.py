"""
CaelumSwarm™ — Agritech Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("John Deere",                99, 97, 95, 93),
    ("Trimble Agriculture",       93, 90, 88, 86),
    ("AgLeader",                  85, 82, 80, 78),
    ("Granular (Corteva)",        80, 77, 75, 73),
    ("Climate Corp",              61, 58, 56, 54),
    ("Indigo Ag",                 51, 48, 46, 44),
    ("Farmers Business Network",  32, 29, 27, 25),
    ("Taranis",                   13, 11,  9,  7),
]
...
if __name__ == "__main__":
    ...
    for r in results:
        print(f"  {r['name']:<30} score={r['composite_score']:>5}  level={r['risk_level']}")
    print(f"\navg_composite = {avg}")
