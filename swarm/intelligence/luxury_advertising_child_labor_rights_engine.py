...
ENTITIES = [
    ("Louis Vuitton Ads",   99, 97, 95, 93),
    ("Chanel Advertising",  93, 90, 88, 86),
    ("Rolex Campaign",      85, 82, 80, 78),
    ("Hermès Marketing",    80, 77, 75, 73),
    ("Gucci Advertising",   61, 58, 56, 54),
    ("Dior Campaign",       51, 48, 46, 44),
    ("Prada Ads",           32, 29, 27, 25),
    ("Cartier Advertising", 13, 11,  9,  7),
]
