...
ENTITIES = [
    ("Contextual AI Platform", 99, 97, 95, 93),
    ("Brand Safety Network", 93, 90, 88, 86),
    ("Content Analysis Co", 85, 82, 80, 78),
    ("Semantic Targeting Systems", 80, 77, 75, 73),
    ("Publisher Alliance Hub", 61, 58, 56, 54),
    ("Creative Optimization Co", 51, 48, 46, 44),
    ("Data Labeling Agency", 32, 29, 27, 25),
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_contextual_index": idx}
