"""
CaelumSwarm™ — DataTech Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Snowflake",     99, 97, 95, 93),
    ("Databricks",    93, 90, 88, 86),
    ("Palantir",      85, 82, 80, 78),
    ("dbt Labs",      80, 77, 75, 73),
    ("Fivetran",      61, 58, 56, 54),
    ("Airbyte",       51, 48, 46, 44),
    ("Monte Carlo",   32, 29, 27, 25),
    ("Atlan",         13, 11,  9,  7),
]
...
if __name__ == "__main__":
    ...
    for r in results:
        print(f"  {r['name']:<24} score={r['composite_score']:>6}  level={r['risk_level']}  idx={r['estimated_index']}")
