"""
CaelumSwarm™ — Robotics Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Boston Dynamics",   99, 97, 95, 93),
    ("ABB Robotics",      93, 90, 88, 86),
    ("KUKA",              85, 82, 80, 78),
    ("Fanuc",             80, 77, 75, 73),
    ("Universal Robots",  61, 58, 56, 54),
    ("Symbotic",          51, 48, 46, 44),
    ("Berkshire Grey",    32, 29, 27, 25),
    ("Sarcos Technology", 13, 11,  9,  7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_robotics_advertising_index": idx}
