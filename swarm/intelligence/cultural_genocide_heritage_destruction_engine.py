...
MOCK_ENTITIES: list[CulturalGenocideHeritageDestructionEntity] = [
    ...
    CulturalGenocideHeritageDestructionEntity(
        "CGH-007",
        "Mexique/Langues Indigènes 60+ Menacées Extinction Sans Programme",
        "Mexique",
        "60+ Langues Indigènes Menacées Extinction, Nahuatl Zapotèque Mixe Déclin Accéléré, INALI Ressources Insuffisantes, Peuples Indigènes Accès Limité Droits Culturels",
        22.0, 25.0, 20.0, 24.0,
    ),
    CulturalGenocideHeritageDestructionEntity(
        "CGH-008",
