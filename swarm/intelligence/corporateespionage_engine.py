...
ENTITIES = [
    {"name": "State-Sponsored IP Theft", "indicators": [99,97,95,93, 98,96,94,92, 97,95,93,91, 96,94,92,90]},
    {"name": "Industrial Espionage EU", "indicators": [93,90,88,86, 92,89,87,85, 91,88,86,84, 90,87,85,83]},
    {"name": "Trade Secret Theft USA", "indicators": [85,82,80,78, 84,81,79,77, 83,80,78,76, 82,79,77,75]},
    {"name": "Cyber Corporate Spying", "indicators": [80,77,75,73, 79,76,74,72, 78,75,73,71, 77,74,72,70]},
    {"name": "Employee Data Breach", "indicators": [61,58,56,54, 60,57,55,53, 59,56,54,52, 58,55,53,51]},
    {"name": "Supply Chain Intel Theft", "indicators": [51,48,46,44, 50,47,45,43, 49,46,44,42, 48,45,43,41]},
    {"name": "Patent Infringement", "indicators": [32,29,27,25, 31,28,26,24, 30,27,25,23, 29,26,24,22]},
    {"name": "Corporate Whistleblowing", "indicators": [13,11,9,7, 12,10,8,6, 11,9,7,5, 10,8,6,4]},
]
