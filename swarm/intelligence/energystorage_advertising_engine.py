"""CaelumSwarm™ — Energy Storage Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL"""

ENTITIES = [
    ("Battery Storage MFG", 99, 97, 95, 93),
    ("Lithium Mining Corp", 93, 90, 88, 86),
    ("Grid Scale Storage Co", 85, 82, 80, 78),
    ("Cobalt Supply Chain", 80, 77, 75, 73),
    ("Flow Battery Systems", 61, 58, 56, 54),
    ("Compressed Air Storage", 51, 48, 46, 44),
    ("Thermal Storage Tech", 32, 29, 27, 25),
    ("Mineral Extraction Labor", 13, 11, 9, 7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_energystorage_index": idx}
...
if __name__ == "__main__":
    ...
    print("✓ Engine energystorage valide")
