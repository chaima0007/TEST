"""
CaelumSwarm™ — Micro-Influencer Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("LTK (LikeToKnowIt)", 99, 97, 95, 93),
    ("Fohr",               93, 90, 88, 86),
    ("Influencer.co",      85, 82, 80, 78),
    ("Tribe Dynamics",     80, 77, 75, 73),
    ("Heepsy",             61, 58, 56, 54),
    ("Modash",             51, 48, 46, 44),
    ("Storyclash",         32, 29, 27, 25),
    ("NeoReach Micro",     13, 11,  9,  7),
]
