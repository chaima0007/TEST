"""
CaelumSwarm™ — CleanTech Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Tesla Energy",    99, 97, 95, 93),
    ("Vestas",          93, 90, 88, 86),
    ("Siemens Gamesa",  85, 82, 80, 78),
    ("Orsted",          80, 77, 75, 73),
    ("First Solar",     61, 58, 56, 54),
    ("Bloom Energy",    51, 48, 46, 44),
    ("Plug Power",      32, 29, 27, 25),
    ("Sunrun",          13, 11,  9,  7),
]
...
if __name__ == "__main__":
    ...
    for r in results:
        print(f"  {r['name']:<20} score={r['composite_score']:>6.2f}  level={r['risk_level']:<10}  idx={r['estimated_index']}")
    print(f"\navg_composite = {avg}")
