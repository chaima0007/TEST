"""
CaelumSwarm™ — Web3 Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("OpenSea",        99, 97, 95, 93),
    ("Uniswap Labs",   93, 90, 88, 86),
    ("Alchemy",        85, 82, 80, 78),
    ("Infura",         80, 77, 75, 73),
    ("Moralis",        61, 58, 56, 54),
    ("QuickNode",      51, 48, 46, 44),
    ("The Graph",      32, 29, 27, 25),
    ("Chainlink Labs", 13, 11,  9,  7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_web3_advertising_index": idx}
