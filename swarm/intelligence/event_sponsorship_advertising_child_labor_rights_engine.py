"""
CaelumSwarm™ — Event Sponsorship Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Eventbrite Ads",          99, 97, 95, 93),
    ("Cvent Advertising",       93, 90, 88, 86),
    ("Hopin Ads",               85, 82, 80, 78),
    ("Splash Event Marketing",  80, 77, 75, 73),
    ("Bizzabo Ads",             61, 58, 56, 54),
    ("vFairs Advertising",      51, 48, 46, 44),
    ("Hubilo Ads",              32, 29, 27, 25),
    ("SpotMe Advertising",      13, 11,  9,  7),
]
