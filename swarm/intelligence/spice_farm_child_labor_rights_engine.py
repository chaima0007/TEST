#!/usr/bin/env python3
"""CaelumSwarm™ — Spice Farm Child Labor Rights Engine (Wave 295)

Domaine : travail des enfants dans les exploitations d'épices
Zones géographiques : Indonésie, Inde, Guatemala — girofle, muscade, poivre
"""
...
def compute():
    ...
    for entity in ENTITIES:
        ...
        results.append({
            ...
            "estimated_spice_farm_child_labor_index": round(composite / 100 * 10, 2),
        })
