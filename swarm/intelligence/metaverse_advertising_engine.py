...
ENTITIES = [
    ("Roblox",         99, 97, 95, 93),
    ("Epic Games",     93, 90, 88, 86),
    ("Decentraland",   85, 82, 80, 78),
    ("The Sandbox",    80, 77, 75, 73),
    ("Niantic",        61, 58, 56, 54),
    ("Spatial",        51, 48, 46, 44),
    ("Somnium Space",  32, 29, 27, 25),
    ("Improbable",     13, 11,  9,  7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_metaverse_advertising_index": idx}
