"""
CaelumSwarm™ — Referral Marketing Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("ReferralCandy",          99, 97, 95, 93),
    ("Viral Loops",            93, 90, 88, 86),
    ("GrowSurf",               85, 82, 80, 78),
    ("InviteReferrals",        80, 77, 75, 73),
    ("Referral Factory",       61, 58, 56, 54),
    ("Post Affiliate Pro",     51, 48, 46, 44),
    ("Tapfiliate",             32, 29, 27, 25),
    ("PartnerStack Referral",  13, 11,  9,  7),
]
