"""
CaelumSwarm™ — Cybersecurity Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("CrowdStrike",          99, 97, 95, 93),
    ("Palo Alto Networks",   93, 90, 88, 86),
    ("Fortinet",             85, 82, 80, 78),
    ("Check Point",          80, 77, 75, 73),
    ("SentinelOne",          61, 58, 56, 54),
    ("Zscaler",              51, 48, 46, 44),
    ("Okta",                 32, 29, 27, 25),
    ("Darktrace",            13, 11,  9,  7),
]
