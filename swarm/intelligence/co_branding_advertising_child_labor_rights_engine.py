"""
CaelumSwarm™ — Co-Branding Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Nike x Apple",                  99, 97, 95, 93),
    ("Spotify x Uber",                93, 90, 88, 86),
    ("GoPro x Red Bull",              85, 82, 80, 78),
    ("BMW x Louis Vuitton",           80, 77, 75, 73),
    ("Kanye x Adidas (Yeezy)",        61, 58, 56, 54),
    ("Supreme x Louis Vuitton",       51, 48, 46, 44),
    ("Taco Bell x Doritos",           32, 29, 27, 25),
    ("Starbucks x Spotify",           13, 11,  9,  7),
]
