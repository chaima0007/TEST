"""
CaelumSwarm™ — Video Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    # (sub1, sub2, sub3, sub4) — tuples FIXES
    ("YouTube Ads",          99, 97, 95, 93),  # critique
    ("Meta Video Ads",       93, 90, 88, 86),  # critique
    ("TikTok Video Ads",     85, 82, 80, 78),  # critique
    ("Snapchat Video Ads",   80, 77, 75, 73),  # critique
    ("Twitter/X Video Ads",  61, 58, 56, 54),  # élevé
    ("LinkedIn Video Ads",   51, 48, 46, 44),  # élevé
    ("Pinterest Video Ads",  32, 29, 27, 25),  # modéré
    ("Amazon Video Ads",     13, 11,  9,  7),  # faible
]
