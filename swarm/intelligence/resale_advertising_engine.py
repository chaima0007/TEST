"""CaelumSwarm™ — Resale Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL"""

ENTITIES = [
    ("Resale Platform Corp", 99, 97, 95, 93),
    ("Authentication Services", 93, 90, 88, 86),
    ("Secondhand Logistics MFG", 85, 82, 80, 78),
    ("Refurbishment Center Ops", 80, 77, 75, 73),
    ("Consignment Network Co", 61, 58, 56, 54),
    ("Grading & Inspection Co", 51, 48, 46, 44),
    ("Repair Workshop Network", 32, 29, 27, 25),
    ("Collection Labor Supply", 13, 11, 9, 7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_resale_index": idx}
