...
MOCK_ENTITIES = [
    ...
    EconomicSingularityInput(
        ...
        ai_labor_displacement_velocity=0.18,
        productivity_growth_acceleration=0.35,
        capital_concentration_rate=0.30,
        conventional_rule_breakdown_index=0.22,
        automation_penetration_depth=0.15,
        economic_phase_transition_proximity=0.15,
        value_creation_redistribution_gap=0.28,
        post_scarcity_emergence_index=0.20,
        human_economic_relevance_erosion=0.18,
        institutional_adaptation_lag=0.25,
        winner_take_all_intensification=0.22,
        economic_complexity_explosion=0.18,
        regulatory_obsolescence_rate=0.20,
        monetary_system_stress=0.28,
        social_contract_dissolution_risk=0.22,
        new_economy_emergence_rate=0.25,
        singularity_resistance_capacity=0.75,
    ),
    ...
    EconomicSingularityInput(
        ...
        ai_labor_displacement_velocity=0.78,
        productivity_growth_acceleration=0.82,
        capital_concentration_rate=0.70,
        conventional_rule_breakdown_index=0.62,
        automation_penetration_depth=0.75,
        economic_phase_transition_proximity=0.68,
        value_creation_redistribution_gap=0.72,
        post_scarcity_emergence_index=0.65,
        human_economic_relevance_erosion=0.70,
        institutional_adaptation_lag=0.60,
        winner_take_all_intensification=0.65,
        ...
        new_economy_emergence_rate=0.75,
        singularity_resistance_capacity=0.20,
    ),
]
