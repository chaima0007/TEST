#!/usr/bin/env python3
"""
Protest Criminalization Rights Engine — CaelumSwarm™
EU CSDDD 2024/1760 Compliance Intelligence
"""
import random
random.seed(42)

AGENT_NAME = "Protest Criminalization Rights Engine Agent"
...
def run_engine():
    ...
    for (eid, s1, s2, s3, s4) in ENTITIES:
        ...
        estimated_protest_criminalization_index = round(composite / 100 * 10, 2)
        results.append({
            "entity_id": eid,
            "anti_protest_legislation_score": s1,
            "activist_imprisonment_score": s2,
            "excessive_force_protest_score": s3,
            "assembly_permit_denial_score": s4,
            "composite_score": composite,
            "risk_level": risk,
            "estimated_protest_criminalization_index": estimated_protest_criminalization_index
        })
