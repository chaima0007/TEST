...
def run_sexual_orientation_gender_identity_rights_engine() -> SexualOrientationGenderIdentityRightsEngineResult:
    entities = [
        ...
        SexualOrientationGenderIdentityRightsEntity(
            ...
            country="Russie",
            criminalization_legal_penalty_severity_score=78.0,
            state_sanctioned_violence_impunity_score=76.0,
            social_discrimination_hate_crime_exposure_score=82.0,
            legal_protection_recognition_gap_score=84.0,
        ...
        SexualOrientationGenderIdentityRightsEntity(
            ...
            country="Jamaïque",
            criminalization_legal_penalty_severity_score=52.0,
            state_sanctioned_violence_impunity_score=48.0,
            social_discrimination_hate_crime_exposure_score=55.0,
            legal_protection_recognition_gap_score=50.0,
            primary_pattern="social_discrimination_hate_crime_exposure",
        ),
        SexualOrientationGenderIdentityRightsEntity(
            entity_id="SGI-007",
            name="Canada/Modèle Protection — Résidus Discriminatoires Persistants Certaines Provinces, Progrès Inégal Régions",
            country="Canada",
            criminalization_legal_penalty_severity_score=22.0,
            state_sanctioned_violence_impunity_score=18.0,
            social_discrimination_hate_crime_exposure_score=28.0,
            legal_protection_recognition_gap_score=20.0,
            primary_pattern="social_discrimination_hate_crime_exposure",
        ),
        SexualOrientationGenderIdentityRightsEntity(
            entity_id="SGI-008",
