"""CaelumSwarm™ — Dropshipping Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL"""

ENTITIES = [
    ("Dropship Platform Corp", 99, 97, 95, 93),
    ("Overseas Supplier Network", 93, 90, 88, 86),
    ("Print On Demand MFG", 85, 82, 80, 78),
    ("Automated Fulfillment Co", 80, 77, 75, 73),
    ("Niche Product Sourcing", 61, 58, 56, 54),
    ("Shipping Aggregator Co", 51, 48, 46, 44),
    ("Returns Management Co", 32, 29, 27, 25),
    ("Factory Labor Supply", 13, 11, 9, 7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_dropshipping_index": idx}
...
if __name__ == "__main__":
    ...
    print("✓ Engine dropshipping valide")
