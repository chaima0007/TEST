"""
CaelumSwarm™ — Agriculture Advertising Child Labor Rights Engine
...
ENTITIES = [
    ...
    ("ADM",               93, 90, 88, 86),
    ("Bunge",             85, 82, 80, 78),
    ("Louis Dreyfus",     80, 77, 75, 73),
    ("Nestlé Agri",       61, 58, 56, 54),
    ("Syngenta",          51, 48, 46, 44),
    ("Bayer CropScience", 32, 29, 27, 25),
    ("BASF Agro",         13, 11,  9,  7),
]
