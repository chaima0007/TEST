"""
CaelumSwarm™ — Foodtech Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Beyond Meat",      99, 97, 95, 93),
    ("Impossible Foods", 93, 90, 88, 86),
    ("Oatly",            85, 82, 80, 78),
    ("NotCo",            80, 77, 75, 73),
    ("Eat Just",         61, 58, 56, 54),
    ("Apeel Sciences",   51, 48, 46, 44),
    ("Perfect Day",      32, 29, 27, 25),
    ("Meati Foods",      13, 11,  9,  7),
]
...
if __name__ == "__main__":
    ...
    for r in results:
        print(f"  {r['name']:<20} score={r['composite_score']:>5}  level={r['risk_level']}")
    print(f"\navg_composite = {avg}")
