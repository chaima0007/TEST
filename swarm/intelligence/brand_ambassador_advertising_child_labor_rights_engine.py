"""
CaelumSwarm™ — Brand Ambassador Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Ambassador Software", 99, 97, 95, 93),
    ("Referral Rock",       93, 90, 88, 86),
    ("Extole",              85, 82, 80, 78),
    ("Friendbuy",           80, 77, 75, 73),
    ("Yotpo Loyalty",       61, 58, 56, 54),
    ("Smile.io",            51, 48, 46, 44),
    ("LoyaltyLion",         32, 29, 27, 25),
    ("Zinrelo",             13, 11,  9,  7),
]
