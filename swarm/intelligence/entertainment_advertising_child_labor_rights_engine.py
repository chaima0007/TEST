"""
CaelumSwarm™ — Entertainment Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Walt Disney",       99, 97, 95, 93),
    ("Universal Pictures",93, 90, 88, 86),
    ("Sony Pictures",     85, 82, 80, 78),
    ("Paramount",         80, 77, 75, 73),
    ("Warner Bros",       61, 58, 56, 54),
    ("Lionsgate",         51, 48, 46, 44),
    ("MGM",               32, 29, 27, 25),
    ("AMC Networks",      13, 11,  9,  7),
]
