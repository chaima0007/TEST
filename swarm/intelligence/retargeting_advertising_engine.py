...
ENTITIES = [
    ("Retargeting Platform Corp", 99, 97, 95, 93),
    ("Cookie Management Provider", 93, 90, 88, 86),
    ("Pixel Technology Co", 85, 82, 80, 78),
    ("Audience Data Systems", 80, 77, 75, 73),
    ("Ad Serving Network Hub", 61, 58, 56, 54),
    ("Creative Optimization Co", 51, 48, 46, 44),
    ("Data Processing Agency", 32, 29, 27, 25),
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_retargeting_index": idx}
