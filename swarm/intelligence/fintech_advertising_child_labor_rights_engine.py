"""
CaelumSwarm™ — Fintech Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("PayPal Advertising", 99, 97, 95, 93),
    ("Stripe Campaign",    93, 90, 88, 86),
    ("Square Ads",         85, 82, 80, 78),
    ("Revolut Advertising",80, 77, 75, 73),
    ("Wise Campaign",      61, 58, 56, 54),
    ("N26 Ads",            51, 48, 46, 44),
    ("Klarna Advertising", 32, 29, 27, 25),
    ("Affirm Campaign",    13, 11,  9,  7),
]
