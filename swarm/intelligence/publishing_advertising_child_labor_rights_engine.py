"""
CaelumSwarm™ — Publishing Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Penguin Random House", 99, 97, 95, 93),
    ("HarperCollins",        93, 90, 88, 86),
    ("Simon & Schuster",     85, 82, 80, 78),
    ("Hachette",             80, 77, 75, 73),
    ("Macmillan",            61, 58, 56, 54),
    ("Scholastic",           51, 48, 46, 44),
    ("Wiley",                32, 29, 27, 25),
    ("Elsevier",             13, 11,  9,  7),
]
