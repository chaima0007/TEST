"""
CaelumSwarm™ — Media Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("News Corp",       99, 97, 95, 93),
    ("Comcast",         93, 90, 88, 86),
    ("ViacomCBS",       85, 82, 80, 78),
    ("WarnerMedia",     80, 77, 75, 73),
    ("NBCUniversal",    61, 58, 56, 54),
    ("Fox Corporation", 51, 48, 46, 44),
    ("Discovery",       32, 29, 27, 25),
    ("Hearst",          13, 11,  9,  7),
]
