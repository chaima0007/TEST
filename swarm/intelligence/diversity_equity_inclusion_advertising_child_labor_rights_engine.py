"""
CaelumSwarm™ — Diversity Equity Inclusion Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Nike Equality Campaign",                    99, 97, 95, 93),
    ("Microsoft Inclusive Design Ads",            93, 90, 88, 86),
    ("Google Diversity Ads",                      85, 82, 80, 78),
    ("Procter & Gamble Widen the Screen",         80, 77, 75, 73),
    ("Mastercard True Name Campaign",             61, 58, 56, 54),
    ("Unilever Unstereotype",                     51, 48, 46, 44),
    ("L'Oreal Diversity Campaign",                32, 29, 27, 25),
    ("Ben & Jerry's Racial Justice Ads",          13, 11,  9,  7),
]
