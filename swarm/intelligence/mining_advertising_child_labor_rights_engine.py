"""
CaelumSwarm™ — Mining Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Glencore",          99, 97, 95, 93),
    ("Rio Tinto",         93, 90, 88, 86),
    ("BHP",               85, 82, 80, 78),
    ("Anglo American",    80, 77, 75, 73),
    ("Vale",              61, 58, 56, 54),
    ("Freeport-McMoRan",  51, 48, 46, 44),
    ("Barrick Gold",      32, 29, 27, 25),
    ("Newmont",           13, 11,  9,  7),
]
