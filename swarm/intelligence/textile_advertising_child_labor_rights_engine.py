"""
CaelumSwarm™ — Textile Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Zara (Inditex)",  99, 97, 95, 93),
    ("H&M",             93, 90, 88, 86),
    ("SHEIN",           85, 82, 80, 78),
    ("Gap",             80, 77, 75, 73),
    ("PVH Corp",        61, 58, 56, 54),
    ("Hanesbrands",     51, 48, 46, 44),
    ("Fast Retailing",  32, 29, 27, 25),
    ("Tapestry",        13, 11,  9,  7),
]
