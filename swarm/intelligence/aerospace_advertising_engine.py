"""
CaelumSwarm™ — Aerospace Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Lockheed Martin",   99, 97, 95, 93),
    ("Boeing",            93, 90, 88, 86),
    ("Airbus",            85, 82, 80, 78),
    ("Raytheon Technologies", 80, 77, 75, 73),
    ("Northrop Grumman",  61, 58, 56, 54),
    ("General Dynamics",  51, 48, 46, 44),
    ("Leonardo S.p.A.",   32, 29, 27, 25),
    ("Embraer",           13, 11,  9,  7),
]
