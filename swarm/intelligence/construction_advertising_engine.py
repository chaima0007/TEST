"""
CaelumSwarm™ — Construction Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Bouygues Construction",  99, 97, 95, 93),
    ("VINCI Construction",     93, 90, 88, 86),
    ("ACS Group",              85, 82, 80, 78),
    ("Skanska",                80, 77, 75, 73),
    ("Balfour Beatty",         61, 58, 56, 54),
    ("Hochtief",               51, 48, 46, 44),
    ("Strabag",                32, 29, 27, 25),
    ("China State Construction", 13, 11,  9,  7),
]
...
if __name__ == "__main__":
    ...
    for r in results:
        print(f"  {r['name']}: {r['composite_score']} ({r['risk_level']}) → index {r['estimated_index']}")
    print(f"\navg_composite: {avg}")
