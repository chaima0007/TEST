"""
CaelumSwarm™ — AR/VR Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Meta Reality Labs",      99, 97, 95, 93),
    ("Apple Vision Pro",       93, 90, 88, 86),
    ("Microsoft HoloLens",     85, 82, 80, 78),
    ("Snap AR",                80, 77, 75, 73),
    ("Niantic",                61, 58, 56, 54),
    ("Varjo",                  51, 48, 46, 44),
    ("Magic Leap",             32, 29, 27, 25),
    ("Matterport",             13, 11,  9,  7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_arvr_advertising_index": idx}
