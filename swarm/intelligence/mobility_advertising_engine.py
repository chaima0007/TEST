"""
CaelumSwarm™ — Mobility Advertising Child Labor Rights Engine
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_mobility_advertising_index": idx}
