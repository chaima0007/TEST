...
MOCK_GAMES: List[GameInput] = [
    ...
    GameInput(
        ...
        nash_equilibrium_stability=0.22, dominant_strategy_clarity=0.52,
        cooperative_surplus_potential=0.48, defection_temptation_index=0.72,
        information_asymmetry_score=0.55, commitment_credibility_score=0.40,
        payoff_matrix_volatility=0.55, iteration_learning_rate=0.48,
        coalition_stability_score=0.42, threat_credibility_score=0.55,
        outside_option_strength=0.55, time_pressure_index=0.55,
        reputation_effect_weight=0.45, zero_sum_intensity=0.52,
        signaling_effectiveness=0.44, punishment_mechanism_strength=0.52,
    ...
    GameInput(
        ...
        nash_equilibrium_stability=0.22, dominant_strategy_clarity=0.35,
        cooperative_surplus_potential=0.28, defection_temptation_index=0.65,
        information_asymmetry_score=0.72, commitment_credibility_score=0.20,
    ...
    GameInput(
        ...
        nash_equilibrium_stability=0.60, dominant_strategy_clarity=0.62,
        cooperative_surplus_potential=0.65, defection_temptation_index=0.38,
        information_asymmetry_score=0.38, commitment_credibility_score=0.65,
        payoff_matrix_volatility=0.32, iteration_learning_rate=0.62,
        coalition_stability_score=0.60, threat_credibility_score=0.62,
        outside_option_strength=0.52, time_pressure_index=0.35,
        reputation_effect_weight=0.62, zero_sum_intensity=0.30,
        signaling_effectiveness=0.58, punishment_mechanism_strength=0.60,
        bargaining_power_score=0.55,
    ),
    # GM-007 talent_competition NAMER — high / defection_cascade
    GameInput(
        game_id="GM-007", game_type="talent_competition", region="NAMER",
        nash_equilibrium_stability=0.40, dominant_strategy_clarity=0.48,
        cooperative_surplus_potential=0.42, defection_temptation_index=0.68,
        information_asymmetry_score=0.52, commitment_credibility_score=0.42,
        payoff_matrix_volatility=0.55, iteration_learning_rate=0.45,
        coalition_stability_score=0.30, threat_credibility_score=0.50,
        outside_option_strength=0.62, time_pressure_index=0.60,
        reputation_effect_weight=0.42, zero_sum_intensity=0.55,
        signaling_effectiveness=0.42, punishment_mechanism_strength=0.45,
        bargaining_power_score=0.48,
    ),
