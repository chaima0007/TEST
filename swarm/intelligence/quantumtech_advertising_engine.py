"""
CaelumSwarm™ — QuantumTech Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("IBM Quantum",        99, 97, 95, 93),
    ("Google Quantum AI",  93, 90, 88, 86),
    ("IonQ",               85, 82, 80, 78),
    ("Rigetti Computing",  80, 77, 75, 73),
    ("D-Wave",             61, 58, 56, 54),
    ("PsiQuantum",         51, 48, 46, 44),
    ("Quantinuum",         32, 29, 27, 25),
    ("QuEra Computing",    13, 11,  9,  7),
]
...
def compute(entity):
    ...
    return {"name": name, "composite_score": score, "risk_level": level, "estimated_quantumtech_advertising_index": idx}
