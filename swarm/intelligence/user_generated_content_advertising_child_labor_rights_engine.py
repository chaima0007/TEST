"""
CaelumSwarm™ — User Generated Content Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("TINT UGC",          99, 97, 95, 93),
    ("Stackla (Nosto)",   93, 90, 88, 86),
    ("Bazaarvoice",       85, 82, 80, 78),
    ("PowerReviews",      80, 77, 75, 73),
    ("Yotpo UGC",         61, 58, 56, 54),
    ("Emplifi UGC",       51, 48, 46, 44),
    ("Curalate",          32, 29, 27, 25),
    ("Olapic",            13, 11,  9,  7),
]
