"""
CaelumSwarm™ — Travel Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Booking.com Ads",        99, 97, 95, 93),
    ("Airbnb Advertising",     93, 90, 88, 86),
    ("Expedia Campaign",       85, 82, 80, 78),
    ("TripAdvisor Ads",        80, 77, 75, 73),
    ("Hotels.com Campaign",    61, 58, 56, 54),
    ("Kayak Advertising",      51, 48, 46, 44),
    ("Trivago Ads",            32, 29, 27, 25),
    ("Skyscanner Advertising", 13, 11,  9,  7),
]
