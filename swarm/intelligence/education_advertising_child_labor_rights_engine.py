"""
CaelumSwarm™ — Education Advertising Child Labor Rights Engine
© 2024-2026 Caelum Partners SPRL
"""

ENTITIES = [
    ("Coursera Ads",           99, 97, 95, 93),
    ("Udemy Campaign",         93, 90, 88, 86),
    ("LinkedIn Learning",      85, 82, 80, 78),
    ("Khan Academy Ads",       80, 77, 75, 73),
    ("Duolingo Advertising",   61, 58, 56, 54),
    ("Chegg Campaign",         51, 48, 46, 44),
    ("edX Ads",                32, 29, 27, 25),
    ("MasterClass Advertising",13, 11,  9,  7),
]
