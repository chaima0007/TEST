...
## ERR-020 — « Correctif APPLIQUÉ » pour un correctif qui vit sur une branche non mergée (2026-09-14)
...
13. **« Écrit » n'est pas « en vigueur »** — un correctif sur une branche non mergée ne protège rien ; vérifier sa présence sur `main` avant d'écrire « APPLIQUÉ » (ERR-020).
