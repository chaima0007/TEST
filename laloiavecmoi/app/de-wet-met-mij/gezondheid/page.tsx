      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-emerald-950 to-slate-900 text-white py-20 px-6">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <span className="inline-block px-4 py-1.5 rounded-full bg-white/10 border border-white/15 text-emerald-100 text-sm font-medium mb-6">
            Gezondheid & patiëntenrechten
          </span>
          <h1 className="text-3xl sm:text-5xl font-bold tracking-tight leading-tight">Uw rechten als patiënt</h1>
          <p className="text-lg text-slate-300 mt-5 leading-relaxed">
            Toestemming, informatie, inzage in uw dossier en klachtrecht: wat de wet u garandeert,
      ...
      <section className="pb-12 px-6 max-w-3xl mx-auto">
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5">
          <p className="text-amber-800 text-sm leading-relaxed">
            ⚖️ Deze fiches geven algemene informatie en vervangen geen persoonlijk medisch of juridisch advies.
            De wet Patiëntenrechten is <strong>federaal</strong> en geldt in heel België. Bij twijfel kan u terecht
            bij de <strong>ombudsfunctie</strong> van uw ziekenhuis of bij de federale ombudsdienst.
          </p>
        </div>
      </section>
