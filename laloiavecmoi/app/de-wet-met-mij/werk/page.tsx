    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-emerald-950 to-slate-900 text-white py-20 px-6">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-3xl sm:text-5xl font-bold tracking-tight leading-tight">Uw rechten op het werk</h1>
          <p className="text-lg text-slate-300 mt-5 leading-relaxed">
            Opzeg, ontslag, C4, minimumloon, verlof: wat de wet voorziet, eenvoudig uitgelegd —
      ...
      <section className="pb-12 px-6 max-w-3xl mx-auto">
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5">
          <p className="text-amber-800 text-sm leading-relaxed">
            ⚖️ Veel arbeidsregels hangen af van uw <strong>paritair comité</strong> (sector) en uw anciënniteit.
            Deze fiches geven de grote principes. Bij een geschil kan u terecht bij uw <strong>vakbond</strong>,
            de <strong>arbeidsinspectie</strong> of een advocaat.
          </p>
        </div>
      </section>
