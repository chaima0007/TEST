  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed z-50 bottom-4 left-4 w-12 h-12 rounded-full bg-emerald-600 text-white shadow-lg hover:bg-emerald-700 flex items-center justify-center text-xl"
            ...
            <div className="grid grid-cols-2 gap-1.5 max-h-44 overflow-auto">
              {LANGUES.map((l) => (
                <button
                  ...
                  className="rounded-lg border border-slate-200 px-2 py-1.5 text-sm hover:border-emerald-400 hover:bg-emerald-50 text-left"
                >
                  {l.label}
                </button>
              ))}
