...
def construire():
    ...
    apropos = (
        ...
        "<li><strong>Par domaine</strong> : logement, travail, famille, dettes, justice, drogues, "
        "citoyenneté &amp; vote, harcèlement, aidants proches, enfants placés, santé, consommation, etc.</li>"
