...
if (!process.env.SWARM_API_URL) {
  console.warn("[lgbtq-rights-criminalization-engine] SWARM_API_URL is not set — falling back to mock data");
}
...
const MOCK = {
  ...
  top_risk_entities: ["Ouganda/Anti-Homosexuality Act 2023 — Peine Mort Homosexualité Aggravée, Perpétuité Simple, Dénonciation Obligatoire & 1 000+ Arrestations", "Iran/République Islamique — Peine Mort Sodomie Codifiée Penal, 4 000+ Exécutions LGBTQ+ depuis 1979, Conversion Forcée & Chirurgie Trans Coercitive", "Arabie Saoudite/Châtiments Corporels — Flagellation & Décapitation Charia, Aucun Statut Légal, Police Morale & Expatriés LGBTQ+ Expulsés"],
  critical_alerts: ["Ouganda/Anti-Homosexuality Act 2023: state_criminalization_imprisonment_severity", "Iran/République Islamique: state_criminalization_imprisonment_severity", "Arabie Saoudite/Châtiments Corporels: legal_identity_recognition_denial", "Tchétchénie/Camps Purge: violence_persecution_impunity_scale"],
  last_analysis: "2026-06-21",
  engine_version: "1.0.0",
  avg_estimated_lgbtq_rights_criminalization_index: 6.37,
  data_sources: ["ilga_world_state_sponsored_homophobia_report", "human_rights_watch_lgbtq_persecution_report", "amnesty_international_rainbow_rights_report"],
  entities: [
    {
,      entity_id: "LRC-001"
      ...
      estimated_lgbtq_rights_criminalization_index: 9.56
...
,      entity_id: "LRC-002"
      ...
      risk_level: "critique"
      primary_pattern: "state_criminalization_imprisonment_severity"
      estimated_lgbtq_rights_criminalization_index: 9.27
      last_updated: "2026-06-21"
    },
    {
,      entity_id: "LRC-003"
      ...
      estimated_lgbtq_rights_criminalization_index: 9.08
      last_updated: "2026-06-21"
    },
    {
,      entity_id: "LRC-004"
      ...
      estimated_lgbtq_rights_criminalization_index: 8.92
      last_updated: "2026-06-21"
    },
    {
,      entity_id: "LRC-005"
      ...
      estimated_lgbtq_rights_criminalization_index: 5.66
      last_updated: "2026-06-21"
    },
    {
,      entity_id: "LRC-006"
      ...
      risk_level: "élevé"
      primary_pattern: "state_criminalization_imprisonment_severity"
      estimated_lgbtq_rights_criminalization_index: 5.35
      last_updated: "2026-06-21"
    },
    {
,      entity_id: "LRC-007"
      ...
      risk_level: "modéré"
      primary_pattern: "anti_lgbtq_legislation_rollback_deficit_gap"
      estimated_lgbtq_rights_criminalization_index: 2.65
      last_updated: "2026-06-21"
    },
    {
,      entity_id: "LRC-008"
      ...
      risk_level: "faible"
      primary_pattern: "legal_identity_recognition_denial"
      estimated_lgbtq_rights_criminalization_index: 0.45
      last_updated: "2026-06-21"
    }
  ],
};
...
export async function GET() {
  ...
  try {
    const res = await fetch(`${process.env.SWARM_API_URL}/lgbtq-rights-criminalization-engine`, {
      next: { revalidate: 30 },
    });
