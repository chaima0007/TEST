...
export async function GET() {
  if (!process.env.SWARM_API_URL) {
    return sealResponse(NextResponse.json(sealResponse(getMockData(), "Water Privatization Engine Agent")));
  }
  ...
  try {
    ...
    return sealResponse(NextResponse.json(sealResponse(data, "Water Privatization Engine Agent")));
  } catch {
