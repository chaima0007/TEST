...
const mockEntities = (() => {
  ...
  const e2 = (() => {
    ...
    return { id:"BFE-002", market_segment:"institutional", region:"NAMER", cognitive_score:cog, emotional_score:emo, narrative_score:nar, systemic_score:sys, composite_score:comp, risk_level:risk, behavioral_pattern:pattern, severity:severity(risk), recommended_action:recommendedAction(risk), signal:signal(risk), speculative_bubble_formation_risk:0.10, collective_delusion_index:0.08 };
  })();
  ...
  const e4 = (() => {
    ...
    return { id:"BFE-004", market_segment:"b2b", region:"MEA", cognitive_score:cog, emotional_score:emo, narrative_score:nar, systemic_score:sys, composite_score:comp, risk_level:risk, behavioral_pattern:pattern, severity:severity(risk), recommended_action:recommendedAction(risk), signal:signal(risk), speculative_bubble_formation_risk:0.15, collective_delusion_index:0.12 };
  })();
  ...
  const e6 = (() => {
    ...
    return { id:"BFE-006", market_segment:"partner", region:"EMEA", cognitive_score:cog, emotional_score:emo, narrative_score:nar, systemic_score:sys, composite_score:comp, risk_level:risk, behavioral_pattern:pattern, severity:severity(risk), recommended_action:recommendedAction(risk), signal:signal(risk), speculative_bubble_formation_risk:0.26, collective_delusion_index:0.24 };
  })();
  ...
  const e7 = (() => {
    ...
    return { id:"BFE-007", market_segment:"institutional", region:"APAC", cognitive_score:cog, emotional_score:emo, narrative_score:nar, systemic_score:sys, composite_score:comp, risk_level:risk, behavioral_pattern:pattern, severity:severity(risk), recommended_action:recommendedAction(risk), signal:signal(risk), speculative_bubble_formation_risk:0.55, collective_delusion_index:0.52 };
  })();
