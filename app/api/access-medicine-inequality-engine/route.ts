...
const MOCK = {
  ...
  entities: [
    ...
    { entity_id: "AMI-006", name: "Amérique Latine/APC-USA — Accords TRIPS-Plus Guatemala/Colombie, Brevets Cancer Inaccessibles", country: "Amérique Latine", composite_score: 51.35, patent_barrier_essential_medicine_scale_score: 50.0, price_exclusion_low_income_severity_score: 52.0, generic_drug_access_suppression_score: 55.0, research_development_neglect_diseases_poor_score: 48.0, risk_level: "élevé", primary_pattern: "patent_barrier_essential_medicine_scale", estimated_access_medicine_inequality_index: 5.14, last_updated: "2026-06-21" },
    { entity_id: "AMI-007", name: "MSF/DNDi/Campagne Accès — Licences Obligatoires, Push Génériques & Médicaments Maladies Oubliées", country: "Global", composite_score: 25.85, patent_barrier_essential_medicine_scale_score: 22.0, price_exclusion_low_income_severity_score: 28.0, generic_drug_access_suppression_score: 25.0, research_development_neglect_diseases_poor_score: 30.0, risk_level: "modéré", primary_pattern: "generic_drug_access_suppression", estimated_access_medicine_inequality_index: 2.59, last_updated: "2026-06-21" },
    { entity_id: "AMI-008", name: "OMS/ONU — Liste Médicaments Essentiels, Résolution TRIPS Doha 2001 & SDG 3.8 Couverture", country: "Global", composite_score: 4.4, patent_barrier_essential_medicine_scale_score: 4.0, price_exclusion_low_income_severity_score: 5.0, generic_drug_access_suppression_score: 3.0, research_development_neglect_diseases_poor_score: 6.0, risk_level: "faible", primary_pattern: "research_development_neglect_diseases_poor", estimated_access_medicine_inequality_index: 0.44, last_updated: "2026-06-21" },
  ],
};
