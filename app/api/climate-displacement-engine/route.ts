...
const MOCK = {
  ...
  entities: [
    ...
    { id: "CD-008", name: "ONU/Résolution — Reconnaissance Réfugiés Climatiques, Agenda Nansen & Lacunes Convention 1951", country: "Global", composite_score: 4.4, displacement_scale_severity_score: 4.0, legal_protection_gap_score: 5.0, adaptation_finance_absence_score: 3.0, return_resettlement_impossibility_score: 6.0, risk_level: "faible", primary_pattern: "legal_protection_gap", estimated_climate_displacement_index: 0.44, last_updated: "2026-06-21" },
  ],
};
