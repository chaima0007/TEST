...
const mockEntities = [
  {
    ...
    estimated_taxjustice_index: 8.44,
    last_updated:               "2026-06-20",
    alerts: [
      "ALERTE CRITIQUE: MegaCorp Cayman Holdings — évasion fiscale systémique confirmée",
      "Signalement obligatoire aux autorités fiscales de Cayman Islands",
    ],
  },
  {
    entity_id:                  "TAX-002",
    ...
    estimated_taxjustice_index: 7.60,
    last_updated:               "2026-06-20",
    alerts: [
      "ALERTE CRITIQUE: TechGiant Ireland LLC — évasion fiscale systémique confirmée",
      "Signalement obligatoire aux autorités fiscales de Ireland",
    ],
  },
  {
    entity_id:                  "TAX-003",
    ...
    estimated_taxjustice_index: 7.65,
    last_updated:               "2026-06-20",
    alerts: [
      "ALERTE CRITIQUE: LuxHolding SA — évasion fiscale systémique confirmée",
      "Signalement obligatoire aux autorités fiscales de Luxembourg",
    ],
  },
  {
    entity_id:                  "TAX-004",
    ...
    estimated_taxjustice_index: 5.35,
    last_updated:               "2026-06-20",
    alerts: [
      "ALERTE ÉLEVÉE: ShellCompany BV — structures offshore suspectes détectées",
    ],
  },
  {
    entity_id:                  "TAX-005",
    ...
    estimated_taxjustice_index: 5.51,
    last_updated:               "2026-06-20",
    alerts: [
      "ALERTE ÉLEVÉE: PharmaOffset AG — structures offshore suspectes détectées",
    ],
  },
  {
    entity_id:                  "TAX-006",
    ...
    estimated_taxjustice_index: 3.03,
    last_updated:               "2026-06-20",
    alerts: [],
  },
  {
    ...
    estimated_taxjustice_index: 0.89,
    last_updated:               "2026-06-20",
    alerts: [],
  },
  {
    ...
    estimated_taxjustice_index: 0.59,
    last_updated:               "2026-06-20",
    alerts: [],
  },
];
...
function getMockData(): Record<string, unknown> {
  ...
  return {
    ...
    data_sources:                  ["OCDE", "Tax Justice Network", "OpenCorporates", "ICIJ Offshore Leaks"],
    entities:                      mockEntities,
    avg_estimated_taxjustice_index: Math.round((avg_composite / 100 * 10) * 100) / 100,
  };
}
