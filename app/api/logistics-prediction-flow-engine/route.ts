...
export async function GET(request: Request) {
  ...
  console.warn("[logistics-prediction-flow-engine] SWARM_API_URL non défini — mode dégradé activé");
};
  ...
  return sealResponse(NextResponse.json(sealResponse({ flows: [], summary: {} } as Record<string,unknown>), { status: 502 }));
}
