...
const MOCK = {
  ...
  entities: [
    ...
    { id: "CI-007", name: "OCCRP/Global Witness — Journalisme Enquête Corruption Corporate & Plaidoyer Due Diligence", country: "Global", composite_score: 25.85, supply_chain_abuse_scale_score: 22.0, legal_jurisdiction_evasion_score: 28.0, environmental_social_harm_score: 25.0, accountability_remedy_gap_score: 30.0, risk_level: "modéré", primary_pattern: "supply_chain_abuse_scale", estimated_corporate_impunity_index: 2.59, last_updated: "2026-06-21" },
    { id: "CI-008", name: "ONU/Principes Directeurs Ruggie — Cadre Entreprises & Droits Humains 2011, Traité Négocié", country: "Global", composite_score: 4.4, supply_chain_abuse_scale_score: 4.0, legal_jurisdiction_evasion_score: 5.0, environmental_social_harm_score: 3.0, accountability_remedy_gap_score: 6.0, risk_level: "faible", primary_pattern: "accountability_remedy_gap", estimated_corporate_impunity_index: 0.44, last_updated: "2026-06-21" },
  ],
};
