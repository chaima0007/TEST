...
const MOCK = {
  ...
  entities: [
    ...
    { entity_id: "MDW-006", name: "USA — 2M Travailleuses Domestiques, FLSA Exemptions & Discriminations Raciales", country: "Amérique du Nord", composite_score: 50.00, kafala_system_score: 45.0, labor_exploitation_score: 50.0, legal_protection_absence_score: 52.0, abuse_impunity_score: 55.0, risk_level: "élevé", primary_pattern: "abuse_impunity", estimated_migrant_domestic_workers_index: 5.00, last_updated: "2026-06-20" },
    { entity_id: "MDW-007", name: "OIT/Convention 189 — Cadre Normatif, 35 Ratifications & IDWN Alliance", country: "Global", composite_score: 28.55, kafala_system_score: 28.0, labor_exploitation_score: 30.0, legal_protection_absence_score: 25.0, abuse_impunity_score: 32.0, risk_level: "modéré", primary_pattern: "legal_protection_absence", estimated_migrant_domestic_workers_index: 2.86, last_updated: "2026-06-20" },
    { entity_id: "MDW-008", name: "ONU/CEDAW/Rapporteur — Travailleuses Domestiques Migrantes & Intersectionnalité", country: "Global", composite_score: 4.40, kafala_system_score: 4.0, labor_exploitation_score: 5.0, legal_protection_absence_score: 3.0, abuse_impunity_score: 6.0, risk_level: "faible", primary_pattern: "kafala_system", estimated_migrant_domestic_workers_index: 0.44, last_updated: "2026-06-20" },
  ],
};
