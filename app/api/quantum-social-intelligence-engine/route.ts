...
export async function GET() {
  if (!process.env.SWARM_API_URL) {
    const entities = MOCK_ENTITIES.map(e => {
      ...
      return {
        entity_id: e.entity_id, collective_type: e.collective_type, region: e.region,
