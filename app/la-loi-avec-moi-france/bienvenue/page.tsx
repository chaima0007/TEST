...
// Page d'accueil multilingue (édition France).
// Objectif : qu'une personne arrivant en France, quelle que soit sa langue, comprenne
// immédiatement ce qu'est ce site, que c'est gratuit, où trouver de l'aide en urgence,
// et comment accéder à ses droits.
// Honnête : les fiches détaillées sont en français ; cette page oriente dans la langue de l'usager.
// Le 112 est le numéro d'urgence européen (valable en France), gratuit, 24h/24.

const HUB = "/la-loi-avec-moi-france";
...
export default function BienvenueFrancePage() {
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-blue-950 to-slate-900 text-white">
        ...
        <div className="relative max-w-3xl mx-auto px-6 py-16 text-center">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/15 text-blue-100 text-sm font-medium mb-6">
      ...
      <section className="px-6 py-10 max-w-3xl mx-auto">
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 text-sm leading-relaxed text-amber-900">
          <p>
            ...
            votre langue. Les fiches détaillées du site sont rédigées en <strong>français</strong>.
            Pour les lire dans votre langue, utilisez la traduction automatique de votre navigateur —
            et en cas de doute important, demandez l&apos;aide d&apos;un service gratuit (nous vous
            indiquons lesquels).
          </p>
        </div>
      </section>
          ...
          {LANGS.map((l) => (
            ...
            >
              <div className="flex items-center justify-between gap-2">
                ...
                <span className="flex-shrink-0 rounded-full bg-blue-50 px-2.5 py-0.5 text-xs font-semibold text-blue-700">
                  {l.label}
                </span>
              </div>
              ...
              <Link
                href={HUB}
                className="mt-4 inline-flex items-center justify-center gap-1.5 rounded-xl bg-blue-700 hover:bg-blue-800 px-4 py-2.5 text-sm font-semibold text-white transition-colors"
              >
      ...
      <section className="px-6 pb-20 max-w-3xl mx-auto">
        <div className="rounded-2xl border border-blue-200 bg-blue-50 p-6">
          <h2 className="font-semibold text-blue-900 text-lg">Besoin d&apos;une aide humaine&nbsp;?</h2>
          <p className="text-blue-800/90 mt-2 text-sm leading-relaxed">
            En France, des services gratuits peuvent vous accompagner&nbsp;: les{" "}
            <strong>structures France Services</strong>, les <strong>Points-justice</strong> (accès au
            droit gratuit), l&apos;<strong>aide juridictionnelle</strong> (prise en charge des frais
            d&apos;avocat selon vos revenus) et de nombreuses associations. Beaucoup proposent un
            accompagnement et parfois un interprète.
          </p>
          <div className="mt-4 flex flex-wrap gap-3">
            <Link
              href="/la-loi-avec-moi-france/trouver-un-avocat"
              className="inline-flex items-center gap-1.5 rounded-xl bg-white border border-blue-200 px-4 py-2.5 text-sm font-semibold text-blue-700 hover:bg-blue-100 transition-colors"
            >
              Trouver un avocat (aide possible) →
            </Link>
            <Link
              href="/la-loi-avec-moi-france/nos-assistants"
              className="inline-flex items-center gap-1.5 rounded-xl bg-white border border-blue-200 px-4 py-2.5 text-sm font-semibold text-blue-700 hover:bg-blue-100 transition-colors"
            >
