...
interface Entity {
  ...
  estimated_racial_discrimination_minority_rights_index: number;
}
interface EngineData {
  ...
  avg_estimated_racial_discrimination_minority_rights_index: number;
...
// Main page component
export default function RacialDiscriminationMinorityRightsPage() {
  ...
  const INDEX_KEY = "estimated_racial_discrimination_minority_rights_index";

  useEffect(() => {
    fetch("/api/racial-discrimination-minority-rights-engine")
      .then(r => r.json())
    ...
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <GaugeRing value={data.avg_estimated_racial_discrimination_minority_rights_index} accent={ACCENT} />
        </div>
