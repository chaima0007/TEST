...
const ACCENT = "#f59e0b";
const SLUG = "elderly-rights-age-discrimination-engine";
...
function DetailModal({ entity, onClose }: { entity: Record<string, unknown>; onClose: () => void }) {
  ...
  const SUB_SCORES = [
    "elder_abuse_neglect_institutional_severity_score",
    "pension_social_security_denial_scale_score",
    "age_discrimination_employment_exclusion_score",
    "elderly_healthcare_access_dignity_deficit_gap_score",
  ];
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {tab === "sources" && (
            <p className="text-slate-400 text-sm">Sources: HelpAge International Global AgeWatch Index, WHO Elder Abuse Report, UN Open-ended Working Group on Ageing.</p>
          )}
        </div>
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Droits Aînés &amp; Discrimination Âge</h1>
          <p className="text-slate-400 mt-1">Droits des personnes âgées, maltraitance institutionnelle et discrimination par l&apos;âge</p>
        </div>
