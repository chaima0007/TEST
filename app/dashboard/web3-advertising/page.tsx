...
const API_URL = "/api/web3-advertising";
const TITLE = "Web3 Advertising Intelligence";
const COLOR = "#7c3aed";
...
const CERTS_TEMPLATE: Omit<Cert, "status" | "year">[] = [
  ...
  { code: "GDPR-WEB3", label: "GDPR Web3 Compliance", issuer: "Union Européenne" },
  { code: "IAB-WEB3", label: "IAB Web3 Ad Standards", issuer: "IAB Tech Lab" },
  { code: "W3C-PRIV", label: "W3C Privacy Principles", issuer: "W3C" },
  { code: "CCPA-WEB3", label: "CCPA Web3 Compliance", issuer: "California AG" },
];
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité Web3 advertising — les réseaux publicitaires décentralisés doivent intégrer des protocoles de consentement on-chain vérifiables : ce contrôle est soumis aux obligations de transparence des données et aux standards IAB Tech Lab pour la publicité Web3 dans l&apos;écosystème décentralisé.</p>}
        {tab === "recommandations" && <p>Implémenter des mécanismes de consentement décentralisés via smart contracts. Documenter les flux de données dans un registre immuable conforme au GDPR et effectuer des audits réguliers de l&apos;impact sur la vie privée selon le cadre W3C Privacy Principles.</p>}
        {tab === "certifications" && (
          <div>
