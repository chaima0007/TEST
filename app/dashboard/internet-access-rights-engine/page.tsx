...
const ACCENT = "#051a2e";
const INDEX_KEY = "estimated_internet_access_rights_index";
...
const FALLBACK_ENTITIES = [
  { id: "IAR-001", name: "North Korea", severity: "critique", score: 91 },
  { id: "IAR-002", name: "Eritrea", severity: "critique", score: 87 },
  { id: "IAR-003", name: "Ethiopia", severity: "critique", score: 83 },
  { id: "IAR-004", name: "Myanmar", severity: "critique", score: 79 },
  { id: "IAR-005", name: "Iran", severity: "élevé", score: 57 },
  { id: "IAR-006", name: "Cuba", severity: "élevé", score: 53 },
  { id: "IAR-007", name: "India", severity: "modéré", score: 33 },
  { id: "IAR-008", name: "Estonia", severity: "faible", score: 9 },
];

const FALLBACK_DATA_SOURCES = [
  "freedom_house_internet",
...
const FALLBACK_CRITICAL_ALERTS = [
  "North Korea: internet_totalement_bloqué_population",
  "Eritrea: 1pct_connectés_pays",
];
...
export default function InternetAccessRightsDashboard() {
  ...
  useEffect(() => {
    fetch("/api/internet-access-rights-engine")
      .then((r) => r.json())
      .then((d) => {
    ...
    <div style={{ minHeight: "100vh", background: "#0f172a", color: "#f1f5f9", fontFamily: "system-ui, sans-serif", padding: "2rem" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "2rem", borderLeft: `4px solid ${ACCENT}`, paddingLeft: "1rem" }}>
          <h1 style={{ fontSize: "1.75rem", fontWeight: 700, margin: 0 }}>Accès Internet — Droit à la Connectivité</h1>
          <p style={{ color: "#94a3b8", marginTop: "0.5rem" }}>Wave 213 · Indice des violations droit à la connectivité</p>
          {index !== null && (
