...
const SIGNALS = [
  "In-game consent management",
  "Loot box advertising",
  "Child-directed game ads",
  "Virtual currency advertising",
  "Player data collection",
];
const ACTIONS = [
  "Enforce in-game consent",
  "Regulate loot box ads",
  "Deploy child safety filters",
  "Audit virtual currency ads",
  "Restrict player data use",
];
