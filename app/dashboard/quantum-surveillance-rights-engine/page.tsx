...
const ACCENT = "#06b6d4";
const TITRE = "Surveillance Quantique, Décryptage & Droits à la Vie Privée";
...
export default function Page() {
  ...
  useEffect(() => {
    fetch("/api/quantum-surveillance-rights-engine").then(r => r.json()).then(d => setData(d.payload ?? d));
  }, []);
