...
type Entity = {
  ...
  risk_level: string;
  estimated_reelsadvertising_index: number;
};
...
function deriveCerts(entity: Entity): string[] {
  return [
    ...
    `Niveau de risque reels advertising : ${entity.risk_level}`,
    `Indice estimé Caelum : ${entity.estimated_reelsadvertising_index.toFixed(2)} / 10`,
    `Conformité plateforme reels : ${entity.composite_score >= 60 ? "Surveillance active" : "Monitoring standard"}`,
    `Certification Wave 420 — Reels Advertising Intelligence`,
  ];
}
...
const SIGNALS = [
  "Reels view tracking",
  "Short video consent",
  "Creator data handling",
  "Auto-play compliance",
  "Reels engagement profiling",
];

const ACTIONS = [
  "Enforce reels consent",
  "Limit view tracking",
  "Protect creator data",
  "Audit auto-play",
  "Cap engagement profiling",
];
      ...
      >
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 16 }}>
          <div>
            ...
            <div style={{ fontSize: 12, color: COLOR, marginTop: 2 }}>Reels Advertising · Wave 420</div>
          </div>
        ...
        {tab === "scores" && (
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            {[
              ...
              { label: "Index Estimé", value: entity.estimated_reelsadvertising_index * 10, color: COLOR },
...
export default function ReelsadvertisingAdvertisingDashboard() {
  ...
  useEffect(() => {
    fetch("/api/reelsadvertising-advertising")
      .then((r) => r.json())
  ...
  const avgIndex = entities.length > 0
    ? entities.reduce((s, e) => s + e.estimated_reelsadvertising_index, 0) / entities.length
    : 0;
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#030712", color: "#fff", padding: "32px 24px" }}>
      ...
      <div style={{ marginBottom: 32 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
          ...
          <h1 style={{ fontSize: 26, fontWeight: 700, color: "#fff", margin: 0 }}>
            Reels Advertising Intelligence
          </h1>
        </div>
        <p style={{ fontSize: 13, color: "#e11d4899", margin: 0 }}>
          Caelum Partners · Wave 420 · Analyse publicitaire reels · {data.generatedAt ? new Date(data.generatedAt).toLocaleDateString("fr-FR") : "2026-06-22"}
        ...
        {filtered.map((entity, i) => (
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, color: "#64748b" }}>
              ...
              <span style={{ color: COLOR, fontWeight: 600 }}>{entity.estimated_reelsadvertising_index.toFixed(2)}</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <div style={{ textAlign: "center", fontSize: 11, color: "#334155" }}>
        Caelum Partners · Reels Advertising Intelligence · Wave 420
      </div>
