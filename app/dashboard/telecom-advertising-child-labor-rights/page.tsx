...
const API_URL = "/api/telecom-advertising-child-labor-rights";
const TITLE = "Publicité Télécommunications";
const COLOR = "#0891b2";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — les opérateurs télécom doivent encadrer strictement la publicité ciblant les mineurs dans leurs réseaux et services : interdiction du profilage publicitaire des enfants, conformité ILO-C182 sur les contenus commerciaux diffusés via des plateformes accessibles aux moins de 18 ans.</p>}
        {tab === "recommandations" && <p>Mettre en place des filtres de vérification d&apos;âge sur les plateformes publicitaires télécom. Auditer les contenus sponsorisés diffusés sur les réseaux accessibles aux mineurs selon les exigences CSDDD 2024/1760. Former les équipes marketing aux obligations ILO-C182 relatives à la protection des enfants dans les communications commerciales.</p>}
        {tab === "certifications" && (
          <div>
