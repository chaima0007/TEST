...
const COLOR = "#6366f1";
const DOMAIN = "crosschannel-advertising";
const INDEX_KEY = "estimated_crosschannel_index";
const TITLE = "Cross-Channel Advertising";
...
const ACTIONS = [
  "Unify consent across channels",
  "Standardise attribution models",
  "Enforce cross-channel frequency caps",
...
export default function CrosschannelAdvertisingDashboard() {
