...
const COLOR = "#dc2626";
const DOMAIN = "deepfakeadvertising-advertising";
const INDEX_KEY = "estimated_deepfakeadvertising_index";
const TITLE = "Deepfake Advertising";

const SIGNALS = [
  "Synthetic media disclosure",
  "Likeness consent rights",
  "Deepfake detection compliance",
  "AI-generated content labeling",
  "Identity manipulation risks",
];

const ACTIONS = [
  "Mandate synthetic media labels",
  "Enforce likeness consent",
  "Deploy deepfake detection",
  "Require AI content labels",
  "Restrict identity manipulation",
];
...
function deriveCerts(entity: Entity): string[] {
  ...
  return [
    ...
    `Niveau de risque deepfake advertising : ${entity.risk_level}`,
    `Indice estimé Caelum : ${idx.toFixed(2)} / 10`,
    `Conformité médias synthétiques : ${entity.composite_score >= 60 ? "Surveillance active" : "Monitoring standard"}`,
    `Certification Wave 422 — Deepfake Advertising Intelligence`,
  ];
}
...
export default function DeepfakeadvertisingAdvertisingDashboard() {
    ...
    <div style={{ minHeight: "100vh", background: "#030712", color: "#fff", padding: "32px 24px" }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 13, color: `${COLOR}99`, margin: 0 }}>
          Caelum Partners · Wave 422 · Analyse publicité deepfake · {data.generatedAt ? new Date(data.generatedAt).toLocaleDateString("fr-FR") : "2026-06-22"}
