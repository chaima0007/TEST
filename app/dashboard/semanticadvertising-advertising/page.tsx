...
const COLOR = "#be185d";
const DOMAIN = "semanticadvertising-advertising";
const INDEX_KEY = "estimated_semanticadvertising_index";
const TITLE = "Semantic Advertising";
...
const SIGNALS = [
  ...
  "Semantic consent framework",
];

const ACTIONS = [
  "Deploy semantic analysis",
  "Enforce keyword safety",
  "Audit content scoring",
  "Strengthen brand filters",
  "Implement semantic consent",
];
...
function deriveCerts(entity: Entity): string[] {
  ...
  return [
    ...
    `Niveau de risque semantic advertising : ${entity.risk_level}`,
    `Indice estimé Caelum : ${idx.toFixed(2)} / 10`,
    `Conformité sémantique : ${entity.composite_score >= 60 ? "Surveillance active" : "Monitoring standard"}`,
    `Certification Wave 416 — Semantic Advertising Intelligence`,
  ];
}
...
export default function SemanticadvertisingAdvertisingDashboard() {
    ...
    <div style={{ minHeight: "100vh", background: "#030712", color: "#fff", padding: "32px 24px" }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 13, color: `${COLOR}99`, margin: 0 }}>
          Caelum Partners · Wave 416 · Analyse publicitaire sémantique · {data.generatedAt ? new Date(data.generatedAt).toLocaleDateString("fr-FR") : "2026-06-22"}
