...
interface Entity {
  ...
  estimated_palm_oil_peatland_rights_index: number;
  risk_level: string;
...
interface DashData {
  ...
  avg_estimated_palm_oil_peatland_rights_index?: number;
...
export default function PalmOilPeatlandRightsPage() {
  ...
  useEffect(() => {
    fetch("/api/palm-oil-peatland-rights")
      .then(r => r.json())
  ...
  if (loading) {
    return (
      <div style={{ background: "#020617", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ color: ACCENT, fontSize: "14px" }}>Initialisation Droits — Huile de Palme et Tourbières…</div>
      </div>
    );
  }
  ...
  const avgIndex = data?.avg_estimated_palm_oil_peatland_rights_index ?? avg(allEntities.map(e => e.estimated_palm_oil_peatland_rights_index));
  ...
  const kpis = [
    ...
    { label: "Index Palme & Tourbières", value: avgIndex.toFixed(2) },
    ...
    <div style={{ minHeight: "100vh", background: "#020617", color: "white", padding: "24px", display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div style={{ background: "#0f172a", border: "1px solid #334155", borderRadius: "16px", width: "100%", maxWidth: "640px", maxHeight: "90vh", overflowY: "auto", boxShadow: "0 25px 50px rgba(0,0,0,0.5)" }}
            ...
            <div style={{ padding: "24px", display: "flex", flexDirection: "column", gap: "16px" }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                ...
                <div style={{ background: "rgba(30,41,59,0.5)", borderRadius: "12px", padding: "16px", textAlign: "center" }}>
                  <div style={{ fontSize: "28px", fontWeight: "bold", color: ACCENT }}>{selected.estimated_palm_oil_peatland_rights_index.toFixed(2)}</div>
                  <div style={{ fontSize: "11px", color: "#94a3b8", marginTop: "4px" }}>Index Palme &amp; Tourbières</div>
                </div>
              </div>
      ...
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "4px" }}>
          ...
          <h1 style={{ fontSize: "22px", fontWeight: "bold", letterSpacing: "-0.025em", margin: 0 }}>Droits — Huile de Palme et Tourbières</h1>
        </div>
        <p style={{ color: "#94a3b8", fontSize: "13px", marginLeft: "24px" }}>
          Palm Oil Peatland Rights Engine — Caelum Partners · Wave 282
        </p>
      </div>
      ...
      <div style={{ background: "#0f172a", border: "1px solid #1e293b", borderRadius: "12px", padding: "20px" }}>
        <h2 style={{ fontSize: "13px", fontWeight: 600, color: "#94a3b8", marginBottom: "16px" }}>Score Global — Huile de Palme &amp; Tourbières</h2>
        ...
        {filtered.map(e => (
          <div key={e.id} onClick={() => setSelected(e)}
            ...
            <div style={{ fontSize: "11px", color: "#64748b", marginTop: "8px" }}>
              Index: <span style={{ fontWeight: 500, color: ACCENT }}>{e.estimated_palm_oil_peatland_rights_index.toFixed(2)}</span>
            </div>
