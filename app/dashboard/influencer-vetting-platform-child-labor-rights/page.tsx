...
const API_URL = "/api/influencer-vetting-platform-child-labor-rights";
const TITLE = "Droits Enfants Plateforme Vetting Influenceurs";
const COLOR = "#7c3aed";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — surveillance active des influenceurs requise.</p>}
        {tab === "recommandations" && <p>Renforcer le vetting des influenceurs et exiger des certifications de conformité avec les normes ILO-C182 pour tout contenu impliquant des mineurs.</p>}
        {tab === "certifications" && (
          <div>
