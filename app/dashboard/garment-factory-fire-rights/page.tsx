...
export default function GarmentFactoryFireRightsDashboard() {
  const [data, setData] = useState<any>(null);
  const [selected, setSelected] = useState<any>(null);

  useEffect(() => {
    fetch("/api/garment-factory-fire-rights")
      .then(r => r.json())
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f8fafc", padding: 32 }}>
      <h1 style={{ fontSize: 28, fontWeight: 800, color: "#1e293b", marginBottom: 8 }}>
        Droits des Travailleurs — Incendies d&apos;Usines Textiles
      </h1>
      <p style={{ color: "#64748b", marginBottom: 32 }}>Analyse CaelumSwarm™ — Sécurité et droits dans l&apos;industrie textile</p>
