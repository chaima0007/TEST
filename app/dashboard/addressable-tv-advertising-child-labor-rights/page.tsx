...
const API_URL = "/api/addressable-tv-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité TV Adressable";
const COLOR = "#1d4ed8";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — interdiction du ciblage publicitaire TV adressable utilisant des données d&apos;audience incluant des mineurs sans consentement parental requis.</p>}
        {tab === "recommandations" && <p>Mettre en place des mécanismes de filtrage des audiences TV adressables pour exclure les mineurs. Garantir la conformité ILO-C182 et CSDDD 2024/1760 dans tous les segments d&apos;audience adressable et interdire l&apos;exploitation des données de visionnage des enfants.</p>}
        {tab === "certifications" && (
          <div>
