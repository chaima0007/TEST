...
const COLOR = "#7c3aed";
const DOMAIN = "influencermarketing-advertising";
const INDEX_KEY = "estimated_influencermarketing_index";
const TITLE = "Influencer Marketing Advertising";
      ...
      <div style={{ background:"#fff",borderRadius:12,padding:24,width:480,maxWidth:"90vw",maxHeight:"80vh",overflowY:"auto" }}>
        ...
        {tab==="signals" && (
          <ul style={{ listStyle:"none",padding:0,margin:0 }}>
            {["Disclosure compliance","FTC guidelines","Fake follower detection","Brand safety","Content authenticity"].map(s => (
        ...
        {tab==="actions" && (
          <ul style={{ listStyle:"none",padding:0,margin:0 }}>
            {["Audit influencer disclosure practices","Implement FTC compliance checklist","Deploy fake follower detection tools","Establish brand safety protocols","Obtain ISO 26000 certification"].map(a => (
...
export default function InfluencermarketingAdvertisingDashboard() {
