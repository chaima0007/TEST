...
const COLOR = "#1d9bf0";
const DOMAIN = "xadvertising-advertising";
const INDEX_KEY = "estimated_xadvertising_index";
const TITLE = "X Advertising";
...
const SIGNALS = [
  "Post promotion disclosure",
  "Political ad restrictions",
  "Sensitive topic limits",
  "Audience targeting consent",
  "Cross-platform data use",
];

const ACTIONS = [
  "Enforce post disclosure",
  "Apply political ad rules",
  "Cap sensitive targeting",
  "Obtain audience consent",
...
export default function XadvertisingAdvertisingDashboard() {
