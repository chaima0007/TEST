...
const COLOR = "#dc2626";
const DOMAIN = "brandadvertising-advertising";
const INDEX_KEY = "estimated_brandadvertising_index";
const TITLE = "Brand Advertising";

const SIGNALS = [
  "Brand identity compliance",
  "Trademark usage controls",
  "Audience perception tracking",
  "Brand safety monitoring",
  "Co-branding transparency",
];

const ACTIONS = [
  "Enforce brand guidelines",
  "Audit trademark usage",
  "Limit perception tracking",
  "Deploy brand safety tools",
  "Disclose co-branding",
];
...
export default function BrandadvertisingAdvertisingDashboard() {
