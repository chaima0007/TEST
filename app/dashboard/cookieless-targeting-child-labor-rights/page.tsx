...
const API_URL = "/api/cookieless-targeting-child-labor-rights";
const TITLE = "Droits Enfants Ciblage Sans Cookies";
const COLOR = "#0f172a";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — le ciblage sans cookies repose sur des signaux comportementaux contextuels ne permettant pas l&apos;identification directe des mineurs : une vigilance accrue est requise pour éviter tout profilage indirect d&apos;enfants via des segments d&apos;audience agrégés contraires à l&apos;ILO-C182.</p>}
        {tab === "recommandations" && <p>Mettre en place des filtres contextuels excluant tout segment d&apos;audience susceptible d&apos;inclure des mineurs dans les campagnes cookieless. Documenter les méthodologies de ciblage contextuel conformément aux exigences de la CSDDD 2024/1760 et réaliser des audits semestriels selon les standards ILO-C182.</p>}
        {tab === "certifications" && (
          <div>
