...
export default function WitchcraftAccusationPersecutionPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/witchcraft-accusation-persecution-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Persécution par Accusations de Sorcellerie
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Witch camps · Enfants accusés · Violence communautaire · Droits des accusés
          </p>
        </div>
