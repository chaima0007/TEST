...
const COLOR = "#7c3aed";
const DOMAIN = "esportsadvertising-advertising";
const INDEX_KEY = "estimated_esportsadvertising_index";
const TITLE = "Esports Advertising";
...
const SIGNALS = [
  "Tournament sponsorship compliance",
  "Streamer disclosure requirements",
  "Minor viewer protections",
  "Virtual item advertising",
  "Cross-border event rules",
];
const ACTIONS = [
  "Audit tournament sponsorships",
  "Enforce streamer disclosure",
  "Deploy minor protections",
  "Regulate virtual item ads",
  "Apply cross-border rules",
];
...
export default function EsportsadvertisingAdvertisingDashboard() {
