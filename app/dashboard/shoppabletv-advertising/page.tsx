...
const COLOR = "#ec4899";
const DOMAIN = "shoppabletv-advertising";
const INDEX_KEY = "estimated_shoppabletv_index";
const TITLE = "Shoppable TV Advertising";
...
const SIGNALS = [
  "Purchase consent on TV",
  "Data collection from smart TVs",
  "ACR technology disclosure",
  "Cross-device purchase tracking",
  "Impulse buying protections",
];

const ACTIONS = [
  "Enforce TV purchase consent",
  "Limit smart TV data collection",
  "Disclose ACR technology",
  "Audit cross-device tracking",
  "Deploy impulse protection",
];
...
export default function ShoppabletvAdvertisingDashboard() {
