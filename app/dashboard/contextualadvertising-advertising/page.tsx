...
const COLOR = "#059669";
const DOMAIN = "contextualadvertising-advertising";
const INDEX_KEY = "estimated_contextualadvertising_index";
...
export default function ContextualadvertisingAdvertisingDashboard() {
