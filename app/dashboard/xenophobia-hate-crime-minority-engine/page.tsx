...
export default function XenophobiaHateCrimeMinorityPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/xenophobia-hate-crime-minority-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Xénophobie &amp; Crimes de Haine contre les Minorités
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Violences ethniques, discours haineux &amp; politiques discriminatoires
          </p>
        </div>
