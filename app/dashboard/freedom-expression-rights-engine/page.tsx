...
const ACCENT = "#fbbf24";
const TITRE = "Liberté d&apos;Expression, Censure & Défenseurs des Droits";
...
export default function Page() {
  ...
  useEffect(() => { fetch("/api/freedom-expression-rights-engine").then(r => r.json()).then(d => setData(d.payload ?? d)); }, []);
  ...
  return (
    <div style={{ background: "#020617", minHeight: "100vh", color: "#f1f5f9", fontFamily: "system-ui,sans-serif" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 24px" }}>
        ...
        <p style={{ color: "#94a3b8", marginBottom: 32 }}>CaelumSwarm™ · CSDDD 2024/1760 · Wave 227</p>
