...
const COLOR = "#0a66c2";
const DOMAIN = "linkedinadvertising-advertising";
const INDEX_KEY = "estimated_linkedinadvertising_index";
const TITLE = "LinkedIn Advertising";
...
const SIGNALS = [
  "B2B targeting consent",
  "Professional data use",
  "Lookalike audience limits",
  "Recruitment ad fairness",
  "InMail opt-out compliance",
];

const ACTIONS = [
  "Enforce B2B consent",
  "Limit professional data use",
  "Cap lookalike targeting",
  "Audit recruitment ads",
  "Implement InMail opt-out",
];
...
export default function LinkedinadvertisingAdvertisingDashboard() {
