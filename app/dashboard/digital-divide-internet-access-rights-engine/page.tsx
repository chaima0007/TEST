...
const ACCENT = "#0a1a3a";
const SLUG = "digital-divide-internet-access-rights-engine";
...
export default function DigitalDivideInternetAccessRightsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Fracture Numérique &amp; Droit à Internet</h1>
          <p className="text-slate-400 mt-1">Inclusion Numérique · Accès Universel · ITU · Alphabétisation</p>
        </div>
