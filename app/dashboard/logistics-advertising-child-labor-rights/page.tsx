...
const API_URL = "/api/logistics-advertising-child-labor-rights";
const TITLE = "Publicité Logistique & Transport";
const COLOR = "#f59e0b";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — les opérateurs logistiques et de transport doivent s&apos;assurer que leurs pratiques publicitaires n&apos;impliquent pas de travail d&apos;enfants dans leur chaîne d&apos;approvisionnement : interdiction de recourir à des mineurs pour des activités promotionnelles, livraisons ou manutention, conformément à l&apos;ILO-C182 et aux normes sectorielles internationales.</p>}
        {tab === "recommandations" && <p>Cartographier la chaîne d&apos;approvisionnement pour identifier les risques de travail des enfants dans les activités de distribution et logistique. Intégrer des clauses CSDDD 2024/1760 dans les contrats avec les sous-traitants. Certifier les entrepôts et centres de tri selon les standards ILO-C182 et soumettre les partenaires logistiques à des audits réguliers.</p>}
        {tab === "certifications" && (
          <div>
