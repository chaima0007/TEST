...
export default function RightToEducationAccessPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/right-to-education-access-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Droit à l&apos;Éducation &amp; Accès Scolaire
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Exclusion scolaire, filles, conflits armés &amp; inégalités structurelles
          </p>
        </div>
