...
const API_URL = "/api/microinfluencer-advertising";
const TITLE = "Micro-Influencer Advertising";
const COLOR = "#0891b2";
const DOMAIN = "microinfluencer-advertising";
const INDEX_KEY = "estimated_microinfluencer_index";

const SIGNALS = [
  "Niche audience consent",
...
const ACTIONS = [
  "Enforce niche consent",
  "Standardize contracts",
  "Audit content authenticity",
  "Protect follower data",
  "Require sponsored disclosure",
];
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && (
          <p>Conformité {TITLE} — les marques travaillant avec des micro-influenceurs doivent garantir le consentement éclairé des audiences de niche, la transparence contractuelle et la protection des données des abonnés conformément aux réglementations publicitaires et aux obligations de divulgation en vigueur.</p>
        )}
        {tab === "recommandations" && (
          <div>
...
export default function MicroinfluencerAdvertisingDashboard() {
