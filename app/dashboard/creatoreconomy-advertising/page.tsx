...
const COLOR = "#f59e0b";
const DOMAIN = "creatoreconomy-advertising";
const INDEX_KEY = "estimated_creatoreconomy_index";
const TITLE = "Creator Economy Advertising";

const SIGNALS = [
  "Creator revenue transparency",
  "Platform fee disclosure",
  "Creator data ownership",
  "Revenue share compliance",
  "Creator contract fairness",
];

const ACTIONS = [
  "Enforce revenue transparency",
  "Disclose platform fees",
  "Protect creator data",
  "Audit revenue share",
  "Standardize creator contracts",
];
...
function deriveCerts(entity: Entity): string[] {
  ...
  return [
    ...
    `Niveau de risque creator economy advertising : ${entity.risk_level}`,
    `Indice estimé Caelum : ${idx.toFixed(2)} / 10`,
    `Conformité économie créateur : ${entity.composite_score >= 60 ? "Surveillance active" : "Monitoring standard"}`,
    `Certification Wave 422 — Creator Economy Advertising Intelligence`,
  ];
}
...
export default function CreatoreconomyAdvertisingDashboard() {
    ...
    <div style={{ minHeight: "100vh", background: "#030712", color: "#fff", padding: "32px 24px" }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 13, color: `${COLOR}99`, margin: 0 }}>
          Caelum Partners · Wave 422 · Analyse économie créateur · {data.generatedAt ? new Date(data.generatedAt).toLocaleDateString("fr-FR") : "2026-06-22"}
