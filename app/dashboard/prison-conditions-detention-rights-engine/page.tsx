...
const ACCENT = "#dc2626";
const SLUG = "prison-conditions-detention-rights-engine";
...
function DetailModal({ entity, onClose }: { entity: Record<string, unknown>; onClose: () => void }) {
  ...
  const SUB_SCORES = [
    "torture_ill_treatment_detention_severity_score",
    "overcrowding_inhumane_conditions_scale_score",
    "solitary_confinement_isolation_abuse_score",
    "prison_healthcare_legal_access_deficit_gap_score",
  ];
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {tab === "sources" && (
            <p className="text-slate-400 text-sm">Sources: CPT/APT Committee Prevention Torture, UN Special Rapporteur on Torture, ICPS World Prison Brief.</p>
          )}
        </div>
      </div>
    </div>
...
export default function PrisonConditionsDetentionRightsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Conditions Détention &amp; Droits Prisonniers</h1>
          <p className="text-slate-400 mt-1">Conditions de détention, surpopulation carcérale, torture et droits des détenus</p>
        </div>
