...
const ACCENT = "#7c2d12"
const DOMAIN_SLUG = "genetic-data-privacy-rights-engine"
...
const FALLBACK: EngineData = {
  ...
  accent_color: ACCENT,
  entities: [
    { id: "GDP_001", name: "BGI Genomics", country: "CN", composite_score: 94.55, severity: "critique", key_violation: "Collecte données génétiques étrangers — transfert autorités chinoises, risque sécurité nationale" },
    { id: "GDP_002", name: "23andMe", country: "US", composite_score: 91.40, severity: "critique", key_violation: "Faillite — données 15M clients exposées, revente potentielle à tiers non consentis" },
    { id: "GDP_003", name: "AncestryDNA", country: "US", composite_score: 85.30, severity: "critique", key_violation: "Partage données forces de l&apos;ordre sans mandat — violation vie privée génétique" },
    { id: "GDP_004", name: "Illumina", country: "US", composite_score: 71.10, severity: "critique", key_violation: "Séquençage génomique — contrats gouvernementaux opaques, consentement insuffisant" },
    { id: "GDP_005", name: "MyHeritage", country: "IL", composite_score: 54.45, severity: "élevé", key_violation: "Brèche sécurité 2018 — 92M profils exposés, gestion crise insuffisante" },
    { id: "GDP_006", name: "FamilyTreeDNA", country: "US", composite_score: 47.30, severity: "élevé", key_violation: "Coopération FBI sans information utilisateurs — données partagées sans consentement explicite" },
    { id: "GDP_007", name: "Nebula Genomics", country: "US", composite_score: 29.30, severity: "modéré", key_violation: "Chiffrement blockchain — amélioration contrôle utilisateur en cours, lacunes persistantes" },
    { id: "GDP_008", name: "Broad Institute", country: "US", composite_score: 12.80, severity: "faible", key_violation: "Recherche académique — protocoles consentement éclairé exemplaires, accès open science contrôlé" },
  ],
  summary: { avg_composite: 60.79, critique: 4, élevé: 2, modéré: 1, faible: 1 },
}
...
export default function GeneticDataPrivacyRightsPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0f172a", color: "#f8fafc", padding: "2rem", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ textAlign: "center", color: "#475569", fontSize: 12, paddingTop: 24, marginTop: 32, borderTop: "1px solid #1e293b" }}>
        Caelum Partners — Wave {d.wave} · Genetic Data Privacy Rights Engine
      </div>
    </main>
  )
}
