...
export default function SocialProtectionPovertyRightsPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/social-protection-poverty-rights-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Protection Sociale &amp; Droits face à la Pauvreté
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Absence filets sécurité, austérité &amp; exclusion travailleurs informels
          </p>
        </div>
