...
interface Entity {
  ...
  estimated_forced_marriage_rights_index: number;
}
interface EngineData {
  ...
  avg_estimated_forced_marriage_rights_index: number;
...
const INDEX_KEY = "estimated_forced_marriage_rights_index";

const FALLBACK_ENTITIES: Entity[] = [
  { id: "FMR-001", name: "UNICEF", country: "International", composite_score: 88, risk_level: "critique", primary_pattern: "mariage_force_mineur_prevalence", estimated_forced_marriage_rights_index: 8.8 },
  { id: "FMR-002", name: "Girls Not Brides", country: "International", composite_score: 85, risk_level: "critique", primary_pattern: "mariage_force_coalition_prevention", estimated_forced_marriage_rights_index: 8.5 },
  { id: "FMR-003", name: "Human Rights Watch", country: "International", composite_score: 82, risk_level: "critique", primary_pattern: "mariage_force_documentation_violations", estimated_forced_marriage_rights_index: 8.2 },
  { id: "FMR-004", name: "Pakistan", country: "Pakistan", composite_score: 78, risk_level: "critique", primary_pattern: "mariage_force_prevalence_regionale", estimated_forced_marriage_rights_index: 7.8 },
  { id: "FMR-005", name: "Bangladesh", country: "Bangladesh", composite_score: 58, risk_level: "élevé", primary_pattern: "mariage_force_taux_eleve", estimated_forced_marriage_rights_index: 5.8 },
  { id: "FMR-006", name: "Niger", country: "Niger", composite_score: 55, risk_level: "élevé", primary_pattern: "mariage_force_taux_eleve_afrique", estimated_forced_marriage_rights_index: 5.5 },
  { id: "FMR-007", name: "Canada", country: "Canada", composite_score: 32, risk_level: "modéré", primary_pattern: "mariage_force_legislation_protection", estimated_forced_marriage_rights_index: 3.2 },
  { id: "FMR-008", name: "Islande", country: "Islande", composite_score: 14, risk_level: "faible", primary_pattern: "mariage_force_risque_minimal", estimated_forced_marriage_rights_index: 1.4 },
];

const FALLBACK: EngineData = {
  agent: "Mariages Forcés — Droits (3TG)",
  total_entities: 8,
  avg_composite: 60.29,
  confidence_score: 0.86,
  avg_estimated_forced_marriage_rights_index: 6.03,
  risk_distribution: { critique: 4, "élevé": 2, "modéré": 1, faible: 1 },
  critical_alerts: [
    "UNICEF: mariage_force_mineur_prevalence",
    "Girls Not Brides: mariage_force_coalition_prevention",
    "Human Rights Watch: mariage_force_documentation_violations",
    "Pakistan: mariage_force_prevalence_regionale",
  ],
  data_sources: ["unicef_child_marriage_data", "girls_not_brides_reports", "hrw_forced_marriage_reports", "un_women_statistics"],
...
export default function ForcedMarriageRightsPage() {
  const [data, setData] = useState<EngineData | null>(null);
  const [selected, setSelected] = useState<Entity | null>(null);

  useEffect(() => {
    fetch("/api/forced-marriage-rights-engine")
      .then(r => r.json())
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#020617", color: "white", padding: 24 }}>
      ...
      <div style={{ maxWidth: 1152, margin: "0 auto", display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
          <div>
            <h1 style={{ fontSize: 24, fontWeight: "bold", color: "white" }}>Mariages Forcés — Droits (3TG)</h1>
            <p style={{ color: "#94a3b8", fontSize: 14, marginTop: 4 }}>
              {d.total_entities} entités · Confiance {(d.confidence_score * 100).toFixed(0)}% · MAJ 2026-06-22
            </p>
          </div>
          <GaugeRing value={d.avg_estimated_forced_marriage_rights_index} accent={ACCENT} />
        </div>
        ...
        {d.critical_alerts.length > 0 && (
          <div style={{ backgroundColor: "#0f172a", borderRadius: 12, padding: 16, border: "1px solid rgba(30,58,47,0.3)" }}>
