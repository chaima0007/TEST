...
const API_URL = "/api/connected-commerce-advertising-child-labor-rights";
const TITLE = "Droits Enfants Commerce Connecté Publicité";
const COLOR = "#0f766e";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — surveillance active des pratiques publicitaires du commerce connecté ciblant les mineurs requise.</p>}
        {tab === "recommandations" && <p>Encadrer strictement les formats publicitaires du commerce connecté exposant les enfants et garantir le respect des conventions ILO-C182 et CSDDD 2024/1760. Mettre en place des mécanismes de vérification de l&apos;âge robustes dans les flux publicitaires e-commerce.</p>}
        {tab === "certifications" && (
          <div>
