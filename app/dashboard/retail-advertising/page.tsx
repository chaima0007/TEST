...
const API_URL = "/api/retail-advertising";
const TITLE = "Publicité Retail — Conformité & Droits";
const COLOR = "#0891b2";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && (
          <p>Conformité CSDDD 2024/1760 — les réseaux de publicité retail doivent intégrer des obligations de transparence sur les données consommateurs et la chaîne d&apos;approvisionnement. Les pratiques de ciblage publicitaire sont soumises à la diligence raisonnable imposée par l&apos;ILO-C182 et la législation européenne sur la protection des données.</p>
        )}
        {tab === "recommandations" && (
          <p>Établir des protocoles de vérification des partenaires publicitaires retail conformes à la CSDDD 2024/1760. Documenter les flux de données dans un registre transparent et effectuer des audits d&apos;impact sur les droits des consommateurs selon le cadre OIT C182 et le RGPD.</p>
        )}
        {tab === "certifications" && (
          <div>
