...
export default function HousingRightsEvictionDashboard() {
  const [data, setData] = useState<DomainData | null>(null)
  const color = "#f97316"
  useEffect(() => {
    fetch("/api/housing-rights-eviction-engine").then(r => r.json()).then(d => setData(d.payload ?? d))
  }, [])
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-2" style={{ color }}>Droit au Logement &amp; Expulsions Forc&eacute;es</h1>
