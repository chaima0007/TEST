...
const API_URL = "/api/retail-data-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Données Retail";
const COLOR = "#15803d";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — interdiction de l&apos;utilisation des données retail pour cibler publicitairement les enfants sans consentement parental explicite et traçable requis.</p>}
        {tab === "recommandations" && <p>Proscrire l&apos;exploitation des données d&apos;achat retail pour le ciblage publicitaire des mineurs. Mettre en oeuvre des contrôles d&apos;âge stricts conformes à ILO-C182 et CSDDD 2024/1760, et auditer régulièrement les flux de données partenaires pour garantir l&apos;exclusion des profils enfants.</p>}
        {tab === "certifications" && (
          <div>
