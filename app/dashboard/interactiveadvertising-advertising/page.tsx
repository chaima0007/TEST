...
const COLOR = "#7c3aed";
const DOMAIN = "interactiveadvertising-advertising";
const INDEX_KEY = "estimated_interactiveadvertising_index";
const TITLE = "Interactive Advertising";

const SIGNALS = [
  "User interaction consent",
  "Gamified ad compliance",
  "Rich media data collection",
  "Interactive tracking limits",
  "Engagement data handling",
];

const ACTIONS = [
  "Enforce interaction consent",
  "Audit gamified ad rules",
  "Limit rich media tracking",
...
export default function InteractiveadvertisingAdvertisingDashboard() {
