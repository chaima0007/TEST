...
export default function BorderWallMigrationRightsPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/border-wall-migration-rights-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Murs Frontaliers &amp; Droits des Migrants
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Pushbacks · Detention · Asylum Obstruction
          </p>
        </div>
