...
const COLOR = "#0891b2";
const DOMAIN = "podcastadvertising-advertising";
const INDEX_KEY = "estimated_podcastadvertising_index";
const TITLE = "Podcast Advertising";

const SIGNALS = ["Host-read ad disclosure","Dynamic ad insertion","Listener data privacy","Programmatic podcast ads","Attribution transparency"];
const ACTIONS = ["Enforce host-read disclosure","Audit dynamic insertion","Protect listener data","Regulate programmatic ads","Improve attribution clarity"];
