...
export default function Page() {
  ...
  useEffect(() => { fetch("/api/asylum-rights-engine").then(r => r.json()).then(d => setData(d.payload ?? d)); }, []);
  ...
  return (
    <div style={{ background: "#020617", minHeight: "100vh", color: "#f1f5f9", fontFamily: "system-ui,sans-serif" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 24px" }}>
        <h1 style={{ fontSize: 28, fontWeight: 700, color: ACCENT, marginBottom: 8 }}>Droit d&apos;Asile</h1>
        <p style={{ color: "#94a3b8", marginBottom: 32 }}>Refoulement, procédures d&apos;asile &amp; détention des demandeurs · CaelumSwarm™ · Wave 229</p>
