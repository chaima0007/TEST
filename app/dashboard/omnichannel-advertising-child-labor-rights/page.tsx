...
const API_URL = "/api/omnichannel-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Omnicanal";
const COLOR = "#7e22ce";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — surveillance active des pratiques publicitaires omnicanal ciblant les mineurs à travers tous les points de contact requise.</p>}
        {tab === "recommandations" && <p>Mettre en place une politique omnicanal cohérente interdisant le ciblage publicitaire des enfants sur l&apos;ensemble des canaux (physique, digital, mobile) et assurer la conformité ILO-C182 et CSDDD 2024/1760.</p>}
        {tab === "certifications" && (
          <div>
