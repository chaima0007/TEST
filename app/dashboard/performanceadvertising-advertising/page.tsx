...
const COLOR = "#7c3aed";
const DOMAIN = "performanceadvertising-advertising";
const INDEX_KEY = "estimated_performanceadvertising_index";
const TITLE = "Performance Advertising";

const SIGNALS = [
  "Conversion tracking consent",
  "Attribution data limits",
  "Click fraud detection",
  "Performance data sharing",
  "ROI measurement privacy",
];

const ACTIONS = [
  "Enforce conversion consent",
  "Limit attribution data",
  "Deploy fraud detection",
  "Restrict data sharing",
  "Audit ROI measurement",
];
...
export default function PerformanceadvertisingAdvertisingDashboard() {
