...
export default function SexualViolenceConflictImpunityPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/sexual-violence-conflict-impunity-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          ...
          <p className="mt-1 text-sm text-slate-400">
            Viol comme arme de guerre, impunité des auteurs &amp; accès à la justice
          </p>
        </div>
