...
const API_URL = "/api/mobility-advertising";
const TITLE = "Publicité Mobilité — Conformité & Droits";
const COLOR = "#0891b2";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && (
          <p>Conformité CSDDD 2024/1760 — les plateformes de publicité mobilité doivent intégrer des obligations de transparence sur le ciblage géolocalisé des usagers. Les pratiques publicitaires liées aux données de déplacement sont soumises à la diligence raisonnable imposée par l&apos;ILO-C182 et la législation européenne sur la protection des données de mobilité.</p>
        )}
        {tab === "recommandations" && (
          <p>Établir des protocoles de vérification des partenaires publicitaires de mobilité conformes à la CSDDD 2024/1760. Documenter les flux de données de déplacement dans un registre transparent et effectuer des audits d&apos;impact sur les droits à la vie privée selon le cadre OIT C182 et le RGPD.</p>
        )}
        {tab === "certifications" && (
          <div>
