...
const ACCENT = "#c026d3"
const DOMAIN_SLUG = "fast-fashion-textile-rights-engine"
...
const FALLBACK: EngineData = {
  ...
  accent_color: ACCENT,
  entities: [
    { id: "FFT_001", name: "Shein", country: "CN", composite_score: 93.30, severity: "critique", key_violation: "Travail forcé — chaîne d&apos;approvisionnement opaque, surexploitation ouvrières" },
    { id: "FFT_002", name: "Primark", country: "IE", composite_score: 85.10, severity: "critique", key_violation: "Conditions de travail sous-traitants Bangladesh — salaires insuffisants" },
    { id: "FFT_003", name: "H&M", country: "SE", composite_score: 78.55, severity: "critique", key_violation: "Greenwashing — collections &apos;durables&apos; masquant surproduction massive" },
    { id: "FFT_004", name: "Zara", country: "ES", composite_score: 70.90, severity: "critique", key_violation: "Violations droits travailleurs Turquie — heures supplémentaires non payées" },
    { id: "FFT_005", name: "Nike", country: "US", composite_score: 55.35, severity: "élevé", key_violation: "Sous-traitance Vietnam — contrôle insuffisant conditions de travail" },
    { id: "FFT_006", name: "Adidas", country: "DE", composite_score: 50.90, severity: "élevé", key_violation: "Chaîne textile Asie du Sud — audits sociaux insuffisants" },
    { id: "FFT_007", name: "Patagonia", country: "US", composite_score: 31.15, severity: "modéré", key_violation: "Progrès reconnus — transparence partielle chaîne d&apos;approvisionnement" },
    { id: "FFT_008", name: "Eileen Fisher", country: "US", composite_score: 14.80, severity: "faible", key_violation: "Engagement fort — programme reprise vêtements, salaires équitables certifiés" },
  ],
  summary: { avg_composite: 60.01, critique: 4, élevé: 2, modéré: 1, faible: 1 },
}
...
export default function FastFashionTextileRightsPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0f172a", color: "#f8fafc", padding: "2rem", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ textAlign: "center", color: "#475569", fontSize: 12, paddingTop: 24, marginTop: 32, borderTop: "1px solid #1e293b" }}>
        Caelum Partners — Wave {d.wave} · Fast Fashion &amp; Textile Rights Engine
      </div>
    </main>
  )
}
