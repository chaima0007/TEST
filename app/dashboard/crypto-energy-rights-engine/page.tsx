...
const ACCENT = "#f59e0b";
const DOMAIN_SLUG = "crypto-energy-rights-engine";

const RC: Record<string, string> = { critique: "text-red-400", "élevé": "text-orange-400", modéré: "text-yellow-400", faible: "text-emerald-400" };
const RB: Record<string, string> = { critique: "border-red-500/30 bg-red-500/10", "élevé": "border-orange-500/30 bg-orange-500/10", modéré: "border-yellow-500/30 bg-yellow-500/10", faible: "border-emerald-500/30 bg-emerald-500/10" };

const FALLBACK_ENTITIES = [
  { id: "CER-001", name: "Riot Platforms", country: "USA", sector: "Bitcoin Mining", composite_score: 87.05, risk_level: "critique", primary_pattern: "Intensive Energy Use", key_signals: ["Fossil fuel dependency", "Community displacement", "Carbon footprint"], last_updated: "2026-06-22" },
  { id: "CER-002", name: "Marathon Digital", country: "USA", sector: "Bitcoin Mining", composite_score: 84.55, risk_level: "critique", primary_pattern: "Grid Destabilization", key_signals: ["Energy grid strain", "Local rate increases", "Regulatory evasion"], last_updated: "2026-06-22" },
  { id: "CER-003", name: "Bitmain", country: "China", sector: "ASIC Manufacturing", composite_score: 81.05, risk_level: "critique", primary_pattern: "Supply Chain Opacity", key_signals: ["Rare earth extraction", "Labor conditions", "Export controls"], last_updated: "2026-06-22" },
  { id: "CER-004", name: "Foundry USA", country: "USA", sector: "Mining Pool", composite_score: 75.05, risk_level: "critique", primary_pattern: "Market Concentration", key_signals: ["Hash rate dominance", "Decentralization threat", "Community exclusion"], last_updated: "2026-06-22" },
  { id: "CER-005", name: "Antpool", country: "China", sector: "Mining Pool", composite_score: 58.35, risk_level: "élevé", primary_pattern: "Energy Arbitrage", key_signals: ["Coal-powered mining", "Cross-border arbitrage", "Regulatory arbitrage"], last_updated: "2026-06-22" },
  { id: "CER-006", name: "F2Pool", country: "China", sector: "Mining Pool", composite_score: 52.35, risk_level: "élevé", primary_pattern: "Opacity in Operations", key_signals: ["Opaque fee structures", "Miner discrimination", "Jurisdictional shifts"], last_updated: "2026-06-22" },
  { id: "CER-007", name: "Ethereum Foundation", country: "Switzerland", sector: "Blockchain Governance", composite_score: 35.40, risk_level: "modéré", primary_pattern: "Transition Friction", key_signals: ["Post-merge energy claims", "Validator centralization", "Governance exclusion"], last_updated: "2026-06-22" },
  { id: "CER-008", name: "Bitcoin Clean Energy", country: "USA", sector: "Green Mining Initiative", composite_score: 13.60, risk_level: "faible", primary_pattern: "Partial Mitigation", key_signals: ["Renewable energy use", "Community partnerships", "Transparency reporting"], last_updated: "2026-06-22" },
];
...
export default function CryptoEnergyRightsPage() {
  const [data, setData] = useState<CERData | null>(null);
  const [loading, setLoading] = useState(true);
  const [filter, setFilter] = useState("tous");
  const [selected, setSelected] = useState<CEREntity | null>(null);
  ...
  if (loading) return (
    <div style={{ minHeight: "100vh", background: "#020617", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ color: ACCENT, animation: "pulse 2s infinite" }}>Chargement des données crypto-énergie…</div>
    </div>
  );
  if (!data) return (
    <div style={{ minHeight: "100vh", background: "#020617", display: "flex", alignItems: "center", justifyContent: "center" }}>
  ...
  const entities: CEREntity[] = data.entities ?? FALLBACK_ENTITIES;
    ...
    <div style={{ minHeight: "100vh", background: "#020617", color: "white", padding: "24px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto 32px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 700, letterSpacing: "-0.025em", margin: 0 }}>Crypto Énergie &amp; Droits Communautés</h1>
        </div>
        <p style={{ color: "#94a3b8", fontSize: 14, marginLeft: 24 }}>Crypto Energy Rights Engine · Impact énergétique et droits des communautés</p>
      </div>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          {filtered.map(entity => (
            <div key={entity.id} onClick={() => { setSelected(entity); setTab(0); }}
              style={{
                ...
                borderColor: RB[entity.risk_level] ? (entity.risk_level === "critique" ? "rgba(239,68,68,0.3)" : entity.risk_level === "élevé" ? "rgba(249,115,22,0.3)" : entity.risk_level === "modéré" ? "rgba(234,179,8,0.3)" : "rgba(16,185,129,0.3)") : "#1e293b",
        ...
        <p style={{ fontSize: 12, color: "#475569", textAlign: "center" }}>Caelum Partners · Crypto Énergie &amp; Droits Communautés · {data.last_analysis ?? "2026-06-22"}</p>
      </div>
