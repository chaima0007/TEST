...
const COLOR = "#1db954";
const DOMAIN = "spotifyadvertising-advertising";
const INDEX_KEY = "estimated_spotifyadvertising_index";
const TITLE = "Spotify Advertising";
...
const ACTIONS = [
  "Enforce audio consent",
  "Limit listening profiling",
  "Enforce podcast disclosure",
  "Cap mood targeting",
  "Audit free tier data",
];
...
export default function SpotifyadvertisingAdvertisingDashboard() {
