...
const API_URL = "/api/woad-dye-child-labor-rights";
const TITLE = "Droits Enfants Teinture Pastel";
const COLOR = "#1e3a5f";
...
type Entity = {
  ...
  risk_level: string;
  estimated_woad_dye_cultivation_child_labor_rights_index: number;
};
type ApiData = {
  entities: Entity[];
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 480, maxWidth: "90vw" }}>
        ...
        {tab === "indicateurs" && (
          <div>
            <p>Index estimé : <strong>{entity.estimated_woad_dye_cultivation_child_labor_rights_index ?? "—"}</strong></p>
          </div>
        )}
        {tab === "recommandations" && (
          <div>
