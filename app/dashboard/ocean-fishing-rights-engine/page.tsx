...
const ACCENT = "#0c4a6e"
const DOMAIN_SLUG = "ocean-fishing-rights-engine"
...
const FALLBACK: EngineData = {
  engine: "OFR_ENGINE",
  entities: [
    { id: "OFR_001", name: "Thai Union", country: "TH", composite_score: 88.5, severity: "critique", key_violation: "Travail forcé à bord — pêcheurs migrants piégés en mer, conditions d&apos;esclavage documentées" },
    { id: "OFR_002", name: "CP Foods", country: "TH", composite_score: 84.2, severity: "critique", key_violation: "Chaîne d&apos;approvisionnement opaque — sous-traitants utilisant main d&apos;oeuvre forcée" },
    { id: "OFR_003", name: "Pacific Andes", country: "HK", composite_score: 79.8, severity: "critique", key_violation: "Pêche INN massive — flottes fantômes contournant les quotas internationaux" },
    { id: "OFR_004", name: "Dongwon", country: "KR", composite_score: 74.5, severity: "critique", key_violation: "Violations droits travailleurs maritimes — heures excessives, rétention salaires" },
    { id: "OFR_005", name: "Maruha", country: "JP", composite_score: 56.3, severity: "élevé", key_violation: "Pratiques de pêche destructrices — impact sur communautés côtières artisanales" },
    { id: "OFR_006", name: "Nippon Suisan", country: "JP", composite_score: 52.1, severity: "élevé", key_violation: "Contrôle insuffisant de la chaîne d&apos;approvisionnement — risques traçabilité" },
    { id: "OFR_007", name: "MSC", country: "GB", composite_score: 28.4, severity: "modéré", key_violation: "Certification controversée — certains labels accordés malgré signalements violations" },
    { id: "OFR_008", name: "Fair Fish", country: "CH", composite_score: 12.6, severity: "faible", key_violation: "Engagement vérifiable — standards élevés droits travailleurs et pêche durable" },
  ],
  summary: { avg_composite: 59.55, critique: 4, élevé: 2, modéré: 1, faible: 1 },
}
...
export default function OceanFishingRightsPage() {
    ...
    <main style={{ minHeight: "100vh", background: "#0f172a", color: "#f8fafc", padding: "2rem", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <h1 style={{ fontSize: "1.75rem", fontWeight: "bold", color: ACCENT, margin: 0, marginBottom: "0.5rem" }}>
          Pêche &amp; Droits Travailleurs Maritimes
        </h1>
      ...
      <div style={{ textAlign: "center", color: "#475569", fontSize: 12, paddingTop: 24, marginTop: 32, borderTop: "1px solid #1e293b" }}>
        CaelumSwarm™ — OFR Engine · Wave 202
      </div>
    </main>
  )
}
