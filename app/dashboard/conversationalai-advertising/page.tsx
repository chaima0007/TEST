...
const COLOR = "#a855f7";
const DOMAIN = "conversationalai-advertising";
const TITLE = "Conversational AI Advertising";

type Entity = { name: string; composite_score: number; risk_level: string; estimated_conversationalai_index: number };
      ...
      <div style={{ background:"#fff",borderRadius:16,padding:32,maxWidth:540,width:"90%",maxHeight:"80vh",overflowY:"auto" }} onClick={e=>e.stopPropagation()}>
        ...
        {tab==="scores" && (
          <div style={{ display:"flex",flexDirection:"column",gap:10 }}>
            {[["Score composite",entity.composite_score],["Indice conversational AI",entity.estimated_conversationalai_index]].map(([label,val])=>(
        ...
        {tab==="signaux" && (
          <div style={{ fontSize:14,color:"#374151",lineHeight:1.7 }}>
            ...
            <p>Analyse conformité CSDDD pour la chaîne d&apos;approvisionnement IA conversationnelle. Risques liés aux conditions de travail des annotateurs de données et à la consommation énergétique des centres de calcul.</p>
          </div>
        )}
        {tab==="certs" && (
        ...
        {tab==="actions" && (
          <div style={{ fontSize:14,color:"#374151",lineHeight:1.8 }}>
            <p>• Auditer agences d&apos;annotation de données</p>
            <p>• Vérifier conditions de travail annotateurs</p>
            <p>• Mettre en place politique éthique IA</p>
            <p>• Certifier SA8000 prestataires d&apos;annotation</p>
          </div>
        )}
      </div>
    </div>
...
export default function ConversationalaiAdvertisingPage() {
  ...
  return (
    <div style={{ padding:32,fontFamily:"sans-serif",maxWidth:1100,margin:"0 auto" }}>
      ...
      <p style={{ color:"#6b7280",marginBottom:28 }}>Analyse conformité CSDDD 2024/1760 — Chaîne d&apos;approvisionnement Conversational AI</p>
