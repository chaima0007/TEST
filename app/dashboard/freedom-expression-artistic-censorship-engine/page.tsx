...
export default function FreedomExpressionArtisticCensorshipPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/freedom-expression-artistic-censorship-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Liberté d&apos;Expression Artistique &amp; Censure
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Artistes emprisonnés, œuvres interdites &amp; censure culturelle étatique
          </p>
        </div>
