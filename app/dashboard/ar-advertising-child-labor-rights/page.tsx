...
export default function ArAdvertisingPage() {
  const [data, setData] = useState<{ entities: Entity[]; avg_composite: number } | null>(null);
  const [selected, setSelected] = useState<Entity | null>(null);

  useEffect(() => {
    fetch("/api/ar-advertising-child-labor-rights")
      .then(r => r.json())
  ...
  return (
    <div style={{ padding: 32, fontFamily: "sans-serif", maxWidth: 900, margin: "0 auto" }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, color: "#1e293b", marginBottom: 8 }}>AR Advertising — Droits de l&apos;Enfant</h1>
