...
const ACCENT = "#d97706"
const DOMAIN_SLUG = "refugee-asylum-rights-engine"
...
const FALLBACK: EngineData = {
  ...
  accent_color: ACCENT,
  entities: [
    { id: "RAR_001", name: "Frontex", country: "EU", composite_score: 91.0, severity: "critique", key_violation: "Refoulements illégaux en Méditerranée — violations documentées" },
    { id: "RAR_002", name: "Libya Coast Guard", country: "LY", composite_score: 88.5, severity: "critique", key_violation: "Torture et détention arbitraire de réfugiés interceptés" },
    { id: "RAR_003", name: "Greece Border Police", country: "GR", composite_score: 84.0, severity: "critique", key_violation: "Pushbacks illégaux vers Turquie — arrestations arbitraires" },
    { id: "RAR_004", name: "Hungary Border", country: "HU", composite_score: 79.3, severity: "critique", key_violation: "Clôtures et zones de transit — refus d&apos;asile systématique" },
    { id: "RAR_005", name: "Turkey", country: "TR", composite_score: 58.7, severity: "élevé", key_violation: "Déportations forcées vers zones de conflit — violations non-refoulement" },
    { id: "RAR_006", name: "Australia", country: "AU", composite_score: 54.2, severity: "élevé", key_violation: "Détention offshore Nauru & Manus — conditions inhumaines" },
    { id: "RAR_007", name: "UNHCR", country: "CH", composite_score: 27.8, severity: "modéré", key_violation: "Financements insuffisants — gaps protection terrain documentés" },
    { id: "RAR_008", name: "IRC", country: "US", composite_score: 11.5, severity: "faible", key_violation: "Meilleure pratique — aide terrain & plaidoyer systémique" },
  ],
  summary: { avg_composite: 61.9, critique: 4, élevé: 2, modéré: 1, faible: 1 },
}
...
export default function RefugeeAsylumRightsPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0f172a", color: "#f8fafc", padding: "2rem", fontFamily: "system-ui, sans-serif" }}>
          ...
          return (
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingTop: "0.75rem", borderTop: "1px solid #334155" }}>
                <span style={{ fontSize: "0.75rem", color: "#64748b" }}>Score Violations</span>
      ...
      <div style={{ textAlign: "center", color: "#475569", fontSize: 12, paddingTop: 24, marginTop: 32, borderTop: "1px solid #1e293b" }}>
        Caelum Partners — Wave {d.wave} · Refugee Asylum Rights Engine
      </div>
    </main>
  )
}
