...
const API_URL = "/api/quantumtech-advertising";
const TITLE = "Publicité QuantumTech — Conformité & Droits";
const COLOR = "#7c3aed";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && (
          <p>Conformité CSDDD 2024/1760 — les acteurs de la publicité quantique doivent intégrer des obligations de transparence sur l&apos;utilisation des algorithmes quantiques à des fins de ciblage publicitaire. Les pratiques d&apos;optimisation par calcul quantique sont soumises à la diligence raisonnable imposée par l&apos;ILO-C182 et la réglementation européenne sur l&apos;IA et la cryptographie quantique.</p>
        )}
        {tab === "recommandations" && (
          <p>Établir des protocoles de vérification des partenaires publicitaires quantiques conformes à la CSDDD 2024/1760. Documenter les algorithmes de ciblage quantique dans un registre transparent et effectuer des audits d&apos;impact sur les droits numériques selon le cadre OIT C182 et la politique européenne sur l&apos;informatique quantique.</p>
        )}
        {tab === "certifications" && (
          <div>
