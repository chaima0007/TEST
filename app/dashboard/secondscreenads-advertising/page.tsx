...
const COLOR = "#8b5cf6";
const DOMAIN = "secondscreenads-advertising";
const INDEX_KEY = "estimated_secondscreenads_index";
const TITLE = "Second Screen Ads";
...
const SIGNALS = [
  "Dual-screen sync consent",
  "Cross-device tracking",
  "Companion ad disclosure",
  "Attention measurement",
  "Real-time bidding on mobile",
];

const ACTIONS = [
  "Enforce dual-screen consent",
  "Limit cross-device tracking",
  "Label companion ads",
  "Deploy attention metrics",
  "Audit mobile RTB",
];
...
export default function SecondscreenadsAdvertisingDashboard() {
