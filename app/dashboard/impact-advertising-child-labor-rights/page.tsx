...
const API_URL = "/api/impact-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Impact Advertising";
const COLOR = "#0369a1";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — les plateformes de publicité à impact doivent mesurer et certifier l&apos;absence de travail des enfants dans leurs campagnes : ce contrôle est soumis aux obligations de diligence raisonnable de l&apos;ILO-C182 et de la CSDDD concernant la protection des mineurs dans les environnements médias.</p>}
        {tab === "recommandations" && <p>Adopter des métriques d&apos;impact social vérifiables incluant les indicateurs de droits de l&apos;enfant. Documenter les politiques d&apos;impact dans un registre conforme à la CSDDD 2024/1760 et effectuer des audits réguliers d&apos;impact sur les droits de l&apos;enfant selon le cadre ILO-C182.</p>}
        {tab === "certifications" && (
          <div>
