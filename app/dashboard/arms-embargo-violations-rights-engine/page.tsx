...
export default function ArmsEmbargoViolationsRightsPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/arms-embargo-violations-rights-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Violations des Embargos sur les Armes &amp; Droits Humains
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Arms Diversion · State Complicity · Civilian Harm
          </p>
        </div>
