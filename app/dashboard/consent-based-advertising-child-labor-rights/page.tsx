...
const API_URL = "/api/consent-based-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Basée sur le Consentement";
const COLOR = "#0e7490";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — exigence d&apos;un consentement explicite, éclairé et traçable avant toute collecte ou utilisation de données publicitaires concernant des mineurs, conformément aux standards ILO-C182.</p>}
        {tab === "recommandations" && <p>Mettre en place des mécanismes de consentement parental robustes et auditable pour toute publicité ciblant des mineurs. S&apos;assurer que les processus de collecte de consentement respectent la Convention ILO-C182 et les dispositions de la CSDDD 2024/1760, avec revue annuelle des protocoles.</p>}
        {tab === "certifications" && (
          <div>
