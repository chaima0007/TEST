...
const COLOR = "#14b8a6";
const DOMAIN = "chatbotmarketing-advertising";
const TITLE = "Chatbot Marketing Advertising";

type Entity = { name: string; composite_score: number; risk_level: string; estimated_chatbotmarketing_index: number };
      ...
      <div style={{ background:"#fff",borderRadius:16,padding:32,maxWidth:540,width:"90%",maxHeight:"80vh",overflowY:"auto" }} onClick={e=>e.stopPropagation()}>
        ...
        {tab==="scores" && (
          <div style={{ display:"flex",flexDirection:"column",gap:10 }}>
            {[["Score composite",entity.composite_score],["Indice chatbot marketing",entity.estimated_chatbotmarketing_index]].map(([label,val])=>(
        ...
        {tab==="signaux" && (
          <div style={{ fontSize:14,color:"#374151",lineHeight:1.7 }}>
            ...
            <p>Analyse conformité CSDDD pour la chaîne d&apos;approvisionnement chatbot marketing. Risques liés à la gestion des données personnelles et aux conditions de travail dans les centres de données partenaires.</p>
          </div>
        )}
        {tab==="certs" && (
        ...
        {tab==="actions" && (
          <div style={{ fontSize:14,color:"#374151",lineHeight:1.8 }}>
            <p>• Auditer fournisseurs infrastructure cloud</p>
            <p>• Vérifier politique protection données</p>
            <p>• Mettre en place audit RGPD chatbots</p>
            <p>• Certifier ISO 26000 partenaires technologiques</p>
          </div>
        )}
      </div>
    </div>
...
export default function ChatbotmarketingAdvertisingPage() {
  ...
  return (
    <div style={{ padding:32,fontFamily:"sans-serif",maxWidth:1100,margin:"0 auto" }}>
      ...
      <p style={{ color:"#6b7280",marginBottom:28 }}>Analyse conformité CSDDD 2024/1760 — Chaîne d&apos;approvisionnement Chatbot Marketing</p>
