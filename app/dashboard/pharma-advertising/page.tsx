...
const API_URL = "/api/pharma-advertising";
const TITLE = "Publicité Pharmaceutique — Conformité & Droits";
const COLOR = "#7c3aed";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && (
          <p>Conformité CSDDD 2024/1760 — les acteurs de la publicité pharmaceutique doivent respecter des obligations strictes de transparence et de diligence raisonnable. Les pratiques publicitaires sont encadrées par l&apos;ILO-C182 et la réglementation européenne sur la promotion des médicaments auprès du grand public.</p>
        )}
        {tab === "recommandations" && (
          <p>Mettre en place des protocoles de vérification des allégations publicitaires pharmaceutiques conformes à la CSDDD 2024/1760. Documenter les processus de diligence raisonnable et effectuer des audits réguliers d&apos;impact sur les droits des patients selon le cadre OIT C182.</p>
        )}
        {tab === "certifications" && (
          <div>
