...
const API_URL = "/api/madder-root-dye-child-labor-rights";
const TITLE = "Droits Enfants Teinture Garance";
const COLOR = "#7f1d1d";
...
type Entity = {
  ...
  risk_level: string;
  estimated_madder_root_dye_child_labor_rights_index: number;
};
type ApiData = {
  entities: Entity[];
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 480, maxWidth: "90vw" }}>
        ...
        {tab === "indicateurs" && (
          <div>
            <p>Index estimé : <strong>{entity.estimated_madder_root_dye_child_labor_rights_index ?? "—"}</strong></p>
          </div>
        )}
        {tab === "recommandations" && (
          <div>
