...
export default function AntiCorruptionWhistleblowerProtectionPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/anti-corruption-whistleblower-protection-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Protection Lanceurs d&apos;Alerte Anti-Corruption
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            EU Directive 2019/1937 · UNCAC · Journalistes · Défenseurs intégrité
          </p>
        </div>
