...
const COLOR = "#0ea5e9";
const DOMAIN = "voicecommerce-advertising";
const TITLE = "Voice Commerce Advertising";

type Entity = { name: string; composite_score: number; risk_level: string; estimated_voicecommerce_index: number };
      ...
      <div style={{ background:"#fff",borderRadius:16,padding:32,maxWidth:540,width:"90%",maxHeight:"80vh",overflowY:"auto" }} onClick={e=>e.stopPropagation()}>
        ...
        {tab==="scores" && (
          <div style={{ display:"flex",flexDirection:"column",gap:10 }}>
            {[["Score composite",entity.composite_score],["Indice voice commerce",entity.estimated_voicecommerce_index]].map(([label,val])=>(
        ...
        {tab==="signaux" && (
          <div style={{ fontSize:14,color:"#374151",lineHeight:1.7 }}>
            ...
            <p>Analyse conformité CSDDD pour la chaîne d&apos;approvisionnement voice commerce. Risques liés à la fabrication de dispositifs audio et aux conditions de travail dans l&apos;assemblage de composants.</p>
          </div>
        )}
        {tab==="certs" && (
        ...
        {tab==="actions" && (
          <div style={{ fontSize:14,color:"#374151",lineHeight:1.8 }}>
            <p>• Auditer fabricants haut-parleurs intelligents</p>
            <p>• Vérifier chaîne approvisionnement composants audio</p>
            <p>• Mettre en place code conduite voice commerce</p>
            <p>• Certifier ISO 26000 fournisseurs clés</p>
          </div>
        )}
      </div>
    </div>
...
export default function VoicecommerceAdvertisingPage() {
  ...
  return (
    <div style={{ padding:32,fontFamily:"sans-serif",maxWidth:1100,margin:"0 auto" }}>
      ...
      <p style={{ color:"#6b7280",marginBottom:28 }}>Analyse conformité CSDDD 2024/1760 — Chaîne d&apos;approvisionnement Voice Commerce</p>
