...
export default function WhistleblowerProtectionRightsDashboard() {
  const [data, setData] = useState<any>(null);
  const [selected, setSelected] = useState<any>(null);

  useEffect(() => {
    fetch("/api/whistleblower-protection-rights")
      .then(r => r.json())
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f8fafc", padding: 32 }}>
      ...
      <p style={{ color: "#64748b", marginBottom: 32 }}>Analyse CaelumSwarm™ — Protection des lanceurs d&apos;alerte</p>
