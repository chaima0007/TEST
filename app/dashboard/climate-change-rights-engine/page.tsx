...
const ACCENT = "#10b981";
const TITRE = "Changement Climatique & Droits";
...
export default function Page() {
  ...
  useEffect(() => { fetch("/api/climate-change-rights-engine").then(r => r.json()).then(d => setData(d.payload ?? d)); }, []);
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 24px" }}>
        ...
        <div style={{ display: "flex", gap: 16, marginBottom: 32, flexWrap: "wrap" }}>
          ...
          <div style={{ background: "#0f172a", borderRadius: 8, padding: 20, flex: "1 1 200px", display: "flex", flexDirection: "column", gap: 10, justifyContent: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}><span style={{ color: "#94a3b8" }}>Index CCR</span><strong style={{ color: ACCENT }}>{data.avg_estimated_climate_change_rights_index?.toFixed(2)}</strong></div>
          </div>
        ...
        <p style={{ color: "#64748b", fontSize: 13, marginBottom: 24 }}>Vulnérabilité climatique, adaptation &amp; justice climatique</p>
