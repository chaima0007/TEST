...
interface Entity { id: string; name: string; composite_score: number; risk_level: string; estimated_minority_language_index?: number; [key: string]: unknown }
          ...
          <div key={e.id} onClick={() => { setSelected(e); setTab(0) }}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs text-slate-400 mb-1">{e.id}</p>
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-700 max-w-2xl w-full max-h-[85vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            <div className="p-6 border-b border-slate-800">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-xs text-slate-400 mb-1">{selected.id}</p>
