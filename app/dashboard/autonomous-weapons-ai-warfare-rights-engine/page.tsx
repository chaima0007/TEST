...
const ACCENT = "#dc2626";
const SLUG = "autonomous-weapons-ai-warfare-rights-engine";
...
const SUB_SCORES = [
  "lethal_autonomous_weapon_civilian_harm_severity_score",
  "human_control_accountability_removal_scale_score",
  "ai_bias_targeting_discrimination_score",
  "autonomous_weapon_ban_treaty_deficit_gap_score",
];

const SUB_LABELS: Record<string, string> = {
  lethal_autonomous_weapon_civilian_harm_severity_score: "Armes Létales Autonomes",
  human_control_accountability_removal_scale_score: "Suppression Contrôle Humain",
  ai_bias_targeting_discrimination_score: "Biais IA Ciblage",
  autonomous_weapon_ban_treaty_deficit_gap_score: "Déficit Traité Interdiction LAWS",
};
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {tab === "sources" && (
            <p className="text-slate-400 text-sm">Sources: ICRC autonomous weapons report, Stop Killer Robots campaign, UN Secretary General agenda for peace.</p>
          )}
        </div>
      </div>
    </div>
...
export default function AutonomousWeaponsAIWarfarePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Armes Autonomes &amp; IA Militaire</h1>
          <p className="text-slate-400 mt-1">Systèmes d&apos;armes létales autonomes, contrôle humain et droit international humanitaire</p>
        </div>
