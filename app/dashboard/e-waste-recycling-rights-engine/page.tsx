...
interface Entity {
  ...
  estimated_e_waste_recycling_rights_index: number;
}
interface EngineData {
  ...
  avg_estimated_e_waste_recycling_rights_index: number;
...
const INDEX_KEY = "estimated_e_waste_recycling_rights_index";

const FALLBACK_ENTITIES: Entity[] = [
  { id: "EWR-001", name: "Apple", country: "États-Unis", composite_score: 89.75, risk_level: "critique", primary_pattern: "obsolescence_programmee_dechets_electroniques", estimated_e_waste_recycling_rights_index: 8.975 },
  { id: "EWR-002", name: "Samsung", country: "Corée du Sud", composite_score: 87.05, risk_level: "critique", primary_pattern: "exportation_illegale_dechets_electroniques_asie", estimated_e_waste_recycling_rights_index: 8.705 },
  { id: "EWR-003", name: "HP", country: "États-Unis", composite_score: 82.05, risk_level: "critique", primary_pattern: "droits_travailleurs_recyclage_informel", estimated_e_waste_recycling_rights_index: 8.205 },
  { id: "EWR-004", name: "Dell", country: "États-Unis", composite_score: 77.05, risk_level: "critique", primary_pattern: "contamination_metaux_lourds_sites_recyclage", estimated_e_waste_recycling_rights_index: 7.705 },
  { id: "EWR-005", name: "Lenovo", country: "Chine", composite_score: 54.05, risk_level: "élevé", primary_pattern: "insuffisance_programmes_reprise_recyclage", estimated_e_waste_recycling_rights_index: 5.405 },
  { id: "EWR-006", name: "Asus", country: "Taïwan", composite_score: 52.05, risk_level: "élevé", primary_pattern: "manque_transparence_filiere_dechets", estimated_e_waste_recycling_rights_index: 5.205 },
  { id: "EWR-007", name: "Fairphone", country: "Pays-Bas", composite_score: 27.75, risk_level: "modéré", primary_pattern: "modele_reparabilite_partiel_dechets_reduits", estimated_e_waste_recycling_rights_index: 2.775 },
  { id: "EWR-008", name: "Basel Action", country: "International", composite_score: 11.95, risk_level: "faible", primary_pattern: "plaidoyer_convention_bale_dechets_electroniques", estimated_e_waste_recycling_rights_index: 1.195 },
];

const FALLBACK: EngineData = {
  agent: "Déchets Électroniques & Droits",
  total_entities: 8,
  avg_composite: 60.22,
  confidence_score: 0.88,
  avg_estimated_e_waste_recycling_rights_index: 6.022,
  risk_distribution: { critique: 4, "élevé": 2, "modéré": 1, faible: 1 },
  critical_alerts: [
    "Apple: obsolescence_programmee_dechets_electroniques",
    "Samsung: exportation_illegale_dechets_electroniques_asie",
    "HP: droits_travailleurs_recyclage_informel",
    "Dell: contamination_metaux_lourds_sites_recyclage",
  ],
  data_sources: ["basel_action_network_e_waste_tracker", "unep_e_waste_monitor", "ilo_informal_recycling_rights", "greenpeace_e_waste_investigations"],
...
export default function EWasteRecyclingRightsPage() {
  const [data, setData] = useState<EngineData | null>(null);
  const [selected, setSelected] = useState<Entity | null>(null);

  useEffect(() => {
    fetch("/api/e-waste-recycling-rights-engine")
      .then(r => r.json())
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#020617", color: "white", padding: 24 }}>
      ...
      <div style={{ maxWidth: 1152, margin: "0 auto", display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
          <div>
            <h1 style={{ fontSize: 24, fontWeight: "bold", color: "white" }}>Déchets Électroniques &amp; Droits</h1>
            <p style={{ color: "#94a3b8", fontSize: 14, marginTop: 4 }}>
              {d.total_entities} entités · Confiance {(d.confidence_score * 100).toFixed(0)}% · MAJ 2026-06-22
            </p>
          </div>
          <GaugeRing value={d.avg_estimated_e_waste_recycling_rights_index} accent={ACCENT} />
        </div>
