...
const COLOR = "#f97316";
const DOMAIN = "amazonadvertising-advertising";
const INDEX_KEY = "estimated_amazonadvertising_index";
const TITLE = "Amazon Advertising";
...
const SIGNALS = ["Purchase data targeting", "Cross-device identity", "Alexa data integration", "Seller data protection", "Third-party data use"];
const ACTIONS = ["Audit purchase targeting", "Restrict cross-device ID", "Limit Alexa data", "Protect seller data", "Restrict third-party data"];
...
function DetailModal({ entity, onClose }: { entity: Entity; onClose: () => void }) {
  ...
  const tabs: { id: "scores" | "signals" | "certs" | "actions"; label: string }[] = [
    { id: "scores", label: "Scores" }, { id: "signals", label: "Signaux" },
    { id: "certs", label: "Certifications" }, { id: "actions", label: "Actions" },
  ];
  return (
...
export default function AmazonadvertisingAdvertisingDashboard() {
