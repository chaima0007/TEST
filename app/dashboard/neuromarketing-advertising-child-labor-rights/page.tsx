...
const API_URL = "/api/neuromarketing-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Neuromarketing";
const COLOR = "#be123c";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — interdiction des techniques de neuromarketing exploitant les vulnérabilités cognitives des enfants dans les publicités requise.</p>}
        {tab === "recommandations" && <p>Prohiber l&apos;usage de techniques neuromarketing ciblant les enfants, notamment les stimuli subliminaux et les biais cognitifs. Garantir la conformité totale avec ILO-C182 et CSDDD 2024/1760 dans toutes les campagnes publicitaires.</p>}
        {tab === "certifications" && (
          <div>
