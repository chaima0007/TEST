...
export default function ChildMarriageForcedUnionsPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);

  useEffect(() => {
    fetch("/api/child-marriage-forced-unions-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Mariage d&apos;Enfants &amp; Unions Forcées
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Mariages précoces, consentement forcé &amp; droits des filles
          </p>
        </div>
