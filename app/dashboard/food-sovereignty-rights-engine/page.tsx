...
const ACCENT = "#0d2818";
const INDEX_KEY = "estimated_food_sovereignty_rights_index";
...
const FALLBACK_ENTITIES = [
  { id: "FSR-001", name: "Monsanto/Bayer", severity: "critique", score: 89 },
  { id: "FSR-002", name: "Syngenta", severity: "critique", score: 85 },
  { id: "FSR-003", name: "DowDuPont/Corteva", severity: "critique", score: 82 },
  { id: "FSR-004", name: "BASF", severity: "critique", score: 78 },
  { id: "FSR-005", name: "Cargill", severity: "élevé", score: 58 },
  { id: "FSR-006", name: "ADM", severity: "élevé", score: 53 },
  { id: "FSR-007", name: "FAO", severity: "modéré", score: 32 },
  { id: "FSR-008", name: "La Via Campesina", severity: "faible", score: 10 },
];

const FALLBACK_DATA_SOURCES = [
  "grain_org_seed_laws",
  "la_via_campesina",
  "un_special_rapporteur_food",
  "etc_group_geopiracy",
];

const FALLBACK_CRITICAL_ALERTS = [
  "Monsanto/Bayer: monopole_semences_mondial_brevets_ogm",
  "Syngenta: patents_bloquant_acces_petits_agriculteurs",
];
...
export default function FoodSovereigntyRightsDashboard() {
  ...
  useEffect(() => {
    fetch("/api/food-sovereignty-rights-engine")
      .then((r) => r.json())
      .then((d) => {
    ...
    <div style={{ minHeight: "100vh", background: "#0f172a", color: "#f1f5f9", fontFamily: "system-ui, sans-serif", padding: "2rem" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "2rem", borderLeft: `4px solid ${ACCENT}`, paddingLeft: "1rem" }}>
          <h1 style={{ fontSize: "1.75rem", fontWeight: 700, margin: 0 }}>Souveraineté Alimentaire — Droits Semences</h1>
          <p style={{ color: "#94a3b8", marginTop: "0.5rem" }}>Wave 213 · Indice des violations droits alimentaires</p>
          {index !== null && (
