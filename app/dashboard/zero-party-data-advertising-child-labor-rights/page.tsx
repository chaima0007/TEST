...
const API_URL = "/api/zero-party-data-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Zero-Party Data";
const COLOR = "#b45309";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — encadrement strict de la collecte de données zero-party auprès des mineurs : les données doivent être fournies volontairement avec consentement parental vérifiable et ne peuvent être utilisées à des fins de ciblage publicitaire sans accord explicite conforme à ILO-C182.</p>}
        {tab === "recommandations" && <p>Garantir que tout dispositif de collecte de données zero-party impliquant des mineurs intègre un mécanisme de vérification de l&apos;âge et du consentement parental. Auditer les flux de données selon les exigences de la CSDDD 2024/1760 et former les équipes aux obligations de protection des enfants définies par l&apos;ILO-C182.</p>}
        {tab === "certifications" && (
          <div>
