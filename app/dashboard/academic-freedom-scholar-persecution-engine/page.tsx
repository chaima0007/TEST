...
interface Entity {
  ...
  estimated_academic_freedom_scholar_persecution_index: number;
}
interface EngineData {
  ...
  avg_estimated_academic_freedom_scholar_persecution_index: number;
...
// Main page component
export default function AcademicFreedomScholarPersecutionPage() {
  ...
  const INDEX_KEY = "estimated_academic_freedom_scholar_persecution_index";

  useEffect(() => {
    fetch("/api/academic-freedom-scholar-persecution-engine")
      .then(r => r.json())
    ...
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <GaugeRing value={data.avg_estimated_academic_freedom_scholar_persecution_index} accent={ACCENT} />
        </div>
