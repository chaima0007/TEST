...
const ACCENT = "#f59e0b";
const TITRE = "Négociation Collective";
...
export default function Page() {
  ...
  useEffect(() => { fetch("/api/collective-bargaining-rights-engine").then(r => r.json()).then(d => setData(d.payload ?? d)); }, []);
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 24px" }}>
        ...
        <div style={{ display: "flex", gap: 16, marginBottom: 32, flexWrap: "wrap" }}>
          ...
          <div style={{ background: "#0f172a", borderRadius: 8, padding: 20, flex: "1 1 200px", display: "flex", flexDirection: "column", gap: 10, justifyContent: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}><span style={{ color: "#94a3b8" }}>Index CBR</span><strong style={{ color: ACCENT }}>{data.avg_estimated_collective_bargaining_rights_index?.toFixed(2)}</strong></div>
          </div>
