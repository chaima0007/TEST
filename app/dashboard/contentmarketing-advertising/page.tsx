...
const COLOR = "#0891b2";
const DOMAIN = "contentmarketing-advertising";
const INDEX_KEY = "estimated_contentmarketing_index";
const TITLE = "Content Marketing Advertising";
...
const ACTIONS = [
  "Audit editorial standards",
  "Deploy plagiarism detection tools",
  "Enforce author disclosure policies",
  "Map content supply chain",
...
export default function ContentmarketingAdvertisingDashboard() {
