...
const API_URL = "/api/first-party-data-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité First-Party Data";
const COLOR = "#166534";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — l&apos;utilisation de données first-party à des fins publicitaires nécessite un consentement éclairé : lorsque des mineurs figurent dans la base de données, leur protection est encadrée par l&apos;ILO-C182 et requiert une gestion stricte des droits d&apos;accès et de l&apos;exploitation commerciale de leurs données.</p>}
        {tab === "recommandations" && <p>Identifier et segmenter les profils de mineurs dans les bases first-party afin d&apos;exclure systématiquement leurs données de toute activation publicitaire. Mettre en conformité les politiques de rétention et d&apos;utilisation des données avec la CSDDD 2024/1760 et conduire un audit annuel selon les standards ILO-C182.</p>}
        {tab === "certifications" && (
          <div>
