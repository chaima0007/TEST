...
const COLOR = "#16a34a";
const DOMAIN = "locationbased-advertising";
const INDEX_KEY = "estimated_locationbased_index";
const TITLE = "Location-Based Advertising";
...
const ACTIONS = [
  "Enforce geolocation consent",
  "Limit precise tracking",
...
export default function LocationbasedAdvertisingDashboard() {
