...
export default function ApostasyBlasphemyPersecutionPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/apostasy-blasphemy-persecution-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Persécution Apostasie &amp; Blasphème
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Liberté de conscience · Lois pénales religieuses · USCIRF · ONU RS
          </p>
        </div>
