...
const API_URL = "/api/social-media-influencer-child-labor-rights";
const TITLE = "Droits Enfants Marketing Influenceurs";
const COLOR = "#7c3aed";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 480, maxWidth: "90vw" }}>
        ...
        {tab === "indicateurs" && (
          <p>Conformité CSDDD 2024/1760 — surveillance active requise.</p>
        )}
        {tab === "recommandations" && (
