...
const API_URL = "/api/influencervetting-advertising";
const TITLE = "Influencer Vetting Advertising";
const COLOR = "#7c3aed";
const DOMAIN = "influencervetting-advertising";
const INDEX_KEY = "estimated_influencervetting_index";
...
const ACTIONS = [
  "Deploy fake follower detection",
  "Audit audience authenticity",
  "Enforce brand safety vetting",
  "Require disclosure compliance",
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && (
          <p>Conformité {TITLE} — les plateformes et marques doivent effectuer une diligence raisonnable sur l&apos;authenticité des influenceurs, incluant la détection de faux abonnés, la vérification de l&apos;engagement et le respect des obligations de divulgation publicitaire selon les cadres réglementaires en vigueur.</p>
        )}
        {tab === "recommandations" && (
          <div>
...
export default function InfluencervettingAdvertisingDashboard() {
