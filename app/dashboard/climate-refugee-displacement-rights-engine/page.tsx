...
interface Entity {
  ...
  estimated_climate_refugee_displacement_rights_index: number;
}
interface EngineData {
  ...
  avg_estimated_climate_refugee_displacement_rights_index: number;
...
// Main page component
export default function ClimateRefugeeDisplacementRightsPage() {
  ...
  const INDEX_KEY = "estimated_climate_refugee_displacement_rights_index";

  useEffect(() => {
    fetch("/api/climate-refugee-displacement-rights-engine")
      .then(r => r.json())
    ...
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <GaugeRing value={data.avg_estimated_climate_refugee_displacement_rights_index} accent={ACCENT} />
        </div>
