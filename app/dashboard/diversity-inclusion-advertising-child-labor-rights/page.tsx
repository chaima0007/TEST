...
const API_URL = "/api/diversity-inclusion-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Diversity & Inclusion Advertising";
const COLOR = "#0891b2";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — les initiatives publicitaires en matière de diversité et d&apos;inclusion doivent intégrer des engagements vérifiables contre le travail des enfants : ce contrôle est soumis aux obligations de diligence raisonnable de l&apos;ILO-C182 et de la CSDDD concernant la protection des mineurs dans les environnements médias.</p>}
        {tab === "recommandations" && <p>Intégrer des indicateurs de droits de l&apos;enfant dans toutes les campagnes D&I publicitaires. Documenter les engagements dans un registre conforme à la CSDDD 2024/1760 et effectuer des audits réguliers d&apos;impact sur les droits de l&apos;enfant selon le cadre ILO-C182.</p>}
        {tab === "certifications" && (
          <div>
