...
export default function WaterSanitationRightsDashboard() {
  const [data, setData] = useState<DomainData | null>(null)
  const color = "#0ea5e9"
  useEffect(() => {
    fetch("/api/water-sanitation-rights-engine").then(r => r.json()).then(d => setData(d.payload ?? d))
  }, [])
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-2" style={{ color }}>Droit à l&apos;Eau &amp; Assainissement</h1>
