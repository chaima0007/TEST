...
const API_URL = "/api/voice-search-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Recherche Vocale";
const COLOR = "#0ea5e9";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — surveillance active des publicités vocales ciblant les mineurs requise.</p>}
        {tab === "recommandations" && <p>Encadrer strictement les formats publicitaires vocaux exposant les enfants et garantir le respect des conventions ILO-C182 et CSDDD 2024/1760.</p>}
        {tab === "certifications" && (
          <div>
