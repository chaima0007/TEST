...
const COLOR = "#e60023";
const DOMAIN = "pinterestadvertising-advertising";
const INDEX_KEY = "estimated_pinterestadvertising_index";
const TITLE = "Pinterest Advertising";
...
const SIGNALS = [
  "Shopping data consent",
  "Interest-based targeting",
  "Influencer pin disclosure",
  "Child board protections",
  "Visual data scraping",
];

const ACTIONS = [
  "Audit shopping data use",
  "Limit interest targeting",
  "Enforce pin disclosure",
  "Deploy child protections",
  "Block visual scraping",
];
...
export default function PinterestadvertisingAdvertisingDashboard() {
