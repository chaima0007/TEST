...
const API_URL = "/api/sustainable-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Sustainable Advertising";
const COLOR = "#15803d";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — les solutions de publicité durable doivent garantir l&apos;absence de recours au travail des enfants dans toute la chaîne de valeur publicitaire : ce contrôle est soumis aux obligations de diligence raisonnable de l&apos;ILO-C182 et de la CSDDD concernant la protection des mineurs dans les environnements médias.</p>}
        {tab === "recommandations" && <p>Intégrer des critères de durabilité et de protection de l&apos;enfance dans tous les appels d&apos;offres publicitaires. Documenter les politiques de placement dans un registre conforme à la CSDDD 2024/1760 et effectuer des audits réguliers d&apos;impact sur les droits de l&apos;enfant selon le cadre ILO-C182.</p>}
        {tab === "certifications" && (
          <div>
