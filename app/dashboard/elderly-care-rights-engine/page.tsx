...
const ACCENT = "#0d9488"
const DOMAIN_SLUG = "elderly-care-rights-engine"
...
const FALLBACK: EngineData = {
  ...
  accent_color: ACCENT,
  entities: [
    { id: "ECR_001", name: "Orpea", country: "FR", composite_score: 94.30, severity: "critique", key_violation: "Maltraitance systémique — sous-alimentation, contention abusive, manque personnel" },
    { id: "ECR_002", name: "Korian", country: "FR", composite_score: 92.70, severity: "critique", key_violation: "Conditions dégradantes — plaintes familles, insuffisance soins hygiène" },
    { id: "ECR_003", name: "Four Seasons", country: "CA", composite_score: 82.80, severity: "critique", key_violation: "EHPAD canadiens — décès évitables COVID, isolement forcé non justifié" },
    { id: "ECR_004", name: "Bupa", country: "GB", composite_score: 69.10, severity: "critique", key_violation: "Résidences UK — personnel insuffisant, violations droits à la dignité" },
    { id: "ECR_005", name: "HC-One", country: "GB", composite_score: 55.10, severity: "élevé", key_violation: "Inspections défavorables — soins inadaptés résidents démence" },
    { id: "ECR_006", name: "Sunrise Senior Living", country: "US", composite_score: 47.30, severity: "élevé", key_violation: "Plaintes récurrentes — rotation personnel excessive, soins intermittents" },
    { id: "ECR_007", name: "Amedisys", country: "US", composite_score: 29.30, severity: "modéré", key_violation: "Soins à domicile — amélioration continue, audits qualité en cours" },
    { id: "ECR_008", name: "Eden Alternative", country: "US", composite_score: 13.20, severity: "faible", key_violation: "Modèle centré personne — meilleure pratique dignité et autonomie résidents" },
  ],
  summary: { avg_composite: 60.48, critique: 4, élevé: 2, modéré: 1, faible: 1 },
}
...
export default function ElderlyCarRightsPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0f172a", color: "#f8fafc", padding: "2rem", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ textAlign: "center", color: "#475569", fontSize: 12, paddingTop: 24, marginTop: 32, borderTop: "1px solid #1e293b" }}>
        Caelum Partners — Wave {d.wave} · Elderly Care Rights Engine
      </div>
    </main>
  )
}
