...
const COLOR = "#a855f7";
const DOMAIN = "virtualinfluencer-advertising";
const INDEX_KEY = "estimated_virtualinfluencer_index";
const TITLE = "Virtual Influencer Advertising";

const SIGNALS = [
  "AI persona disclosure",
  "CGI identity transparency",
  "Virtual influencer consent",
  "Synthetic identity risks",
  "Audience deception prevention",
];

const ACTIONS = [
  "Require AI disclosure labels",
  "Enforce CGI transparency",
  "Implement persona consent",
  "Audit synthetic identity",
  "Deploy anti-deception measures",
];
...
function deriveCerts(entity: Entity): string[] {
  ...
  return [
    ...
    `Niveau de risque virtual influencer advertising : ${entity.risk_level}`,
    `Indice estimé Caelum : ${idx.toFixed(2)} / 10`,
    `Conformité influenceur virtuel : ${entity.composite_score >= 60 ? "Surveillance active" : "Monitoring standard"}`,
    `Certification Wave 422 — Virtual Influencer Advertising Intelligence`,
  ];
}
      ...
      >
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 16 }}>
          <div>
            ...
            <div style={{ fontSize: 12, color: COLOR, marginTop: 2 }}>{TITLE} · Wave 422</div>
          </div>
...
export default function VirtualinfluencerAdvertisingDashboard() {
    ...
    <div style={{ minHeight: "100vh", background: "#030712", color: "#fff", padding: "32px 24px" }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 13, color: `${COLOR}99`, margin: 0 }}>
          Caelum Partners · Wave 422 · Analyse influenceur virtuel · {data.generatedAt ? new Date(data.generatedAt).toLocaleDateString("fr-FR") : "2026-06-22"}
      ...
      <div style={{ textAlign: "center", fontSize: 11, color: "#334155" }}>
        Caelum Partners · {TITLE} Intelligence · Wave 422
      </div>
