...
const COLOR = "#2563eb";
const DOMAIN = "sociallistening-advertising";
const INDEX_KEY = "estimated_sociallistening_index";
const TITLE = "Social Listening Advertising";

const SIGNALS = [
  "Public mention consent",
  "User data scraping limits",
  "Sentiment analysis privacy",
  "Brand monitoring disclosure",
  "Social data retention",
];

const ACTIONS = [
  "Enforce mention consent",
  "Limit data scraping",
  "Audit sentiment analysis",
  "Disclose brand monitoring",
...
function deriveCerts(entity: Entity): string[] {
  return [
    ...
    `Niveau de risque ${DOMAIN} : ${entity.risk_level}`,
    `Indice estimé Caelum : ${entity.estimated_index.toFixed(2)} / 10`,
    `Conformité plateforme ${DOMAIN} : ${entity.composite_score >= 60 ? "Surveillance active" : "Monitoring standard"}`,
    `Certification Wave 418 — ${TITLE} Intelligence`,
  ];
}
      ...
      >
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 16 }}>
          <div>
            ...
            <div style={{ fontSize: 12, color: COLOR, marginTop: 2 }}>{TITLE} · Wave 418</div>
          </div>
...
export default function SociallisteningAdvertisingDashboard() {
    ...
    <div style={{ minHeight: "100vh", background: "#030712", color: "#fff", padding: "32px 24px" }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 13, color: `${COLOR}99`, margin: 0 }}>
          Caelum Partners · Wave 418 · Analyse {TITLE.toLowerCase()} · {data.generatedAt ? new Date(data.generatedAt).toLocaleDateString("fr-FR") : "2026-06-22"}
      ...
      <div style={{ textAlign: "center", fontSize: 11, color: "#334155" }}>
        Caelum Partners · {TITLE} Intelligence · Wave 418
      </div>
