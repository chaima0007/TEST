...
const API_URL = "/api/contextual-signals-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Signaux Contextuels";
const COLOR = "#0369a1";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — les signaux contextuels publicitaires peuvent cibler des contenus consommés par des enfants : leur collecte et utilisation à des fins de ciblage publicitaire est soumise aux restrictions de l&apos;ILO-C182 et de la CSDDD concernant la protection des données des mineurs.</p>}
        {tab === "recommandations" && <p>Mettre en place des filtres contextuels excluant les environnements numériques fréquentés par des mineurs. Documenter les sources de signaux contextuels dans un registre conforme à la CSDDD 2024/1760 et réaliser des évaluations d&apos;impact sur les droits de l&apos;enfant selon le cadre ILO-C182 avant tout déploiement.</p>}
        {tab === "certifications" && (
          <div>
