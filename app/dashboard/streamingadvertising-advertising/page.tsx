...
const COLOR = "#0891b2";
const DOMAIN = "streamingadvertising-advertising";
const INDEX_KEY = "estimated_streamingadvertising_index";
const TITLE = "Streaming Advertising";
...
const SIGNALS = [
  "Content-matched ad targeting",
  "Subscriber data protection",
  "Cross-platform frequency caps",
  "Child content ad restrictions",
  "Binge-watch ad limits",
];
const ACTIONS = [
  "Audit content-matched targeting",
  "Protect subscriber data",
  "Implement frequency caps",
  "Enforce child content rules",
  "Cap binge-watch ads",
];
...
export default function StreamingadvertisingAdvertisingDashboard() {
