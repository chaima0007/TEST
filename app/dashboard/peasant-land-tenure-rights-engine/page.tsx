...
const ACCENT = "#1a2a0a";
const SLUG = "peasant-land-tenure-rights-engine";
...
function DetailModal({ entity, onClose }: { entity: Record<string, unknown>; onClose: () => void }) {
  ...
  const SUB_SCORES = [
    "land_dispossession_eviction_severity_score",
    "customary_tenure_recognition_deficit_score",
    "land_grab_corporate_impunity_scale_score",
    "peasant_rights_legal_enforcement_gap_score",
  ];
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {tab === "sources" && (
            <p className="text-slate-400 text-sm">Sources: Déclaration ONU droits paysans 2018, FAO directives volontaires tenure 2012, Land Matrix Initiative, Oxfam rapport accaparement terres 2023.</p>
          )}
        </div>
      </div>
    </div>
...
export default function PeasantLandTenureRightsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Droits Fonciers Paysans &amp; Tenure Terrienne</h1>
          <p className="text-slate-400 mt-1">Déclaration ONU 2018 · Land Matrix · Accaparement terres · FAO</p>
        </div>
