...
export default function PovertyCriminalizationAntiHomelessLawsPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/poverty-criminalization-anti-homeless-laws-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Criminalisation de la Pauvreté &amp; Sans-Abrisme
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Anti-Homeless Laws · Arrestations · Expulsions · Droits Urbains
          </p>
        </div>
