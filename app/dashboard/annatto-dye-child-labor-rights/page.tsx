...
const API_URL = "/api/annatto-dye-child-labor-rights";
const TITLE = "Droits Enfants Teinture Rocou";
const COLOR = "#c2410c";
...
type Entity = {
  ...
  risk_level: string;
  estimated_annatto_dye_child_labor_rights_index: number;
};
type ApiData = {
  entities: Entity[];
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 480, maxWidth: "90vw" }}>
        ...
        {tab === "indicateurs" && (
          <p>Index estimé : <strong>{entity.estimated_annatto_dye_child_labor_rights_index}</strong></p>
        )}
        {tab === "recommandations" && (
