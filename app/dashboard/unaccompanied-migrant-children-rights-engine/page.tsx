...
const ACCENT = "#0a1a3a";
const SLUG = "unaccompanied-migrant-children-rights-engine";
...
function DetailModal({ entity, onClose }: { entity: Record<string, unknown>; onClose: () => void }) {
  ...
  const SUB_SCORES = [
    "child_detention_border_severity_score",
    "guardian_legal_representation_deficit_score",
    "family_separation_trauma_impact_score",
    "asylum_procedure_child_rights_compliance_score",
  ];
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {tab === "sources" && (
            <p className="text-slate-400 text-sm">Sources: UNHCR rapport enfants non accompagnés 2023, UNICEF migration enfants 2023, Human Rights Watch détention enfants 2023, Règlement UE procédures asile 2024.</p>
          )}
        </div>
      </div>
    </div>
...
export default function UnaccompaniedMigrantChildrenRightsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Enfants Migrants Non Accompagnés &amp; Droits</h1>
          <p className="text-slate-400 mt-1">UNHCR · UNICEF · Détention enfants · Règlement EU Asile 2024</p>
        </div>
