...
const API_URL = "/api/metaverse-advertising";
const TITLE = "Metaverse Advertising Intelligence";
const COLOR = "#06b6d4";
...
const CERTS_TEMPLATE: Omit<Cert, "status" | "year">[] = [
  ...
  { code: "GDPR-VR", label: "GDPR Virtual Reality Compliance", issuer: "Union Européenne" },
  { code: "IAB-XR", label: "IAB Extended Reality Standards", issuer: "IAB Tech Lab" },
  { code: "XR-SAFETY", label: "XR Safety Framework", issuer: "XR Association" },
  { code: "COPPA-META", label: "COPPA Metaverse Compliance", issuer: "FTC" },
];
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité metaverse advertising — les plateformes publicitaires en réalité virtuelle doivent intégrer des protections spécifiques pour les mineurs et les données biométriques : ce contrôle est soumis aux obligations COPPA et aux standards XR Association pour la publicité immersive responsable.</p>}
        {tab === "recommandations" && <p>Implémenter des filtres de protection des mineurs dans tous les environnements virtuels publicitaires. Documenter les traitements de données biométriques conformément au GDPR et effectuer des audits réguliers d&apos;impact sur la santé mentale des utilisateurs selon le cadre XR Safety Framework.</p>}
        {tab === "certifications" && (
          <div>
