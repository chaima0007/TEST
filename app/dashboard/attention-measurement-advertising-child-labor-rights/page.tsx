...
const API_URL = "/api/attention-measurement-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Mesure de l'Attention";
const COLOR = "#7c3aed";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — les outils de mesure de l&apos;attention publicitaire collectent des données comportementales pouvant identifier des mineurs : leur usage est soumis aux restrictions de l&apos;ILO-C182 et de la CSDDD concernant la surveillance et le profilage d&apos;enfants à des fins commerciales.</p>}
        {tab === "recommandations" && <p>Exclure systématiquement les profils mineurs des pipelines de mesure de l&apos;attention et désactiver la collecte de données biométriques sur les plateformes à audience mixte. Établir un cadre de conformité CSDDD 2024/1760 et documenter les évaluations d&apos;impact sur les droits de l&apos;enfant selon l&apos;ILO-C182.</p>}
        {tab === "certifications" && (
          <div>
