...
const COLOR = "#0f766e";
const DOMAIN = "geotargeting-advertising";
const INDEX_KEY = "estimated_geotargeting_index";
const TITLE = "Geo-Targeting Advertising";
...
const ACTIONS = [
  ...
  "Cap precision targeting",
  "Implement cross-border safeguards",
  "Block sensitive location targeting",
  "Deploy anonymization protocols",
];
...
export default function GeotargetingAdvertisingDashboard() {
