...
export default function MineralWaterExtractionCommunityRightsDashboard() {
  const [data, setData] = useState<EngineData | null>(null);
  const [selected, setSelected] = useState<EntityResult | null>(null);
  const [tab, setTab] = useState(0);

  useEffect(() => {
    fetch("/api/mineral-water-extraction-community-rights")
      .then(r => r.json())
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: 32, fontFamily: "sans-serif" }}>
      <h1 style={{ fontSize: 28, fontWeight: 800, marginBottom: 8 }}>Droits Communautés — Extraction Eau Minérale</h1>
          ...
          <div style={{ background: "#fff", borderRadius: 16, padding: 32, maxWidth: 480, width: "90%", maxHeight: "80vh", overflow: "auto" }}
            ...
            {tab === 2 && (
              <div>
                ...
                <p>Conformité EU 2024/1760 requise — audit obligatoire pour ce domaine à risque {selected.risk_level}.</p>
              </div>
            )}
