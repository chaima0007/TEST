...
interface EngineData {
  ...
  avg_estimated_camel_jockey_child_rights_index: number;
...
export default function CamelJockeyChildRightsDashboard() {
  ...
  useEffect(() => {
    fetch("/api/camel-jockey-child-rights")
      .then((r) => r.json())
      .then((d) => {
        setData(d.payload ?? d);
        setLoading(false);
  ...
  const index = data.avg_estimated_camel_jockey_child_rights_index ?? 0;
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="border-l-4 pl-6" style={{ borderColor: ACCENT }}>
          <h1 className="text-3xl font-bold text-white">
            Droits des Enfants Jockeys de Chameaux
          </h1>
          <p className="text-slate-400 mt-2">
            Child Labor · Camel Racing · Child Exploitation · Sports Rights
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-900 rounded-2xl p-6 flex flex-col items-center">
            ...
            <div className="text-slate-400 text-sm mt-1">Indice Jockeys Enfants &amp; Chameaux</div>
          </div>
