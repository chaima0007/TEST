...
const API_URL = "/api/entertainment-advertising-child-labor-rights";
const TITLE = "Publicité Divertissement & Cinéma";
const COLOR = "#dc2626";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — encadrement de la publicité dans le divertissement et le cinéma ciblant les mineurs : restriction des pratiques de placement de produit dans les contenus jeunesse, obligation de classification des publicités selon l&apos;âge et respect des conventions ILO-C182 sur les droits des enfants dans les productions cinématographiques et les chaînes d&apos;approvisionnement du divertissement.</p>}
        {tab === "recommandations" && <p>Adopter des codes de conduite sectoriels interdisant le ciblage publicitaire comportemental des mineurs dans les plateformes de divertissement. Réaliser des audits de conformité CSDDD 2024/1760 sur les pratiques publicitaires et renforcer la formation des équipes marketing aux obligations de l&apos;ILO-C182 dans l&apos;ensemble de l&apos;écosystème cinéma et divertissement.</p>}
        {tab === "certifications" && (
          <div>
