...
const ACCENT = "#f97316";
const SLUG = "freedom-assembly-association-rights-engine";
...
function DetailModal({ entity, onClose }: { entity: Record<string, unknown>; onClose: () => void }) {
  ...
  const SUB_SCORES = [
    "protest_crackdown_violence_severity_score",
    "union_suppression_labor_rights_scale_score",
    "civil_society_ngo_criminalization_score",
    "assembly_permit_restriction_deficit_gap_score",
  ];
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {tab === "sources" && (
            <p className="text-slate-400 text-sm">Sources: ITUC Global Rights Index, CIVICUS Monitor, UN Special Rapporteur on Freedom of Peaceful Assembly and of Association.</p>
          )}
        </div>
      </div>
    </div>
...
export default function FreedomAssemblyAssociationRightsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Liberté Réunion &amp; Association</h1>
          <p className="text-slate-400 mt-1">Liberté de réunion et d&apos;association, répression des manifestations et droit syndical</p>
        </div>
