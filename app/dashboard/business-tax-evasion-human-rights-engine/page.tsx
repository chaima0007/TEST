...
export default function BusinessTaxEvasionHumanRightsDashboard() {
  const [data, setData] = useState<DomainData | null>(null)
  const color = "#4f46e5"

  useEffect(() => {
    fetch("/api/business-tax-evasion-human-rights-engine")
      .then(r => r.json())
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-2" style={{ color }}>Évasion Fiscale &amp; Droits Humains</h1>
