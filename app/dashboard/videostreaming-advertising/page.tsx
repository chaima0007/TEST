...
const COLOR = "#0ea5e9";
const DOMAIN = "videostreaming-advertising";
const INDEX_KEY = "estimated_videostreaming_index";
const TITLE = "Video Streaming Advertising";
...
const SIGNALS = [
  "Pre-roll ad disclosure",
  "Viewer data consent",
  "Content targeting transparency",
  "Ad skip compliance",
  "Streaming data retention",
];

const ACTIONS = [
  "Enforce pre-roll disclosure",
  "Audit viewer consent",
  "Improve targeting transparency",
  "Comply with skip rules",
...
export default function VideostreamingAdvertisingDashboard() {
