...
const API_URL = "/api/identity-resolution-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Résolution d'Identité";
const COLOR = "#7c2d12";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — la résolution d&apos;identité publicitaire croise de multiples signaux pouvant révéler l&apos;identité de mineurs : ce processus est soumis aux restrictions les plus strictes de l&apos;ILO-C182 et de la CSDDD concernant la collecte et l&apos;exploitation de données personnelles d&apos;enfants à des fins commerciales.</p>}
        {tab === "recommandations" && <p>Intégrer des contrôles de vérification d&apos;âge à chaque étape du pipeline de résolution d&apos;identité afin de neutraliser les profils correspondant à des mineurs. Mettre en place un registre de traitement conforme à la CSDDD 2024/1760 et réaliser des évaluations d&apos;impact sur les droits de l&apos;enfant selon le cadre ILO-C182 avant tout déploiement à grande échelle.</p>}
        {tab === "certifications" && (
          <div>
