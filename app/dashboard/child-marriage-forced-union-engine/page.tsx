...
export default function ChildMarriageForcedUnionDashboard() {
  const [data, setData] = useState<DomainData | null>(null)
  const color = "#f43f5e"
  useEffect(() => {
    fetch("/api/child-marriage-forced-union-engine").then(r => r.json()).then(d => setData(d.payload ?? d))
  }, [])
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-2" style={{ color }}>Mariage d&apos;Enfants &amp; Unions Forcées</h1>
