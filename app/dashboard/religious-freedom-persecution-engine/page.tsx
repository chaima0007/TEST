...
export default function ReligiousFreedomPersecutionDashboard() {
  const [data, setData] = useState<DomainData | null>(null)
  const color = "#a78bfa"
  useEffect(() => {
    fetch("/api/religious-freedom-persecution-engine").then(r => r.json()).then(d => setData(d.payload ?? d))
  }, [])
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-2" style={{ color }}>Libert&eacute; Religieuse &amp; Pers&eacute;cutions</h1>
