...
const API_URL = "/api/insurance-advertising-child-labor-rights";
const TITLE = "Publicité Assurance & Finance";
const COLOR = "#1d4ed8";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — les acteurs de l&apos;assurance et de la finance doivent encadrer leurs pratiques publicitaires ciblant les mineurs : interdiction du démarchage de produits financiers complexes auprès des moins de 18 ans, respect de l&apos;ILO-C182 dans les contenus promotionnels et transparence sur les conditions d&apos;accès aux produits.</p>}
        {tab === "recommandations" && <p>Auditer les campagnes publicitaires financières diffusées sur des canaux accessibles aux mineurs. Mettre en place un cadre de conformité CSDDD 2024/1760 pour les communications commerciales destinées aux jeunes adultes. Former les équipes marketing aux obligations ILO-C182 et aux réglementations financières sur la protection des mineurs.</p>}
        {tab === "certifications" && (
          <div>
