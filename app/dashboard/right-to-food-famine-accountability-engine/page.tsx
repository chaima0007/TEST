...
export default function RightToFoodFamineAccountabilityPage() {
  ...
  useEffect(() => {
    fetch("/api/right-to-food-famine-accountability-engine").then(r => r.json()).then(d => { setData(d.payload ?? d); setLoading(false); }).catch(() => setLoading(false));
  }, []);
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 p-6">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight">Droit à l&apos;Alimentation &amp; Responsabilité Famine</h1>
        </div>
        <p className="text-slate-400 text-sm ml-6">Aide Bloquée · Famine Intentionnelle · FAO · Droit International Humanitaire</p>
      </div>
