...
const API_URL = "/api/social-commerce-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Social Commerce";
const COLOR = "#db2777";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — surveillance active des pratiques publicitaires en social commerce requise.</p>}
        {tab === "recommandations" && <p>Mettre en place des mécanismes de contrôle des annonces ciblant les mineurs et aligner les pratiques sur les normes SA8000 et ILO-C182.</p>}
        {tab === "certifications" && (
          <div>
