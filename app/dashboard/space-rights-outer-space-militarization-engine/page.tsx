...
const ACCENT = "#7c3aed";
const SLUG = "space-rights-outer-space-militarization-engine";
...
const SUB_SCORES = [
  "anti_satellite_weapons_debris_severity_score",
  "space_militarization_arms_race_scale_score",
  "space_debris_kessler_syndrome_risk_score",
  "outer_space_treaty_compliance_governance_deficit_gap_score",
];

const SUB_LABELS: Record<string, string> = {
  anti_satellite_weapons_debris_severity_score: "Armes ASAT & Débris",
  space_militarization_arms_race_scale_score: "Course Armements Spatiaux",
  space_debris_kessler_syndrome_risk_score: "Risque Syndrome Kessler",
  outer_space_treaty_compliance_governance_deficit_gap_score: "Déficit Traité Espace",
};
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {tab === "sources" && (
            <p className="text-slate-400 text-sm">Sources: UN Office for Outer Space Affairs, Secure World Foundation space security report, Outer Space Treaty compliance review.</p>
          )}
        </div>
      </div>
    </div>
...
export default function SpaceRightsOuterSpaceMilitarizationPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Espace &amp; Militarisation Orbitale</h1>
          <p className="text-slate-400 mt-1">Militarisation espace extra-atmosphérique, débris orbitaux et gouvernance spatiale</p>
        </div>
