...
export default function Page() {
  ...
  useEffect(() => {
    fetch("/api/food-security-rights-engine")
      .then(r => r.json())
  ...
  return (
    <div style={{ background:"#020617",minHeight:"100vh",color:"#f1f5f9",fontFamily:"system-ui,sans-serif" }}>
      ...
      <div style={{ maxWidth:1200,margin:"0 auto",padding:"32px 24px" }}>
        <h1 style={{ fontSize:28,fontWeight:700,color:ACCENT,marginBottom:8 }}>Droit à l&apos;Alimentation, Famine &amp; Sécurité Alimentaire</h1>
