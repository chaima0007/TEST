...
const COLOR = "#6366f1";
const DOMAIN = "mobileadvertising-advertising";
const INDEX_KEY = "estimated_mobileadvertising_index";
...
const SIGNALS = [
  "IDFA/GAID consent",
  "In-app privacy labels",
  "SDK data collection",
  "Child-directed content filters",
...
const ACTIONS = [
  ...
  "Restrict location data sharing",
];
...
export default function MobileadvertisingAdvertisingDashboard() {
