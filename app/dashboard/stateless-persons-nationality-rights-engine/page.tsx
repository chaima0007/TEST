...
interface Entity {
  ...
  estimated_stateless_persons_nationality_rights_index: number;
}
interface EngineData {
  ...
  avg_estimated_stateless_persons_nationality_rights_index: number;
...
export default function StatelessPersonsNationalityRightsPage() {
  ...
  const INDEX_KEY = "estimated_stateless_persons_nationality_rights_index";
    ...
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <GaugeRing value={data.avg_estimated_stateless_persons_nationality_rights_index} accent={ACCENT} />
        </div>
