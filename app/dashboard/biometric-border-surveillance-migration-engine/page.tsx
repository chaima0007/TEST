...
interface Entity {
  ...
  risk_level: string
  estimated_border_rights_index: number
}
...
export default function BiometricBorderSurveillanceMigrationPage() {
  const [data, setData] = useState<DomainData | null>(null)

  useEffect(() => {
    fetch("/api/biometric-border-surveillance-migration-engine")
      .then((r) => r.json())
  ...
  if (!data) {
    return (
      <div style={{ background: "#0f172a", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ color: ACCENT, fontSize: 18 }}>Chargement surveillance frontalière biométrique…</div>
      </div>
    )
  }
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            <h1 style={{ margin: 0, fontSize: 24, fontWeight: 800, color: "#f1f5f9" }}>
              Surveillance Biométrique Frontalière &amp; Droits des Migrants
            </h1>
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: "flex", gap: 16 }}>
                <div>
                  <div style={{ fontSize: 18, fontWeight: 700, color: ACCENT }}>{entity.estimated_border_rights_index.toFixed(2)}</div>
                  <div style={{ fontSize: 11, color: "#64748b" }}>Indice frontière</div>
                </div>
                <div>
