...
const ACCENT = "#7c3aed";
const SLUG = "academic-freedom-university-rights-engine";
...
function DetailModal({ entity, onClose }: { entity: Record<string, unknown>; onClose: () => void }) {
  ...
  const SUB_SCORES = [
    "scholar_arrest_exile_persecution_severity_score",
    "curriculum_ideology_state_control_scale_score",
    "research_publication_censorship_score",
    "university_autonomy_governance_deficit_gap_score",
  ];
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {tab === "sources" && (
            <p className="text-slate-400 text-sm">Sources: Scholars at Risk Academic Freedom Monitoring Project, CIVICUS Monitor, Freedom House Academic Freedom Index, UNESCO Education Reports.</p>
          )}
        </div>
      </div>
    </div>
...
export default function AcademicFreedomUniversityRightsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Liberté Académique &amp; Universités</h1>
          <p className="text-slate-400 mt-1">Liberté académique, répression des universités et censure de la recherche</p>
        </div>
