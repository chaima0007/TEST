...
const ACCENT = "#059669";
const SLUG = "climate-change-human-rights-engine";
...
function DetailModal({ entity, onClose }: { entity: Record<string, unknown>; onClose: () => void }) {
  ...
  const SUB_SCORES = [
    "climate_displacement_refugee_rights_severity_score",
    "extreme_weather_livelihood_destruction_scale_score",
    "fossil_fuel_community_health_impact_score",
    "climate_justice_loss_damage_deficit_gap_score",
  ];
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {tab === "sources" && (
            <p className="text-slate-400 text-sm">Sources: IPCC climate vulnerability report, UNHRC climate change rights resolution, loss &amp; damage finance accountability report.</p>
          )}
        </div>
      </div>
    </div>
...
export default function ClimateChangeHumanRightsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Changement Climatique &amp; Droits</h1>
          <p className="text-slate-400 mt-1">Droits humains face au changement climatique, réfugiés climatiques et justice climatique</p>
        </div>
