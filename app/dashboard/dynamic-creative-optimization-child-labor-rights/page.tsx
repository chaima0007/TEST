...
const API_URL = "/api/dynamic-creative-optimization-child-labor-rights";
const TITLE = "Droits Enfants Optimisation Créative Dynamique";
const COLOR = "#ea580c";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — interdiction des systèmes d&apos;optimisation créative dynamique exploitant les données comportementales des enfants pour cibler des publicités requise.</p>}
        {tab === "recommandations" && <p>Interdire l&apos;utilisation des algorithmes d&apos;optimisation créative dynamique pour cibler les enfants. Assurer la conformité totale avec ILO-C182 et CSDDD 2024/1760 en excluant explicitement les mineurs des profils d&apos;optimisation publicitaire.</p>}
        {tab === "certifications" && (
          <div>
