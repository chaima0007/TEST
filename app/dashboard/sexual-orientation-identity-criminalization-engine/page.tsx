...
export default function SexualOrientationIdentityCriminalizationPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/sexual-orientation-identity-criminalization-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Criminalisation Orientation Sexuelle &amp; Identité de Genre
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            SOGIE Laws · Conversion Therapy · Trans Recognition · Intersex Rights
          </p>
        </div>
