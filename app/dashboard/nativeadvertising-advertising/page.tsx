...
const COLOR = "#0284c7";
const DOMAIN = "nativeadvertising-advertising";
const INDEX_KEY = "estimated_nativeadvertising_index";
const TITLE = "Native Advertising";
...
const ACTIONS = [
  "Enforce disclosure labels",
  "Audit editorial independence",
  "Deploy authenticity checks",
  "Publish advertiser lists",
