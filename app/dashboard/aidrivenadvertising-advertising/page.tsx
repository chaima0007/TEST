...
const COLOR = "#6d28d9";
const DOMAIN = "aidrivenadvertising-advertising";
const INDEX_KEY = "estimated_aidrivenadvertising_index";
const TITLE = "AI-Driven Advertising";

const SIGNALS = [
  "AI model transparency",
  "Automated bidding consent",
  "Algorithmic targeting limits",
  "AI creative disclosure",
  "Machine learning data use",
];

const ACTIONS = [
  "Enforce AI transparency",
  "Audit automated bidding",
  "Cap algorithmic targeting",
  "Deploy AI creative labels",
  "Limit ML training data",
];
...
function deriveCerts(entity: Entity): string[] {
  ...
  return [
    ...
    `Niveau de risque AI-driven advertising : ${entity.risk_level}`,
    `Indice estimé Caelum : ${idx.toFixed(2)} / 10`,
    `Conformité IA publicitaire : ${entity.composite_score >= 60 ? "Surveillance active" : "Monitoring standard"}`,
    `Certification Wave 416 — AI-Driven Advertising Intelligence`,
  ];
}
...
export default function AidrivenadvertisingAdvertisingDashboard() {
    ...
    <div style={{ minHeight: "100vh", background: "#030712", color: "#fff", padding: "32px 24px" }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 13, color: `${COLOR}99`, margin: 0 }}>
          Caelum Partners · Wave 416 · Analyse publicitaire IA · {data.generatedAt ? new Date(data.generatedAt).toLocaleDateString("fr-FR") : "2026-06-22"}
