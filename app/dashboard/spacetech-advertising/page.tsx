...
const API_URL = "/api/spacetech-advertising";
const TITLE = "Publicité SpaceTech — Conformité & Droits";
const COLOR = "#1e1b4b";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && (
          <p>Conformité CSDDD 2024/1760 — les acteurs de la publicité spatiale doivent intégrer des obligations de transparence sur l&apos;utilisation des données satellitaires à des fins commerciales. Les pratiques de ciblage via constellation orbitale sont soumises à la diligence raisonnable imposée par l&apos;ILO-C182 et le cadre international de l&apos;OCDE sur la gouvernance spatiale.</p>
        )}
        {tab === "recommandations" && (
          <p>Établir des protocoles de vérification des partenaires publicitaires spatiaux conformes à la CSDDD 2024/1760. Documenter les flux de données orbitales dans un registre transparent et effectuer des audits d&apos;impact sur les droits numériques selon le cadre OIT C182 et la réglementation spatiale internationale.</p>
        )}
        {tab === "certifications" && (
          <div>
