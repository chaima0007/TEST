...
const ACCENT = "#1a3a0a";
const SLUG = "human-rights-education-rights-engine";
...
export default function HumanRightsEducationRightsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Droit à l&apos;Éducation aux Droits Humains</h1>
          <p className="text-slate-400 mt-1">Déclaration HRE · UNESCO · Formation Citoyenne · Sensibilisation</p>
        </div>
