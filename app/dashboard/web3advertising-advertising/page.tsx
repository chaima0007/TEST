...
const API_URL = "/api/web3advertising-advertising";
const TITLE = "Web3 Advertising";
const COLOR = "#f59e0b";
const INDEX_KEY = "estimated_web3advertising_index";

const SIGNALS = [
  "Wallet address privacy",
  "On-chain data exposure",
  "Token-gated ad consent",
  "DeFi user profiling",
  "Blockchain tracking limits",
];

const ACTIONS = [
  "Protect wallet privacy",
  "Limit on-chain exposure",
  "Enforce token-gated consent",
  "Restrict DeFi profiling",
  "Cap blockchain tracking",
];
      ...
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "apercu" && (
          <div>
            ...
            {indexVal !== null && <p style={{ marginBottom: 8 }}>Index Web3 Advertising : <strong>{indexVal}</strong></p>}
        ...
        {tab === "indicateurs" && (
          <p>Conformité Web3 Advertising — les plateformes publicitaires décentralisées doivent garantir la confidentialité des adresses de portefeuille, limiter l&apos;exposition des données on-chain et assurer un consentement explicite pour les publicités token-gated selon les normes émergentes de la finance décentralisée.</p>
        )}
        {tab === "recommandations" && (
          <div>
            <p style={{ marginBottom: 12 }}>Actions prioritaires pour renforcer la conformité Web3 Advertising :</p>
            <ul style={{ paddingLeft: 16, fontSize: 13, color: "#374151" }}>
...
export default function Web3advertisingAdvertisingDashboard() {
