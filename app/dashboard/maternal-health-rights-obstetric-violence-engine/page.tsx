...
interface Entity {
  ...
  estimated_maternal_health_rights_obstetric_violence_index: number;
}
interface EngineData {
  ...
  avg_estimated_maternal_health_rights_obstetric_violence_index: number;
...
// Main page component
export default function MaternalHealthRightsObstetricViolencePage() {
  ...
  const INDEX_KEY = "estimated_maternal_health_rights_obstetric_violence_index";

  useEffect(() => {
    fetch("/api/maternal-health-rights-obstetric-violence-engine")
      .then(r => r.json())
    ...
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <GaugeRing value={data.avg_estimated_maternal_health_rights_obstetric_violence_index} accent={ACCENT} />
        </div>
