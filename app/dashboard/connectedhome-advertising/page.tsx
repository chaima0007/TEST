...
const COLOR = "#14b8a6";
const DOMAIN = "connectedhome-advertising";
const INDEX_KEY = "estimated_connectedhome_index";
const TITLE = "Connected Home Advertising";
...
const SIGNALS = [
  "Smart device consent",
  "Voice data protection",
  "In-home behavioral tracking",
  "IoT data minimization",
  "Household profiling limits",
];

const ACTIONS = [
  "Enforce smart device consent",
  "Protect voice recordings",
  "Limit behavioral tracking",
  "Minimize IoT data",
  "Cap household profiling",
];
...
export default function ConnectedhomeAdvertisingDashboard() {
