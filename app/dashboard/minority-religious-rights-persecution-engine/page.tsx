...
const ACCENT = "#f59e0b";
const SLUG = "minority-religious-rights-persecution-engine";
...
function DetailModal({ entity, onClose }: { entity: Record<string, unknown>; onClose: () => void }) {
  ...
  const SUB_SCORES = [
    "state_religious_persecution_severity_score",
    "blasphemy_apostasy_law_enforcement_scale_score",
    "minority_worship_restriction_destruction_score",
    "religious_conversion_prohibition_deficit_gap_score",
  ];
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {tab === "sources" && (
            <p className="text-slate-400 text-sm">Sources: USCIRF Annual Report, Forum 18 Religious Freedom News, UN Special Rapporteur on Freedom of Religion.</p>
          )}
        </div>
      </div>
    </div>
...
export default function MinorityReligiousRightsPersecutionPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Persécution Religieuse Minorités</h1>
          <p className="text-slate-400 mt-1">Persécution religieuse des minorités, lois sur le blasphème et liberté de culte</p>
        </div>
