...
const API_URL = "/api/metaverseadvertising-advertising";
const TITLE = "Metaverse Advertising";
const COLOR = "#7c3aed";
const INDEX_KEY = "estimated_metaverseadvertising_index";

const SIGNALS = [
  "Avatar data consent",
  "Virtual space tracking",
  "Immersive ad disclosure",
  "Digital identity rights",
  "Metaverse behavior profiling",
];

const ACTIONS = [
  "Enforce avatar consent",
  "Limit virtual tracking",
  "Require immersive disclosures",
  "Protect digital identity",
  "Cap behavior profiling",
];
      ...
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "apercu" && (
          <div>
            ...
            {indexVal !== null && <p style={{ marginBottom: 8 }}>Index Metaverse Advertising : <strong>{indexVal}</strong></p>}
        ...
        {tab === "indicateurs" && (
          <p>Conformité Metaverse Advertising — les plateformes publicitaires dans les espaces virtuels doivent garantir le consentement des avatars, la transparence des espaces immersifs et la protection de l&apos;identité numérique des utilisateurs selon les cadres internationaux de droits numériques.</p>
        )}
        {tab === "recommandations" && (
          <div>
            <p style={{ marginBottom: 12 }}>Actions prioritaires pour renforcer la conformité Metaverse Advertising :</p>
            <ul style={{ paddingLeft: 16, fontSize: 13, color: "#374151" }}>
...
export default function MetaverseadvertisingAdvertisingDashboard() {
