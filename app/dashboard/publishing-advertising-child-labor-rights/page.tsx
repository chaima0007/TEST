...
const API_URL = "/api/publishing-advertising-child-labor-rights";
const TITLE = "Publicité Édition & Livres";
const COLOR = "#92400e";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — encadrement de la publicité dans le secteur de l&apos;édition ciblant les mineurs : obligation de transparence sur les pratiques publicitaires dans les contenus jeunesse, interdiction du marketing déguisé dans les livres scolaires et respect des conventions ILO-C182 sur le travail des enfants dans les chaînes d&apos;approvisionnement éditoriales.</p>}
        {tab === "recommandations" && <p>Établir des chartes éditoriales interdisant la publicité non identifiée dans les contenus destinés aux enfants. Auditer les pratiques de marketing intégré selon la CSDDD 2024/1760 et sensibiliser les équipes éditoriales aux droits de l&apos;enfant définis par l&apos;ILO-C182 dans l&apos;ensemble de la chaîne de valeur de l&apos;édition.</p>}
        {tab === "certifications" && (
          <div>
