...
const COLOR = "#ef4444";
const DOMAIN = "interstitial-advertising";
const INDEX_KEY = "estimated_interstitial_index";
const TITLE = "Interstitial Advertising";
...
const SIGNALS = [
  "Full-screen takeover consent",
  "Skip button compliance",
  "Frequency capping",
  "Child audience protection",
  "Viewability standards",
];

const ACTIONS = [
  "Enforce interstitial consent",
  "Implement skip buttons",
  "Cap interstitial frequency",
  "Deploy child protection",
...
export default function InterstitialAdvertisingDashboard() {
