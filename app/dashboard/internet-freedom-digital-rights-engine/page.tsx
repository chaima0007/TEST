...
export default function InternetFreedomDigitalRightsDashboard() {
  const [data, setData] = useState<DomainData | null>(null)
  const color = "#06b6d4"
  useEffect(() => {
    fetch("/api/internet-freedom-digital-rights-engine").then(r => r.json()).then(d => setData(d.payload ?? d))
  }, [])
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-2" style={{ color }}>Liberté Internet &amp; Droits Numériques</h1>
