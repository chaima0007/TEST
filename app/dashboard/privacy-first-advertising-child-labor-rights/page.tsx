...
const API_URL = "/api/privacy-first-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Privacy-First";
const COLOR = "#4338ca";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — approche privacy-first interdisant le profilage publicitaire des mineurs et imposant la minimisation des données, la transparence algorithmique et l&apos;absence de ciblage comportemental non consenti.</p>}
        {tab === "recommandations" && <p>Adopter une architecture publicitaire privacy-by-design excluant par défaut tout traitement de données personnelles d&apos;enfants. Documenter les analyses d&apos;impact (DPIA) conformément à la CSDDD 2024/1760 et soumettre les dispositifs à une revue indépendante selon les standards ILO-C182.</p>}
        {tab === "certifications" && (
          <div>
