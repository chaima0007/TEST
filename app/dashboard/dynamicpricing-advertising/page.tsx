...
const COLOR = "#f59e0b";
const DOMAIN = "dynamicpricing-advertising";
const INDEX_KEY = "estimated_dynamicpricing_index";
const TITLE = "Dynamic Pricing Advertising";
...
export default function DynamicpricingAdvertisingDashboard() {
