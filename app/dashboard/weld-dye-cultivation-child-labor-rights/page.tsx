...
const API_URL = "/api/weld-dye-cultivation-child-labor-rights";
const TITLE = "Droits Enfants Culture Gaude";
const COLOR = "#854d0e";
...
type Entity = {
  ...
  risk_level: string;
  estimated_weld_dye_cultivation_child_labor_rights_index: number;
};
type ApiData = {
  entities: Entity[];
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 480, maxWidth: "90vw" }}>
        ...
        {tab === "indicateurs" && (
          <p>Index estimé : <strong>{entity.estimated_weld_dye_cultivation_child_labor_rights_index}</strong></p>
        )}
        {tab === "recommandations" && (
