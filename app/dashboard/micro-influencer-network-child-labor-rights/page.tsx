...
const API_URL = "/api/micro-influencer-network-child-labor-rights";
const TITLE = "Droits Enfants Réseau Micro-Influenceurs";
const COLOR = "#7c3aed";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "certifications" && (
          <div>
            <p style={{ fontSize: 12, color: "#6b7280", marginBottom: 12 }}>Statut des certifications pour {entity.entity} — score composite {entity.composite_score}</p>
