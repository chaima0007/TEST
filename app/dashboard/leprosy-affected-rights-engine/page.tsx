...
export default function LeprosyAffectedRightsPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);
  useEffect(() => {
    fetch("/api/leprosy-affected-rights-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Droits des Personnes Affectées par la Lèpre
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Stigmatisation · Discrimination · Accès aux Soins · Réhabilitation
          </p>
        </div>
