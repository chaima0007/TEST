...
const COLOR = "#00adef";
const DOMAIN = "microsoftadvertising-advertising";
const INDEX_KEY = "estimated_microsoftadvertising_index";
const TITLE = "Microsoft Advertising";
...
const SIGNALS = ["LinkedIn profile targeting", "Bing search data", "Microsoft Graph data", "Windows telemetry use", "B2B targeting consent"];
const ACTIONS = ["Limit LinkedIn targeting", "Audit Bing data use", "Restrict Graph data", "Cap telemetry use", "Enforce B2B consent"];
...
export default function MicrosoftadvertisingAdvertisingDashboard() {
