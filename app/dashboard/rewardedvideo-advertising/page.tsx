...
const COLOR = "#10b981";
const DOMAIN = "rewardedvideo-advertising";
const INDEX_KEY = "estimated_rewardedvideo_index";
const TITLE = "Rewarded Video Advertising";
...
const SIGNALS = [
  "Reward transparency",
  "Completion rate ethics",
  "User choice enforcement",
  "In-app purchase linkage",
  "Minors protection",
];

const ACTIONS = [
  "Disclose rewards clearly",
  "Enforce completion ethics",
  "Strengthen user choice",
  "Audit in-app linkage",
  "Protect minor users",
];
...
export default function RewardedvideoAdvertisingDashboard() {
