...
export default function SandalwoodIllegalLoggingRightsDashboard() {
  const [data, setData] = useState<EngineData | null>(null);
  const [selected, setSelected] = useState<EntityResult | null>(null);
  const [tab, setTab] = useState(0);

  useEffect(() => {
    fetch("/api/sandalwood-illegal-logging-rights")
      .then(r => r.json())
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: 32, fontFamily: "sans-serif" }}>
      <h1 style={{ fontSize: 28, fontWeight: 800, marginBottom: 8 }}>Droits — Exploitation Illégale Bois de Santal</h1>
