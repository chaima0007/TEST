...
const COLOR = "#555555";
const DOMAIN = "applesearchads-advertising";
const INDEX_KEY = "estimated_applesearchads_index";
const TITLE = "Apple Search Ads";
...
const SIGNALS = ["App Store privacy labels", "SKAdNetwork compliance", "IDFA deprecation", "Audience Match limits", "Child app protections"];
const ACTIONS = ["Enforce privacy labels", "Implement SKAdNetwork", "Remove IDFA tracking", "Cap Audience Match", "Deploy child protections"];
...
export default function ApplesearchadsAdvertisingDashboard() {
