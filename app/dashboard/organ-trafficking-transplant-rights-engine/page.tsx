...
export default function OrganTraffickingTransplantRightsPage() {
  ...
  useEffect(() => {
    fetch("/api/organ-trafficking-transplant-rights-engine").then(r => r.json()).then(d => { setData(d.payload ?? d); setLoading(false); });
  }, []);
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-6">
      <div className="mb-8 flex items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: ACCENT }}>Trafic d&apos;Organes &amp; Transplantation</h1>
          <p className="text-slate-400 mt-1 text-sm">Récolte Forcée · Marché Noir · Déclaration Istanbul · WHO</p>
        </div>
