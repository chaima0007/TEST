...
const COLOR = "#7c3aed";
const DOMAIN = "voiceassistant-advertising";
const INDEX_KEY = "estimated_voiceassistant_index";
const TITLE = "Voice Assistant Advertising";

const SIGNALS = ["Voice command privacy","Wake word consent","Audio data retention","Speaker identification","Child voice protection"];
const ACTIONS = ["Enforce voice consent","Audit audio retention","Deploy speaker ID controls","Protect child voices","Publish voice data policy"];
