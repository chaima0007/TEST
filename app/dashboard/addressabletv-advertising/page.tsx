...
const COLOR = "#0e7490";
const DOMAIN = "addressabletv-advertising";
const INDEX_KEY = "estimated_addressabletv_index";
const TITLE = "Addressable TV Advertising";

const SIGNALS = [
  "Household targeting consent",
  "ACR data compliance",
  "Cross-device matching",
  "Set-top box data privacy",
  "CTV audience segmentation",
];

const ACTIONS = [
  "Enforce household consent",
  "Audit ACR data usage",
  "Limit cross-device matching",
  "Secure STB data flows",
  "Review CTV segmentation",
];
...
export default function AddressabletvAdvertisingDashboard() {
