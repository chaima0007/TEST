...
export default function EnvironmentalDefendersRightsPage() {
  const [data, setData] = useState<Record<string, unknown> | null>(null);

  useEffect(() => {
    fetch("/api/environmental-defenders-rights-engine")
      .then((r) => r.json())
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="border-b border-slate-800 pb-6">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: ACCENT }}>
            Droits des Défenseurs de l&apos;Environnement
          </h1>
          <p className="mt-1 text-sm text-slate-400">
            Militants écologiques tués, poursuites SLAPP &amp; criminalisation
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-xl bg-slate-900 border border-slate-800 p-6 flex flex-col items-center">
            ...
            <div className="w-32 h-32">
              <GaugeRing value={avgComposite} color={ACCENT} />
            </div>
