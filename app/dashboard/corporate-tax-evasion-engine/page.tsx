...
const ACCENT = "#065f46"
const DOMAIN_SLUG = "corporate-tax-evasion-engine"
...
const FALLBACK: EngineData = {
  ...
  accent_color: ACCENT,
  entities: [
    { id: "CTE_001", name: "Apple Ireland", country: "IE/US", composite_score: 89.4, severity: "critique", key_violation: "Double irlandais — 13Mds€ réclamés par Commission européenne" },
    { id: "CTE_002", name: "Amazon Luxembourg", country: "LU/US", composite_score: 86.2, severity: "critique", key_violation: "Structures LuxLeaks — 250M€ avantages fiscaux illicites" },
    { id: "CTE_003", name: "Google Netherlands", country: "NL/US", composite_score: 83.1, severity: "critique", key_violation: "Dutch Sandwich — milliards transférés hors UE annuellement" },
    { id: "CTE_004", name: "Meta Ireland", country: "IE/US", composite_score: 77.8, severity: "critique", key_violation: "Prix de transfert IP — économie fiscale estimée 15Mds$/an" },
    { id: "CTE_005", name: "Starbucks NL", country: "NL/US", composite_score: 56.9, severity: "élevé", key_violation: "Ruling fiscal néerlandais annulé — remboursement ordonné" },
    { id: "CTE_006", name: "Nike Switzerland", country: "CH/US", composite_score: 52.3, severity: "élevé", key_violation: "Redevances IP Suisse — taux effectif <2% sur profits européens" },
    { id: "CTE_007", name: "IKEA", country: "NL/SE", composite_score: 28.5, severity: "modéré", key_violation: "Fondation liechtensteinoise — restructuration partielle en cours" },
    { id: "CTE_008", name: "Patagonia", country: "US", composite_score: 13.2, severity: "faible", key_violation: "Transparence fiscale totale — don intégral à causes environnementales" },
  ],
...
export default function CorporateTaxEvasionPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0f172a", color: "#f8fafc", padding: "2rem", fontFamily: "system-ui, sans-serif" }}>
          ...
          return (
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingTop: "0.75rem", borderTop: "1px solid #334155" }}>
                <span style={{ fontSize: "0.75rem", color: "#64748b" }}>Score Évasion</span>
      ...
      <div style={{ textAlign: "center", color: "#475569", fontSize: 12, paddingTop: 24, marginTop: 32, borderTop: "1px solid #1e293b" }}>
        Caelum Partners — Wave {d.wave} · Corporate Tax Evasion Engine
      </div>
    </main>
  )
}
