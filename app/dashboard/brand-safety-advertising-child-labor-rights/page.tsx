...
const API_URL = "/api/brand-safety-advertising-child-labor-rights";
const TITLE = "Droits Enfants Publicité Brand Safety";
const COLOR = "#dc2626";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, width: 520, maxWidth: "90vw", maxHeight: "80vh", overflowY: "auto" }}>
        ...
        {tab === "indicateurs" && <p>Conformité CSDDD 2024/1760 — les solutions de brand safety publicitaire doivent garantir qu&apos;aucune publicité de marque ne soit diffusée dans des contextes nuisibles aux enfants : ce contrôle est soumis aux obligations de diligence raisonnable de l&apos;ILO-C182 et de la CSDDD concernant la protection des mineurs dans les environnements médias.</p>}
        {tab === "recommandations" && <p>Intégrer des listes d&apos;exclusion ciblant les contenus nocifs pour les enfants dans tous les outils de brand safety. Documenter les politiques de placement dans un registre conforme à la CSDDD 2024/1760 et effectuer des audits réguliers d&apos;impact sur les droits de l&apos;enfant selon le cadre ILO-C182.</p>}
        {tab === "certifications" && (
          <div>
