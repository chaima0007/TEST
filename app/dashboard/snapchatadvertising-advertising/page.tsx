...
const COLOR = "#d4a017";
const DOMAIN = "snapchatadvertising-advertising";
const INDEX_KEY = "estimated_snapchatadvertising_index";
const TITLE = "Snapchat Advertising";
...
const SIGNALS = [
  ...
  "AR data collection",
  "Teen audience protections",
  "Location snap targeting",
  "Friend graph data use",
];

const ACTIONS = [
  "Enforce ephemeral consent",
  "Limit AR data collection",
  "Deploy teen protections",
  "Cap location targeting",
  "Restrict friend graph use",
];
...
export default function SnapchatadvertisingAdvertisingDashboard() {
