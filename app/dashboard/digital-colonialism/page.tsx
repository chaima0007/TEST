...
export default function DigitalColonialismDashboard() {
  ...
  useEffect(() => { fetch("/api/digitalcolonialism").then(r => r.json()).then(d => setData(d.payload ?? d)); }, []);
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-2">Digital Colonialism &amp; Data Sovereignty</h1>
      <p className="text-gray-500 text-sm mb-6">Analyse des dynamiques de pouvoir numériques et droits à la souveraineté des données</p>
