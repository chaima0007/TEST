# Vérification des prédictions — résultats réels

## Brésil – Norvège (8e de finale, 5 juillet 2026)

**Résultat réel : Brésil 1-2 Norvège** — doublé de Haaland (79e et 90e), penalty brésilien dans les dernières secondes. Fait de match décisif : **Nyland a arrêté un penalty de Bruno Guimarães** en cours de match, alors que le score était encore 0-0.

### Prédiction vs réalité
| Élément prédit | Prédiction | Réalité | Verdict |
|---|---|---|---|
| Vainqueur | Brésil (~65-68 %) | **Norvège** | ❌ FAUX — le scénario à ~32-35 % s'est réalisé |
| Score | 2-1 | 2-1 (mais dans l'autre sens) | ❌ (le format du score était juste) |
| Buteur norvégien | « Si la Norvège marque, Haaland à 50 % » | Haaland ×2 | ✅ |
| Les deux équipes marquent (pari validé à 1,87+) | OUI (~55-60 %) | OUI (2-1) | ✅ **PARI GAGNANT** |
| Brésil gagne en 90 min (pari validé à 1,90+) | ~51-56 % | Non | ❌ PARI PERDANT |
| « Si égalité à la 75e : Brésil 64 % seulement » (table live) | Fragilité réelle en fin de match | Les 2 buts à la 79e et 90e | ✅ le danger identifié |

### Bilan financier du plan recommandé (25 € + 25 €)
- 25 € sur Brésil 90 min : −25 €
- 25 € sur BTTS oui à 1,87+ : +21,75 €
- **Net : ≈ −3 € — la répartition a fait son travail de protection**
(Un all-in de 50 € sur « Brésil gagne » aurait coûté −50 €.)

### Leçons honnêtes
1. Une prédiction à 65 % qui échoue n'est pas une erreur de calcul : c'est le tiers restant qui se réalise. Le backtest l'annonçait : ~96,5 % de chances qu'au moins un de nos 7 pronostics tombe — c'est celui-ci.
2. Le penalty arrêté par Nyland est exactement le type d'événement à ~25 % qui fait basculer un match serré — aucun modèle ne le prédit.
