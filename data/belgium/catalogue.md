...
|---|---|---|---|---|---|
| Risques professionnels | Accident du travail & maladie professionnelle | 4 | 8 | 4 | 2 |
| — | Accident de la route — indemnisation | 4 | 5 | 1 | 1 |
| Achat immobilier | Acheter un logement — compromis & notaire | 4 | 7 | 4 | 2 |
| Adoption | Adoption — formes et procédure | 4 | 8 | 4 | 0 |
| Sans-abri & domiciliation | Adresse de référence (sans logement) | 4 | 4 | 4 | 1 |
| Aidants proches | Aidants proches — reconnaissance, congé, droits | 4 | 6 | 4 | 2 |
| Accès à la justice | Aide juridique — un avocat (presque) gratuit | 4 | 5 | 4 | 1 |
...
| Logement étudiant | Logement étudiant (kot) — bail & droits | 4 | 4 | 4 | 1 |
...
| — | Changement de nom ou de prénom | 4 | 5 | 1 | 0 |
| Couple & patrimoine | Changer de régime matrimonial | 4 | 5 | 1 | 0 |
| Chômage & emploi | Chômage — droits, démarches et sanctions | 4 | 4 | 4 | 1 |
...
| Divorce & séparation | Divorce & séparation | 4 | 8 | 4 | 0 |
| Documents d'identité | Documents d'identité — carte, passeport, permis | 4 | 8 | 4 | 2 |
| — | Domiciliation & changement d'adresse | 4 | 5 | 1 | 3 |
| — | Don d'organes | 4 | 4 | 1 | 0 |
| — | Donations | 5 | 9 | 1 | 0 |
...
| — | Filiation & reconnaissance d'un enfant | 4 | 5 | 1 | 0 |
| Fin de vie | Fin de vie — déclarations anticipées & droits | 4 | 8 | 4 | 0 |
| Fonction publique | Travailler dans le secteur public | 4 | 8 | 4 | 0 |
...
| — | Légalisation & apostille de documents | 4 | 6 | 1 | 0 |
...
| — | Achat sur plan / clé-sur-porte (loi Breyne) | 4 | 6 | 1 | 0 |
| — | Maladie professionnelle | 4 | 5 | 1 | 1 |
...
| — | Accès aux documents administratifs | 4 | 6 | 1 | 1 |
...
| — | Saisie immobilière (vente forcée d'un immeuble) | 4 | 6 | 1 | 1 |
| Saisies & recouvrement | Saisies & huissier — ce qui peut être pris (ou non) | 4 | 4 | 4 | 1 |
| — | Sanctions administratives communales (SAC) | 4 | 4 | 1 | 2 |
...
| Achat véhicule d'occasion | Acheter une voiture d'occasion | 4 | 7 | 4 | 1 |
...
| Aide sociale & CPAS | couvert | haute |
| Consommation & contrats | couvert | moyenne |
| Étrangers & séjour | couvert | moyenne |
| Fiscalité (impôts) | couvert | moyenne |
| Circulation routière | couvert | moyenne |
| Santé & droits du patient | couvert | moyenne |
| Vie privée & données (RGPD) | couvert | moyenne |
| Successions & héritage | couvert | basse |
| Énergie & PEB (lié au logement) | couvert | moyenne |
| Citoyenneté (droits & devoirs) | couvert | haute |
| Aidants proches | couvert | haute |
| Vote & démocratie | couvert | moyenne |
| Drogues & prévention | couvert | haute |
| Enfants placés & aide à la jeunesse | couvert | haute |
| Gouvernement & institutions | couvert | moyenne |
| Enseignement | couvert | moyenne |
| Animaux | couvert | basse |
| Indépendant & activité | couvert | moyenne |
| Couple & vie commune | couvert | moyenne |
| Crédit & fichage | couvert | moyenne |
| Décès & démarches | couvert | moyenne |
| Pension & retraite | couvert | moyenne |
| Logement social | couvert | haute |
| Allocations familiales | couvert | haute |
| Assurances | couvert | moyenne |
| Job étudiant | couvert | moyenne |
| Discrimination & égalité | couvert | haute |
| Télécommunications | couvert | moyenne |
| Santé mentale | couvert | haute |
| Protection des personnes vulnérables | couvert | moyenne |
| Eau & distribution | couvert | moyenne |
| Mobilité douce (vélo, trottinette) | couvert | moyenne |
| Naissance & filiation | couvert | haute |
| Déchets & environnement | couvert | moyenne |
| Services bancaires | couvert | haute |
| Droits des passagers (train, avion) | couvert | moyenne |
| Violences conjugales & familiales | couvert | haute |
| Documents d identité | couvert | haute |
| Bien-être & burnout | couvert | haute |
| Accès à la justice (aide juridique) | couvert | haute |
| Fraude & sécurité numérique | couvert | haute |
| Chômage & emploi | couvert | haute |
| Maladie & incapacité | couvert | haute |
| Saisies & recouvrement | couvert | haute |
...
| Recours administratifs | couvert | haute |
| Règlement des conflits | couvert | haute |
| Jeunes & premier emploi | couvert | haute |
| Logement étudiant | couvert | moyenne |
| Achat immobilier | couvert | haute |
| Assurance véhicule | couvert | moyenne |
| Crédit hypothécaire | couvert | haute |
| Copropriété | couvert | moyenne |
| Urbanisme & travaux | couvert | haute |
| Voyages | couvert | moyenne |
| Volontariat | couvert | moyenne |
| Fonction publique | couvert | moyenne |
| Assurance logement | couvert | haute |
