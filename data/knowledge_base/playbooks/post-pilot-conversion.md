...
Coût évité (estimation) :
  ...
  - Provision risque amende LkSG non matérialisée
ROI estimé : [multiple]x
```

**4. Proposition de renouvellement (10 min)**
- Présenter 2-3 options claires (Standard / Pro / Enterprise)
- Mettre en avant la différence entre le plan pilote et le plan annuel
- Angle : "Vous avez vu la valeur du monitoring sur X engines — imaginez la couverture complète"

**5. Roadmap produit (5 min)**
- Annoncer 1-2 fonctionnalités à venir répondant à des besoins exprimés pendant le pilote
...
- Le contact a partagé spontanément un rapport à son manager ou au COMEX
- Il/elle a demandé à ajouter un nouveau domaine ou un nouveau fournisseur pendant le pilote
- Des membres d'autres équipes ont rejoint la plateforme sans demande commerciale
- La personne parle de la solution comme "notre outil" et non "le pilote Caelum"
- Elle a déjà posé des questions sur les tarifs annuels ou sur l'ajout de sièges
...
- Le sponsor interne a changé de poste pendant le pilote
- L'interlocuteur répond aux relances avec des délais ("on verra en Q3")
...
**"Le pilote était bien mais le budget n'est pas confirmé"**
...
> "Parfait — c'est exactement le bon réflexe. Puis-je vous envoyer notre documentation juridique directement à votre collègue juridique ?"

**"On n'a utilisé que 2 des 5 engines — c'est trop pour nous"**
> "Vous avez raison d'optimiser. Nous avons un plan Standard à 290€/mois limité à 3 engines — peut-être plus adapté à votre usage actuel."
...
- [ ] Template de brief interne "Pourquoi nous renouveler"
...
2. Programmer une réunion avec le manager du contact
3. Envoyer un email de synthèse "Ce que vous perdez si vous stoppez" avec 3 exemples concrets
4. Si toujours bloqué → marquer "Nurture" dans le CRM et relancer à J+180
